...
Под мультимедиа понимается аудио, видео и фотографии, которое было сжато цифровыми методами.  Windows Server Essentials позволяет подключенным к сети компьютерам и некоторые сетевым устройствам мультимедиа воспроизводить файлы мультимедиа, которые хранятся на сервере.  
  
 В следующих разделах сведения о доступе и воспроизведении файлов цифрового мультимедиа, которые хранятся на Windows Server Essentials.  
  

-   [Обзор цифрового мультимедиа](Play-Digital-Media-in-Windows-Server-Essentials.md#BKMK_1)  
  
-   [Воспроизведение и совместно использовать мультимедиа](Play-Digital-Media-in-Windows-Server-Essentials.md#BKMK_2)  
...
-   [Просмотр и общего мультимедийного](Play-Digital-Media-in-Windows-Server-Essentials.md#BKMK_7)  

-   [Обзор цифрового мультимедиа](../use/Play-Digital-Media-in-Windows-Server-Essentials.md#BKMK_1)  
  
-   [Воспроизведение и совместно использовать мультимедиа](../use/Play-Digital-Media-in-Windows-Server-Essentials.md#BKMK_2)  
...
-   [Просмотр и общего мультимедийного](../use/Play-Digital-Media-in-Windows-Server-Essentials.md#BKMK_7)  
...
### <a name="why-would-i-want-to-stream-my-digital-media"></a>В чем смысл потоковой передачи цифрового мультимедиа?  
 Многие хранят музыку, видео и фотографии в общих папках в Windows Server Essentials. Могут возникнуть ситуации, когда требуется выполнить следующие задачи:  
...
##  <a name="BKMK_2"></a> Воспроизведение и совместно использовать мультимедиа  
...
> [!NOTE]
>  Текущий список устройств воспроизведения и приема мультимедиа, совместимых с Windows Server Essentials, см. в разделе [Центр совместимости Windows](https://www.microsoft.com/windows/compatibility/CompatCenter/Home).  
  
 Можно использовать один из следующих способов для поиска и воспроизведения файлов мультимедиа, хранимых на вашем сервере:  
  

-   [Поиск и воспроизведение файлов мультимедиа в Windows Server Essentials с компьютера или мультимедийного проигрывателя в сети](Play-Digital-Media-in-Windows-Server-Essentials.md#BKMK_2.1)  
  
-   [Отправка файлов мультимедиа в Windows Server Essentials в проигрыватель Windows Media, Xbox 360 или сетевой мультимедийный проигрыватель сети](Play-Digital-Media-in-Windows-Server-Essentials.md#BKMK_SendToDevice)  

-   [Поиск и воспроизведение файлов мультимедиа в Windows Server Essentials с компьютера или мультимедийного проигрывателя в сети](../use/Play-Digital-Media-in-Windows-Server-Essentials.md#BKMK_2.1)  
  
-   [Отправка файлов мультимедиа в Windows Server Essentials в проигрыватель Windows Media, Xbox 360 или сетевой мультимедийный проигрыватель сети](../use/Play-Digital-Media-in-Windows-Server-Essentials.md#BKMK_SendToDevice)  

  
###  <a name="BKMK_2.1"></a> Поиск и воспроизведение файлов мультимедиа в Windows Server Essentials с компьютера или мультимедийного проигрывателя в сети  
 Если устройство присоединено к сети Windows Server Essentials, можно найти и воспроизведение файлов мультимедиа в любом из следующих способов:  
...
-   [Поиск и воспроизведение файлов мультимедиа с помощью других цифровых проигрывателей или приемников мультимедиа, совместимых с Windows Server Essentials](Play-Digital-Media-in-Windows-Server-Essentials.md#BKMK_Other)  
...
-   [Поиск и воспроизведение файлов мультимедиа с помощью других цифровых проигрывателей или приемников мультимедиа, совместимых с Windows Server Essentials](../use/Play-Digital-Media-in-Windows-Server-Essentials.md#BKMK_Other)  
...
2.  На компьютере, на котором работает Windows Server Essentials включите общий доступ к мультимедиа. Дополнительные сведения см. в разделе [включить потоковая передача или отключение](../manage/Manage-Digital-Media-in-Windows-Server-Essentials.md#BKMK_4).  
...
####  <a name="BKMK_Other"></a> Поиск и воспроизведение файлов мультимедиа с помощью других цифровых проигрывателей или приемников мультимедиа, совместимых с Windows Server Essentials  
...
###  <a name="BKMK_SendToDevice"></a> Отправка файлов мультимедиа в Windows Server Essentials в проигрыватель Windows Media, Xbox 360 или сетевой мультимедийный проигрыватель сети  
...
##  <a name="BKMK_3"></a> Воспроизведение общих файлов мультимедиа из удаленного расположения  
 Можно воспроизводить файлы мультимедиа, находясь вдали от сети Windows Server Essentials с помощью удаленного веб-доступа. Для поиска и воспроизведения общих файлов мультимедиа, которые хранятся на сервере, можно использовать сотовый телефон, удаленный компьютер или мультимедийный проигрыватель.  
...
4.  Используйте любой метод для поиска файла мультимедиа, который требуется воспроизвести.  
    ...
    >  Сведения о различных методах поиска см [поиск и воспроизведение файлов мультимедиа в Windows Server Essentials с компьютера или из мультимедиапроигрывателя в сети](Play-Digital-Media-in-Windows-Server-Essentials.md#BKMK_2.1).  

    >  Сведения о различных методах поиска см [поиск и воспроизведение файлов мультимедиа в Windows Server Essentials с компьютера или из мультимедиапроигрывателя в сети](../use/Play-Digital-Media-in-Windows-Server-Essentials.md#BKMK_2.1).  
...
1.  Для входа на сервер воспользуйтесь одним из следующих способов.  
    ...
    1.  Сведения о входе через удаленный веб-доступ, см. в разделе [Use Remote Web Access](Use-Remote-Web-Access-in-Windows-Server-Essentials.md).  

    1.  Сведения о входе через удаленный веб-доступ, см. в разделе [Use Remote Web Access](../use/Use-Remote-Web-Access-in-Windows-Server-Essentials.md).  

  
    2.  Сведения о входе через панель запуска см. в разделе [Обзор стартовой платформы](../manage/Overview-of-the-Launchpad-in-Windows-Server-Essentials.md).  
...
##  <a name="BKMK_6"></a> Средство отправки файлов  
 Средство отправки файлов упрощает процесс передачи файлов на сервере Windows Server Essentials. Можно добавить столько файлов в средство отправки файлов и передать их в общие папки на сервере Windows Server Essentials в одном пакете. Дополнительные сведения см. в записи блога [Общие сведения о совместном использовании папок с помощью удаленного веб-доступа](http://blogs.technet.com/b/sbs/archive/2012/04/19/understanding-remote-web-access-file-sharing.aspx).  
  
##  <a name="BKMK_7"></a> Просмотр и общего мультимедийного  
...
3.  Откройте вкладку **Папки сервера** . Отображается список папок сервера.  
