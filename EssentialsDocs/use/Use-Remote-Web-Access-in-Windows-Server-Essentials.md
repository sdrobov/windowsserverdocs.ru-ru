...
>Область применения. Windows Server 2016 Essentials, Windows Server 2012 R2 Essentials, Windows Server 2012 Essentials
  ...
  Remote Web Access — это компонент Essentials серверов Windows, который позволяет доступ файлов/папок и компьютерам сети через веб-браузер из любого места с подключением к Интернету. 
  
  Удаленный веб-доступ позволяет сохранять подключение к сети Windows Server Essentials, находясь за пределами офиса. При входе удаленный веб-доступ, можно подключиться к компьютерам в сети Windows Server Essentials, откройте панель мониторинга для управления сетью Windows Server Essentials и получить доступ ко всем общим папкам и файлам мультимедиа на сервере.  
  
 Эта статья содержит следующие разделы.  
  

-   [Соединиться с удаленного веб-доступа](Use-Remote-Web-Access-in-Windows-Server-Essentials.md#BKMK_Connect)  
  
-   [Совместное использование файлов и папок](Use-Remote-Web-Access-in-Windows-Server-Essentials.md#BKMK_SharedFolders)  
  
-   [Подключение с мобильного устройства](Use-Remote-Web-Access-in-Windows-Server-Essentials.md#BKMK_ConnectMobile)  
  
##  <a name="BKMK_Connect"></a> Соединиться с удаленного веб-доступа  
...
-   [Соединиться с удаленного веб-доступа](../use/Use-Remote-Web-Access-in-Windows-Server-Essentials.md#BKMK_Connect)  
  
-   [Совместное использование файлов и папок](../use/Use-Remote-Web-Access-in-Windows-Server-Essentials.md#BKMK_SharedFolders)  
...
###  <a name="BKMK_1"></a> Войдите в систему удаленного веб-доступа  
 При входе удаленный веб-доступ из локального или удаленного компьютера, ресурсы доступны на сервере под управлением Windows Server Essentials и компьютерах в сети.  
  
##### <a name="to-log-on-to-remote-web-access-from-a-network-computer"></a>Вход в удаленный веб-доступ с компьютера в сети  
  
1.  Откройте веб-браузер, введите **https://***< Имя_вашего_сервера\>***/remote** в адресной строке и нажмите клавишу ВВОД.  
  
    > [!NOTE]
    >  Убедитесь, что вы включите преобразования в https.  
  
2.  На странице входа в систему удаленного веб-доступа введите имя пользователя и пароль в текстовые поля и нажмите кнопку со стрелкой.  
  
##### <a name="to-log-on-to-remote-web-access-from-a-remote-computer"></a>Вход в удаленный веб-доступ с удаленного компьютера  
  
1.  Откройте веб-браузер, введите **https://***< имя_домена\>***/remote** в адресной строке и нажмите клавишу ВВОД.  
  
    > [!NOTE]
    >  Информацию об имени домена можно получить у администратора сети. Убедитесь, что вы включите преобразования в https.  
  
2.  На странице входа в систему удаленного веб-доступа введите имя пользователя и пароль в текстовые поля и нажмите кнопку со стрелкой.  
  
###  <a name="BKMK_1.5"></a> Удаленный доступ к компьютеру  
 Находясь за пределами офиса, можно использовать веб-браузере вход на сайт удаленного веб-доступа для удаленного доступа к вашей панели мониторинга Windows Server Essentials, общим папкам и компьютеров в сети.  
  
 При подключении к панели мониторинга системой Windows Server Essentials можно управлять точно так же, как если бы вы находились в офисе. Вы можете выполнять все стандартные задачи администрирования, таких как добавление учетных записей пользователей, Добавление общих папок, Настройка доступа к общей папке и так далее. При подключении к компьютерам в сети вы получаете доступ к своим настольным компьютерам, как если бы вы сидели за ними в офисе.  
...
##  <a name="BKMK_SharedFolders"></a> Совместное использование файлов и папок  
...
-   [Создание, переименование, перемещение, удалить или скопировать файлы и папки в удаленного веб-доступа](Use-Remote-Web-Access-in-Windows-Server-Essentials.md#BKMK_2)  
...
-   [Создание, переименование, перемещение, удалить или скопировать файлы и папки в удаленного веб-доступа](../use/Use-Remote-Web-Access-in-Windows-Server-Essentials.md#BKMK_2)  
...
-   Отправка (передача) файлов с компьютера в Windows Server Essentials.  
    ...
    > [!NOTE]
    >  В режиме удаленного веб-доступа вы можете загрузить только файлы, загрузить папки нельзя. Если вы хотите иметь ту же иерархию файлов и папок в области **Общие папки** сервера, что и на компьютере, необходимо создать папки на сервере в режиме удаленного веб-доступа и затем отправить файлы в созданную папку. Дополнительные сведения о создании папок на сервере см. в статье [Add or move a server folder](../manage/Manage-Server-Folders-in-Windows-Server-Essentials.md#BKMK_5).  
...
-   Удаление, перемещение и переименование файлов и папок в Windows Server Essentials. Дополнительные сведения см. в разделе [создать, переименование, перемещение, удаление, или копирования файлов и папок в удаленного веб-доступа](Use-Remote-Web-Access-in-Windows-Server-Essentials.md#BKMK_2).  

-   Удаление, перемещение и переименование файлов и папок в Windows Server Essentials. Дополнительные сведения см. в разделе [создать, переименование, перемещение, удаление, или копирования файлов и папок в удаленного веб-доступа](../use/Use-Remote-Web-Access-in-Windows-Server-Essentials.md#BKMK_2).  
...
> [!NOTE]
>  Чтобы добавить новые общие папки на сервере под управлением Windows Server Essentials, необходимо использовать панель мониторинга. Для подключения к консоли сервера из режима удаленного веб-доступа, на вкладке **Компьютеры** щелкните имя сервера, щелкните элемент **Подключение** и следуйте инструкциям для входа на сервер. Дополнительные сведения о создании общих папок см. в статье [Add or move a server folder](../manage/Manage-Server-Folders-in-Windows-Server-Essentials.md#BKMK_5).  
...
-   [USE Remote Web Access с мобильного устройства](Use-Remote-Web-Access-in-Windows-Server-Essentials.md#BKMK_8)  
  
-   [Поддерживаемые веб-браузеры для мобильных устройств](Use-Remote-Web-Access-in-Windows-Server-Essentials.md#BKMK_9)  

-   [USE Remote Web Access с мобильного устройства](../use/Use-Remote-Web-Access-in-Windows-Server-Essentials.md#BKMK_8)  
  
-   [Поддерживаемые веб-браузеры для мобильных устройств](../use/Use-Remote-Web-Access-in-Windows-Server-Essentials.md#BKMK_9)  

  
###  <a name="BKMK_8"></a> USE Remote Web Access с мобильного устройства  
...
1.  Откройте веб-браузер и введите **https://***<имя_домена\>***/remote** в адресной строке.  Убедитесь, что вы включите преобразования в https.  
  
2.  На странице входа в систему удаленного веб-доступа введите имя пользователя и пароль в текстовые поля и нажмите кнопку со стрелкой. Вы вошли в версию удаленного веб-доступа для мобильных устройств.  
...
2.  На странице входа в систему удаленного веб-доступа, введите имя пользователя и пароль в текстовые поля, выберите **представление рабочего стола версии**и нажмите кнопку со стрелкой. Вы вошли в версию удаленного веб-доступа для настольных компьютеров.  
...
2. Откройте веб-браузер и введите **https://***<имя_домена\>***/remote/m** в адресной строке. Убедитесь, что вы включите преобразования в https.  
  
3. Отображается в мобильную версию удаленного веб-доступа. На странице входа в систему удаленного веб-доступа введите имя пользователя и пароль в текстовые поля и нажмите кнопку со стрелкой. Вы вошли мобильную версию удаленного веб-доступа.  
