...
##  <a name="BKMK_1"></a>Общие сведения о цифровом мультимедиа  
...
###  <a name="BKMK_1.5"></a>Общий доступ к носителю с защитой от копирования  
...
##  <a name="BKMK_4"></a>Включение или отключение потоковой передачи мультимедиа  
...
####  <a name="BKMK_2.5"></a>Включение или отключение потоковой передачи мультимедиа  
...
4. Нажмите кнопку **ОК** , чтобы сохранить изменения.  
   ...
   Дополнительные сведения см. в разделе [Allow or restrict access to a media library on the server](Manage-Digital-Media-in-Windows-Server-Essentials.md#BKMK_6).  
  
##  <a name="BKMK_5"></a>Добавление цифровых файлов мультимедиа на сервер  
...
1.  Для входа на сервер воспользуйтесь одним из следующих способов.  
    ...
    1.  Сведения о входе через удаленный веб-доступ см. в разделе [Log on to Remote Web Access](../use/Use-Remote-Web-Access-in-Windows-Server-Essentials.md#BKMK_1).  
...
##  <a name="BKMK_6"></a>Разрешение или запрет доступа к библиотеке мультимедиа на сервере  
...
##  <a name="BKMK_9"></a>Отмена общего доступа к цифровым файлам мультимедиа  
...
##  <a name="BKMK_10"></a>Включение устройств мультимедиа, использующих протокол SMB для доступа к общим файлам на сервере  
