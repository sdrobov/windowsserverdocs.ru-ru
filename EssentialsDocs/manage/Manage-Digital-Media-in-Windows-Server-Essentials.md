...
-   На сетевом компьютере под управлением Windows 7 или Windows 8 с таким же процессором, что и сервер, перейдите в каталог **панели управления**, нажмите кнопку **счетчики и средства**, а затем просмотрите сведения на **Скорость и повышение производительности компьютера s** страницы.  
