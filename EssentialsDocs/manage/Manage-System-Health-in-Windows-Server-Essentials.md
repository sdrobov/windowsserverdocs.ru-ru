...
##  <a name="BKMK_AddIn"></a>О надстройке отчета о работоспособности  
...
###  <a name="BKMK_Generate"></a>Создание отчета по запросу или по расписанию  
...
##  <a name="BKMK_View"></a>Просмотр предупреждений с помощью средства просмотра предупреждений  
...
##  <a name="BKMK_Respond"></a>Ответ на предупреждения  
...
###  <a name="BKMK_Resolve"></a>Разрешение предупреждения  
...
##  <a name="BKMK_Email"></a>Настройка уведомлений по электронной почте для оповещений  
...
###  <a name="BKMK_list"></a>Оповещения, которые приводят к появлению уведомлений по электронной почте  
...
##  <a name="BKMK_Potential"></a>Потенциальные оповещения компьютера  
...
###  <a name="BKMK_Protect"></a>Защита компьютера  
