...
###  <a name="BKMK_StepThree"></a>Шаг 3. Связывание доменного имени в Интернете с Office 365 (необязательно)  
...
|Служба|Необходимые записи DNS|Описание|  
|-------------|--------------------------|-------------|  
