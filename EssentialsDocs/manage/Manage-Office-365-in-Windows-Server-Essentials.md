...
> [!IMPORTANT]
>   Интеграция с Office 365 поддерживается только в среде с одним контроллером домена. Кроме того, мастер интеграции Office 365 должен работать на контроллере домена.
...
-   [Шаг 1. Проверка выполнения требований для интеграции Office 365](#BKMK_StepOne_VERIFY)
...
3. **Привязка вашего настраиваемого домена Интернета к подписке Office 365.** Вы будете использовать действие **связать домен с Office 365** .

4. **Проверка использования службами Office 365 вашего нового доменного имени.**
