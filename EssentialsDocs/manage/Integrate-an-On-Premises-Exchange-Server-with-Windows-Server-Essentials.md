...
3. Для установки маршрутизации запросов приложений нажмите **Установить** и следуйте инструкциям.
   ...
   >
   >  По завершении установки может появиться сообщение о том, что не удалось установить исправление из статьи базы знаний (KB 2589179) для модуля маршрутизации запросов приложений версии 2.5. Это сообщение об ошибке можно игнорировать.
