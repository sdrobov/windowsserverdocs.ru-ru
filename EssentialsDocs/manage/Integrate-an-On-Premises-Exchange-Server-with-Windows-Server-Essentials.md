...
### <a name="what-do-i-need-to-know-about-email-accounts"></a>Что нужно знать об учетных записях электронной почты?  
 ...
 Псевдоним, указанный вами при запуске мастера добавления учетных записей пользователей, отправляется провайдеру как предлагаемое имя для псевдонима пользователя. Например, если псевдоним пользователя *FrankM*, электронный адрес пользователя может выглядеть *FrankM@Contoso.com*.  
