...
##  <a name="BKMK_2"></a>Увеличение объема хранилища на сервере  
...
-   **Не** отформатировано Если внутренний жесткий диск не отформатирован, отображается следующее оповещение: К серверу подключен один или несколько неформатированных жестких дисков. Выполните следующие действия, чтобы отформатировать жесткий диск.  
...
##  <a name="BKMK_Check"></a>Выполнение проверок и восстановление на жестких дисках  
...
###  <a name="BKMK_4a"></a>Использовать новый жесткий диск для хранения папок сервера  
...
3. В области **Задачи папок сервера** выполните одно из следующих действий.  
   ...
   > [!NOTE]
   >  Если перейти к жесткому диску и выбрать его в качестве папки сервера без создания папки, появится следующее сообщение об ошибке: **Корневой каталог (например, C:\\, D:\\) нельзя добавить в качестве серверной папки. Создайте новую или выберите существующую папку в корневом каталоге и повторите попытку**. Чтобы устранить эту ошибку, создайте новую папку на добавленном жестком диске и выберите новую папку в качестве расположения для хранения папок сервера.  
...
###  <a name="BKMK_4b"></a>Использовать новый жесткий диск для хранения резервных копий сервера  
...
###  <a name="BKMK_4c"></a>Используйте новый жесткий диск для увеличения емкости пула носителей  
...
##  <a name="BKMK_5"></a>Общие сведения о дисковых пространствах  
