...
3.  Если t места хранения существует, используйте новый жесткий диск для создания дискового пространства. Для этого необходимы по крайней мере два жестких диска.  
