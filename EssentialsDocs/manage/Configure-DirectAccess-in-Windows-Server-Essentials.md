...
###  <a name="BKMK_GrantFullPermissions"></a> Шаг 3a. Предоставление полных разрешений для прошедших проверку пользователей для шаблона сертификата веб сервера  
 Первая задача — Предоставление полных разрешений для проверки подлинности пользователей для шаблона сертификата веб сервера в центре сертификации.  
  
####  <a name="BKMK_ToGrantFullPermissions"></a> Для предоставления полных разрешений для Authenticated Users для шаблона сертификата веб сервера  
...
2.  В дереве консоли диспетчера DNS разверните локальный сервер, разверните узел **зоны прямого просмотра**, щелкните правой кнопкой мыши зону с суффиксом домена сервера и нажмите кнопку **новый узел (A или AAAA)** .  
