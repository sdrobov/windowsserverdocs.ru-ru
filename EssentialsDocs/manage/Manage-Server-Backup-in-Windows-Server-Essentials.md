...
-   [Остановка выполняемой архивации сервера](Manage-Server-Backup-in-Windows-Server-Essentials.md#BKMK_2)  
...
-   [Повторного разбиения жесткого диска на сервере](Manage-Server-Backup-in-Windows-Server-Essentials.md#BKMK_6)  
...
##  <a name="BKMK_2"></a> Остановка выполняемой архивации сервера  
...
4.  Если щелкнуть имя сервера в удаленного веб-доступа, откроется страница входа панели мониторинга отображается.  
...
##  <a name="BKMK_6"></a> Повторного разбиения жесткого диска на сервере  
