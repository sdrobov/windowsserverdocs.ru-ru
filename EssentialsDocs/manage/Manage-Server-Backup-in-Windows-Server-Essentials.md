...
##  <a name="BKMK_WhichBackup"></a>Какую резервную копию следует выбрать?  
...
##  <a name="BKMK_1"></a>Настройка или Настройка резервного копирования сервера  
...
##  <a name="BKMK_2"></a>Выполняется завершение резервного копирования сервера  
...
##  <a name="BKMK_4"></a>Отключить резервное копирование сервера  
...
##  <a name="BKMK_5"></a>Дополнительные сведения о настройке резервного копирования сервера  
...
###  <a name="BKMK_Target"></a>Диск назначения резервной копии  
...
##  <a name="BKMK_6"></a>Повторное разбиение жесткого диска на сервер  
