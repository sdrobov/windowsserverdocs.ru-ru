...
-   [Общие сведения об общих папках](Manage-Server-Folders-in-Windows-Server-Essentials.md#BKMK_11)  
  
-   [Общие сведения о теневых копиях](Manage-Server-Folders-in-Windows-Server-Essentials.md#BKMK_Shadow)  
...
|Удаление папки|Позволяет удалить папку, созданную пользователем. Эта задача недоступна для папок по умолчанию, которые создаются при установке сервера.|  
...
|Users|Используется для хранения и доступа пользователей сети к файлам. Пользовательская папка создается автоматически в папке сервера **Пользователи** для каждой создаваемой учетной записи пользователя сети.|  
...
-   [Скрыть папки сервера](Manage-Server-Folders-in-Windows-Server-Essentials.md#BKMK_Hide)  
  
-   [Задание разрешений для папок сервера](Manage-Server-Folders-in-Windows-Server-Essentials.md#BKMK_Perms)  
  
-   [Просмотр или изменение свойств папки сервера](Manage-Server-Folders-in-Windows-Server-Essentials.md#BKMK_10)  
  
###  <a name="BKMK_Hide"></a>Скрыть папки сервера  
...
4.  В области **задачи < серверфолдер\>** выберите пункт **Просмотр свойств папки**.  
  
5.  В **< имя_папки\> свойства**щелкните **общий доступ**, выберите **скрыть эту папку из удаленных веб-доступ и приложений веб-службы**, а затем нажмите кнопку **Применить**.  
  
###  <a name="BKMK_Perms"></a>Задание разрешений для папок сервера  
...
5.  В **< имя_папки\> свойства**на вкладке **Общие** просмотрите или измените имя и описание папки сервера.  
...
##  <a name="BKMK_11"></a>Общие сведения об общих папках  
...
##  <a name="BKMK_Shadow"></a>Общие сведения о теневых копиях  
