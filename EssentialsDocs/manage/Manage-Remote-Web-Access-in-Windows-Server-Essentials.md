...
###  <a name="BKMK_ReplaceRouter"></a> Замените маршрутизатор  
 Замените маршрутизатор в соответствии с инструкциями производителя и запустите набор мастер настройки маршрутизатора для настройки нового устройства.  
