...
4. [Удаление устаревших Active Directory объектов групповой политики (необязательно)](#remove-legacy-active-directory-group-policy-objects) 
