...
### [Поддержка для более крупных развертываний](get-started/support-for-larger-deployments.md)
...
### [Настройка и развертывание Windows Server Essentials в Windows Server](install/Customize-and-Deploy-Windows-Server-Essentials.md)
### [Комплект средств для развертывания и оценки для Windows Server Essentials](install/Assessment-and-Deployment-Kit-for-Windows-Server-Essentials.md)
...
###### [Создание файла Oobe.xml, включающего эмблему и лицензионное соглашение](install/Create-the-Oobe.xml-File-Including-Logo-and-EULA.md)
...
###### [Добавление элементов в ссылки УСТАНОВКИ, НАДСТРОЕК, КРАТКОГО СОСТОЯНИЯ и СПРАВКИ](install/Add-Entries-to-SETUP--ADD-INS--QUICK-STATUS--and-HELP-Links.md)
...
###### [Настройка поддержки беспроводных сетей](install/Configure-Support-for-a-Wireless-Network.md)
###### [Настройка разделов диска](install/Customize-Disk-Partitions.md)
###### [Настройка системы архивации данных сервера](install/Customize-Server-Backup.md)
...
##### [Добавление вкладки в раздел "Параметры"](install/Add-a-Tab-to-Settings.md)
##### [Добавление категорий верхнего уровня в панель запуска (операционная система Macintosh)](install/Add-Top-Level-Categories-to-the-Launchpad--Macintosh-Operating-System-.md)
##### [Изменение параметров потоковой передачи мультимедиа](install/Change-Media-Streaming-Settings.md)
##### [Изменение цветовой схемы панели администрирования и панели запуска](install/Change-the-Color-Scheme-of-the-Dashboard-and-Launchpad.md)
...
##### [Добавление информации о зарегистрированном партнере, заключившем партнерское соглашение об использовании интернет-служб Майкрософт](install/Add-Microsoft-Online-Service-Partner-Agreement-Partner-of-Record-Information.md)
...
### [Миграция с Windows Windows Server 2008 Foundation на Windows Server Essentials](migrate/Migrate-Windows-Server-2008-Foundation-to-Windows-Server-Essentials.md)
...
### [Перенос параметров и данных Windows SBS 2003 на целевой сервер для миграции Windows Server Essentials](migrate/Move-Windows-SBS-2003-settings-and-data-to-the-Destination-Server-for-Windows-Server-Essentials-migration.md)
### [Перенос параметров и данных Windows SBS 2008 на целевой сервер для миграции Windows Server Essentials](migrate/Move-Windows-SBS-2008-settings-and-data-to-the-Destination-Server-for-Windows-Server-Essentials-migration.md)
### [Перенос параметров и данных Windows SBS 2011 Essentials на целевой сервер для миграции Windows Server Essentials](migrate/Move-Windows-SBS-2011-Essentials-settings-and-data-to-the-Destination-Server-for-Windows-Server-Essentials-migration.md)
### [Перенос параметров и данных Windows SBS 2011 Standard на целевой сервер для миграции Windows Server Essentials](migrate/Move-Windows-SBS-2011-Standard-settings-and-data-to-the-Destination-Server-for-Windows-Server-Essentials-migration.md)
### [Перенос параметров и данных Windows Server 2008 Foundation на целевой сервер для миграции Windows Server Essentials](migrate/Move-Windows-Server-2008-Foundation-settings-and-data-to-the-Destination-Server-for-Windows-Server-Essentials-migration.md)
### [Выполнение задач после миграции для Windows Server Essentials](migrate/Perform-post-migration-tasks-for-Windows-Server-Essentials-migration.md)
...
### [Шаг 1. Подготовка исходного сервера для миграции Windows Server Essentials](migrate/Step-1--Prepare-your-Source-Server-for-Windows-Server-Essentials-migration.md)
### [Шаг 2. Установка Windows Server Essentials в качестве нового репликата контроллера домена](migrate/Step-2--Install-Windows-Server-Essentials-as-a-new-replica-domain-controller.md)
...
### [Шаг 4. Перенос параметров и данных на целевой сервер для миграции Windows Server Essentials](migrate/Step-4--Move-settings-and-data-to-the-Destination-Server-for-Windows-Server-Essentials-migration.md)
### [Шаг 5. Включение перенаправления папок на целевом сервере для миграции Windows Server Essentials](migrate/Step-5--Enable-folder-redirection-on-the-Destination-Server-for-Windows-Server-Essentials-migration.md)
...
### [Шаг 7. Задачи, выполняемые после миграции Windows Server Essentials](migrate/Step-7--Perform-post-migration-tasks-for-the-Windows-Server-Essentials-migration.md)
...
### [Управление повсеместным доступом в Windows Server 2012 Essentials](manage/Manage-Anywhere-Access-in-Windows-Server-Essentials.md)
### [Управление приложениями в Windows Server Essentials](manage/Manage-Applications-in-Windows-Server-Essentials.md)
### [Управление архивацией и восстановлением в Windows Server Essentials](manage/Manage-Backup-and-Restore-in-Windows-Server-Essentials.md)
### [Управление BranchCache в Windows Server Essentials](manage/Manage-BranchCache-in-Windows-Server-Essentials.md)
### [Управление архивацией клиентского компьютера в Windows Server Essentials](manage/Manage-Client-Computer-Backup-in-Windows-Server-Essentials.md)
### [Управление устройствами в Windows Server Essentials](manage/Manage-Devices-in-Windows-Server-Essentials.md)
### [Управление мультимедиа в Windows Server Essentials](manage/Manage-Digital-Media-in-Windows-Server-Essentials.md)
...
### [Управление веб-службами Microsoft в Windows Server Essentials](manage/Manage-Microsoft-Online-Services-in-Windows-Server-Essentials.md)
...
### [Управление оперативной архивацией в Windows Server Essentials](manage/Manage-Online-Backup-in-Windows-Server-Essentials.md)
...
### [Управление архивацией сервера в Windows Server Essentials](manage/Manage-Server-Backup-in-Windows-Server-Essentials.md)
...
### [Обзор Launchpad в Windows Server Essentials](manage/Overview-of-the-Launchpad-in-Windows-Server-Essentials.md)
...
### [Настройка архивации сервера](manage/Set-up-or-customize-server-backup.md)
## [Работа с Windows Server Essentials](use/Use-Windows-Server-Essentials.md)
### [Установка подключения в Windows Server Essentials](use/Get-Connected-in-Windows-Server-Essentials.md)
### [Воспроизведение мультимедиа в Windows Server Essentials](use/Play-Digital-Media-in-Windows-Server-Essentials.md)
...
### [Использование приложения My Server для подключения к Windows Server Essentials](use/Use-the-My-Server-App-to-Connect-to-Windows-Server-Essentials.md)
...
### [Устранение неполадок архивации и восстановления данных в Windows Server Essentials](support/Troubleshoot-computer-backup-and-restore-errors-in-Windows-Server-Essentials.md)
