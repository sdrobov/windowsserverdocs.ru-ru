...
|------------------|------------------------|  
|Запись|— Два физических диска;<br /><br /> — Настроен в качестве зеркального набора RAID 1, который содержит следующее:<br /><br /> -C: том? 60 ГБ<br /><br /> -D: том? 1000 ГБ|  
...
|Высока|-Пять или более общих физических дисков<br /><br /> — Два диска в наборе с зеркальным отображением RAID 1, который содержит том C:? 100 ГБ<br /><br /> — Все остальные диски в наборе RAID 5, который содержит следующее:<br /><br /> -D: том? 1500 ГБ<br /><br /> -E: том? 1500 ГБ|  
