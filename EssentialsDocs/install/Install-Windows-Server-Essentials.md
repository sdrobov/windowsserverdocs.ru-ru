...
-   [Документация по выпуску для Windows Server Essentials](../get-started/release-notes.md)  
...
-   [Размещения Windows Server Essentials Experience в Windows виртуальных машинах Azure](https://msdn.microsoft.com/library/dn520828.aspx) (MSDN)  
