...
3.  Для каждой задачи или ссылки необходимо добавить строки и значения в файл OEMHomePageContent.home.resx, которые соответствуют элементам Task и Link, которые определены в файле OEMHomePageContent.home. В следующем коде показан пример файла Tasks.xml, структура которого соответствует файлу ресурсов.  
