...
ms.locfileid: "71369890"
---
# <a name="configuring-cluster-accounts-in-active-directory"></a>Настройка учетных записей кластеров в Active Directory

Относится к: Windows Server 2019, Windows Server 2016, Windows Server 2012 R2, Windows Server 2012, Windows Server 2008 R2 и Windows Server 2008
...
2.  Если учетная запись, созданная или полученная на шаге 1, не включена автоматически в группу локальных **администраторов** на компьютерах в домене, добавьте учетную запись в группу локальных **администраторов** на серверах, которые будут узлами в отработке отказа. кластеризован
