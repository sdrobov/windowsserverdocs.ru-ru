...
ms.locfileid: "71369797"
---
# <a name="create-a-failover-cluster"></a>создание отказоустойчивого кластера

>Относится к: Windows Server 2019, Windows Server 2016, Windows Server 2012 R2 и Windows Server 2012
...
> [!NOTE]
> Командлет **Test-Cluster** выводит результаты в файл журнала в текущем рабочем каталоге. Пример: C:\Users @ no__t-0username > \AppData\Local\Temp.
