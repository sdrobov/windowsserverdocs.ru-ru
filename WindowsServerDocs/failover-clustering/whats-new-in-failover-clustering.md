...
- **Усовершенствования файлового ресурса-свидетеля** Мы включили использование файлового ресурса-свидетеля в следующих сценариях: 
  ...
  - В Рабочей группе или кластере между доменами, для которых отсутствует Active Directory объект имени кластера (CNO). Дополнительные сведения об этих усовершенствованиях см. в следующих публикациях в блогах по управлению сервером &. Файловый ресурс-свидетель отказоустойчивого кластера и DFS.
...
### <a name="BKMK_RollingUpgrade"></a>Последовательное обновление операционной системы кластера
...
> -   Пока не будет запущен командлет `Update-ClusterFunctionalLevel`, процесс будет отменен, и можно будет добавить узлы Windows Server 2012 R2, а также удалить узлы Windows Server 2016. 
...
### <a name="BKMK_CloudWitness"></a>Облачный следящий сервер  
...
### <a name="BKMK_VMs"></a>Устойчивость виртуальной машины  
...
Дополнительные сведения о рабочем процессе и параметрах карантина для вычислений виртуальной машины, управляющих размещением узла в изоляции или помещении в карантин, см. [в разделе устойчивость вычислений виртуальной машины в Windows Server 2016](http://blogs.msdn.com/b/clustering/archive/2015/06/03/10619308.aspx). 
...
Дополнительные сведения см. в статье о [кластерах Рабочей группы и нескольких доменов в Windows Server 2016](http://blogs.msdn.com/b/clustering/archive/2015/08/17/10635825.aspx) .  
...
### <a name="BKMK_SMBMultiChannel"></a>Упрощенные сети с многоканальными и многосетевыми кластерами SMB  
