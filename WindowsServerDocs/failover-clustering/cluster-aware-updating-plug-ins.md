...
## <a name="install-a-plug-in"></a><a name="BKMK_INSTALL"></a>Установка подключаемого\-в  
...
### <a name="configure-the-windows-update-agent-query-string"></a><a name="BKMK_QUERY"></a>Настройка строки запроса агента Центр обновления Windows  
...
## <a name="use-the-microsofthotfixplugin"></a><a name="BKMK_HFP"></a>Использование Microsoft. Хотфиксплугин  
...
- Параметры на сервере, на котором размещается корневая папка исправления, для проверки соответствующих разрешений на доступ к папке и обеспечения целостности данных, доступ к которым осуществляется из общей папки SMB \(подписывания SMB или\)шифрования SMB. Подробнее см. в подразделе [Ограничение доступа к корневой папке с исправлениями](#BKMK_ACL).
...
### <a name="configure-a-hotfix-root-folder-structure"></a><a name="BKMK_HF_ROOT"></a>Настройка структуры корневых папок исправлений
...
### <a name="customize-the-hotfix-configuration-file"></a><a name="BKMK_CONFIG_FILE"></a>Настройка файла конфигурации исправления  
...
### <a name="restrict-access-to-the-hotfix-root-folder"></a><a name="BKMK_ACL"></a>Ограничение доступа к корневой папке исправления  
