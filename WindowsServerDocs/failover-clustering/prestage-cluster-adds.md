...
## <a name="step-1-prestage-the-cno-in-ad-ds"></a>Шаг 1. Предварительная настройка CNO в AD DS
...
@no__t 0Figure 1. Отключенные CNO в примере Clusters OU @ no__t-0
...
5. Выберите добавленную учетную запись пользователя или группу и около пункта **Полный доступ**установите флажок **Разрешить** .
   ...
   @no__t 0Figure 2. Предоставление полного доступа пользователю или группе, которые будут создавать кластер @ no__t-0
6. Нажмите кнопку **ОК**.
...
## <a name="step-3-grant-the-cno-permissions-to-the-ou-or-prestage-vcos-for-clustered-roles"></a>Шаг 3. Предоставьте разрешения CNO для подразделения или предварительной подготовки VCO для кластерных ролей.
...
1. На странице "Пользователи и компьютеры Active Directory" в меню **Вид** убедитесь, что выбран пункт **Дополнительные параметры**.
2. Щелкните правой кнопкой мыши подразделение, в котором вы создали CNO, в [Step 1: Выполните предварительную настройку CNO в AD DS @ no__t-0, а затем выберите **Свойства**.
...
9. В разделе **Разрешения** установите флажок **Создание объектов-компьютеров**.
   ...
   @no__t 0Figure 3. Предоставление разрешения на создание объектов компьютеров для CNO @ no__t-0
