...
>[!NOTE]
>В первоначальном выпуске System Insights необходимо указать сценарии исправления за пределами пользовательских каталогов. Это будет исправлено в следующем выпуске.
