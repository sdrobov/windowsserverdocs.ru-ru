...
### [Видеоролики](understand/videos.md)
...
### [Ведение журналов](use/logging.md)


## Подключение к Azure
### [Гибридная среда Azure служб](azure/index.md)
#### [Azure резервного копирования](azure/azure-backup.md)
#### [Azure Site Recovery](azure/azure-site-recovery.md)
#### [Синхронизации Azure файлов](azure/azure-file-sync.md)
#### [Мониторинг Azure](azure/azure-monitor.md)
...
### [Общие инструкции по устранению проблем](support/troubleshooting.md)
### [Известные проблемы](support/known-issues.md)


## Расширение
### [Обзор расширений](extend/extensibility-overview.md)
### [Общее понимание расширений](extend/understand-extensions.md)
...
#### [Разработка расширения средства](extend/develop-tool.md)
...
### [Руководства](extend/guides.md)
#### [Добавление модуля в расширение средства](extend/guides/add-module.md)
#### [Добавление iFrame в расширение средства](extend/guides/add-iFrame.md)
#### [Использование пользовательского подключаемого модуля шлюза в расширении средства](extend/guides/use-custom-gateway-plugin.md)
