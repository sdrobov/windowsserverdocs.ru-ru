...
## <a name="known-issue-appcontextserviceactiveconnectionishyperconvergedclusterisfailovercluster-is-not-set-properly-in-windows-admin-center-v1909"></a>Известная ошибка: Аппконтекстсервице. activeConnection. Ишиперконвержедклустер/Исфаиловерклустер неправильно задан в Windows Admin Center v1909
