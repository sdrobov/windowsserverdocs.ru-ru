---
title: Защита виртуальных машин Hyper-V с помощью Azure Site Recovery и Windows Admin Center
...
ms.locfileid: "9297029"
---
# Защита виртуальных машин Hyper-V с помощью Azure Site Recovery и Windows Admin Center
...
## Что такое служба Azure Site Recovery и как она работает с Windows Admin Center? 
...
## Этап 1. Настройка защиты виртуальной машины на целевом узле
...
8.  Подождите, пока не появится уведомление: **Настройка параметров восстановления сайта завершена**.
 
Этот процесс может занять больше 10минут. Можно отслеживать ход выполнения, перейдя в раздел **Уведомления** (значок звонка в верхнем правом углу).
...
## Этап 2. Выбор виртуальных машин для защиты
...
## Этап 3. Настройка и запуск тестовой отработки отказа на портале Azure
...
## Мониторинг реплицированных виртуальных машин в Azure ##
