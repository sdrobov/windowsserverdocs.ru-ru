...
## <a name="working-with-certificate-rules"></a><a name="BKMK_Cert_Rules"></a>Работа с правилами сертификатов
...
## <a name="working-with-path-rules"></a><a name="BKMK_Path_Rules"></a>Работа с правилами пути
