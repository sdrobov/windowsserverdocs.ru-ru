...
## <a name="to-open-software-restriction-policies"></a><a name="BKMK_Open_SRP"></a>Открытие политик ограниченного использования программ
...
### <a name="for-a-domain-site-or-organizational-unit-and-you-are-on-a-member-server-or-on-a-workstation-that-is-joined-to-a-domain"></a><a name="BKMK_2"></a>Для домена, сайта или подразделения, а также на рядовом сервере или на рабочей станции, присоединенной к домену.
...
### <a name="for-a-site-and-you-are-on-a-domain-controller-or-on-a-workstation-that-has-the-remote-server-administration-tools-installed"></a><a name="BKMK_4"></a>Для сайта, который находится на контроллере домена или на рабочей станции с установленным средства удаленного администрирования сервера
...
## <a name="to-prevent-software-restriction-policies-from-applying-to-local-administrators"></a><a name="BKMK_Prevent_Admin"></a>Предотвращение применения политик ограниченного использования программ к локальным администраторам
...
## <a name="to-apply-software-restriction-policies-to-dlls"></a><a name="BKMK_Apply_SRP_DLLs"></a>Применение политик ограниченного использования программ к DLL
