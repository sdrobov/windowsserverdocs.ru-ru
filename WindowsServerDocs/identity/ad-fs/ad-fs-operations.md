...
Этот документ содержит список всех операций документации по AD FS для Windows Server 2016. Это следующие атрибуты:  
...
- [Параметры единого входа в AD FS 2016](../ad-fs/operations/AD-FS-2016-Single-Sign-On-Settings.md)
...
- [Добавьте атрибут Store](../ad-fs/operations/Add-an-Attribute-Store.md)
...
- [Настройка AD FS 2016 и Azure MFA](../ad-fs/operations/Configure-AD-FS-2016-and-Azure-MFA.md)
