---
title: Миграция изолированного AD FS сервера федерации или AD FS фермы с одним узлом
...
ms.locfileid: "71359381"
---
# <a name="migrate-a-stand-alone-ad-fs-federation-server-or-a-single-node-ad-fs-farm"></a>Миграция изолированного AD FS сервера федерации или AD FS фермы с одним узлом  
...
Выполняя действия в мастере, используйте информацию, полученную в ходе подготовки к миграции сервера федерации AD FS, следующим образом.  
 ...
 |**Параметр input мастера настройки сервера федерации**|**Используйте следующее значение**| 
|-----|-----| 
...
> [!IMPORTANT] 
> Этот метод можно использовать только при использовании внутренней базы данных Windows (WID) для хранения базы данных конфигурации AD FS для изолированного сервера федерации или фермы AD FS с одним узлом.  
>
>  Если вы используете SQL Server для хранения базы данных конфигурации AD FS для фермы AD FS с одним узлом, необходимо использовать Windows PowerShell для создания исходной конфигурации AD FS на сервере федерации.  
