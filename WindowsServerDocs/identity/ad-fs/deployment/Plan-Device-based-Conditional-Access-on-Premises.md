...
|Управление устройствами    |      Политики MDM (с дополнительной регистрацией в Intune)   | Политики MDM (с дополнительной регистрацией в Intune)        |   Групповая политика, System Center Configuration Manager (SCCM) |
