...
После настройки компьютера с необходимыми приложениями и сертификатами вы можете установить службу роли прокси-агент службы федерации службы федерации Active Directory (AD FS) \(AD FS @ no__t-1. Для установки службы роли прокси-агент службы федерации можно использовать следующую процедуру. При установке службы роли прокси-агент службы федерации на компьютере этот компьютер станет прокси-сервером федерации.  
