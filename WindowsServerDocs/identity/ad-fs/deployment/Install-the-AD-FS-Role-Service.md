...
3.  На странице **Выбор типа установки** выберите **роль @ no__t-2based или Feature @ no__t-3based установки**, а затем нажмите кнопку **Далее**.  
...
7.  На странице **Active Directory служба федерации \(ad FS @ no__t-2** нажмите кнопку **Далее**.  
  
8.  После проверки сведений на странице **Подтверждение выбора установки** нажмите кнопку **установить**.  
