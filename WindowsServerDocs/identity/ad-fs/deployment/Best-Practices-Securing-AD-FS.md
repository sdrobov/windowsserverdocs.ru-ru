...
Используемый протокол |Порты |Описание
--------- | --------- |---------
...
Дополнительные сведения о необходимых портах и протоколах, необходимых для гибридных развертываний, [см. в этом документе](https://azure.microsoft.com/documentation/articles/active-directory-aadconnect-ports/).
...
Значение свойства равно `ExtendedProtectionTokenCheck`.  Значение по умолчанию — Allow, поэтому преимущества безопасности могут быть достигнуты без проблем совместимости с браузерами, которые не поддерживают эту возможность.  
