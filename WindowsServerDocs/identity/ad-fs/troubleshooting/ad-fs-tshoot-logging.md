...
4.       Откройте командную строку с повышенными привилегиями и выполните следующую команду, чтобы включить аудит auditpol.exe/set /subcategory: «Создано приложением» /success:enable /failure:enable 5.       Закрыть **Локальная политика безопасности**, а затем откройте оснастку управления AD FS.
 
Чтобы открыть оснастку управления AD FS, нажмите кнопку Пуск, выберите программы, Администрирование и управление AD FS.
 
6.       В области действий щелкните Изменить свойства-7 службы федерации.       В диалоговом окне Свойства службы федерации перейдите на вкладку события. 8.       Выберите **успешные события аудита** и **неудачные события аудита** флажки.
9.       Нажмите кнопку "ОК".
