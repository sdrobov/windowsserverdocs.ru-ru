...
![усовершенствований аудита](media/ad-fs-tshoot-logging/event2.PNG)  
3.  Развернуть трассировку AD FS
4.  Щелкните отладку правой кнопкой мыши и выберите **Включить журнал**.
![усовершенствований аудита](media/ad-fs-tshoot-logging/event3.PNG)  
...
|Тип события|код события;|Описание| 
|----- | ----- | ----- | 
