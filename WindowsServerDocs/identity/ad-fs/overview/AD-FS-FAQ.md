...
- aza - при использовании [расширения протокола OAuth 2.0 для клиентов Broker](https://docs.microsoft.com/openspecs/windows_protocols/ms-oapxbc/2f7d8875-0383-4058-956d-2fb216b44706) и, если параметр области содержит область «aza», сервер выдает новый маркер обновления основной и задает его в поле refresh_token ответа, а также параметр поле refresh_token_expires_in времени существования новый маркер основной обновления, если он применяется.
