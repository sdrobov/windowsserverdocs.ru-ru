...
> [!CAUTION]  
> Сертификаты, используемые для маркера\-подписи и маркера\-расшифровку\/шифрования, важны для стабильности служба федерации. Клиенты, управляющие собственным маркером\-подписи маркера &\-расшифровку\/шифрование сертификатов должны обеспечить их резервное копирование и доступность во время события восстановления.  
...
-   Указание имени сервера \(SNI\) должны поддерживаться  
