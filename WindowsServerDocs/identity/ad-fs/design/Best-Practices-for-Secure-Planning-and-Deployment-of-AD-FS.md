...
-   **Используйте мастер настройки безопасности, чтобы применить рекомендации по обеспечению безопасности AD FS к серверам федерации и прокси-серверам федерации.**  
    ...
    |Серверная роль AD FS|Используемая база данных конфигурации AD FS|В командной строке введите следующую команду:|  
    |---------------------|-------------------------------------|---------------------------------------------------|  
...
-   **Использование расширенной защиты для проверки подлинности**  
    ...
    |-------------------|------------------|----------------------|  
    |Требовать|Сервер полностью защищен.|Расширенная защита активирована и требуется всегда.|  
    |Разрешение|Сервер частично защищен.|Расширенная защита активирована, если в соответствующих системах установлены исправления для поддержки этой функции|  
...
Следующие рекомендации по обеспечению безопасности относятся к использованию Microsoft SQL Server&reg; или внутренней базы данных Windows (WID), если эти технологии баз данных используются для управления данными в AD FS проектировании и развертывании.  
