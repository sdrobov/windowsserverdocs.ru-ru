...
Важной частью разработки новой инфраструктуры службы федерации Active Directory (AD FS) \(AD FS @ no__t-1 в организации партнера по ресурсам является определение полного набора приложений и служб, которые будут использоваться для участия в Федерации и Партнеры по учетным записям будут являться получателями этих ресурсов. Перед созданием стратегии работы с федеративными приложениями и службами ответьте на следующие вопросы.  
  
-   Будет ли включено и развернуто приложение ASP.NET или служба Windows Communication Foundation \(WCF @ no__t-1 для Федерации?  
...
-   Все ли веб-серверы размещают Федеративные приложения под управлением операционной системы Windows Server и службы IIS \(IIS @ no__t-1?  
...
Дополнительные сведения о создании приложения Claims @ no__t-0aware ASP.NET или службы WCF см. в разделе [пакет SDK для Windows Identity Foundation](https://go.microsoft.com/fwlink/?LinkId=122266).  
