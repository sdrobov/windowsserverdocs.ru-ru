...
### <a name="example-how-to-issue-group-claims-based-on-the-users-group-membership"></a>Пример. Выдача групповых заявок на основе членства пользователя в группах  
