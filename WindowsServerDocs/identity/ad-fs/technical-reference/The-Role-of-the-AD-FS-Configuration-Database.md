...
В базе данных конфигурации AD FS хранятся все данные конфигурации, представляющие единственный экземпляр службы федерации Active Directory (AD FS) \(AD FS\) \(, то есть служба федерации\). База данных конфигурации AD FS определяет набор параметров, необходимых службе федерации для идентификации партнеров, сертификатов, хранилищ атрибутов, утверждений и разнообразных данных об этих связанных сущностях. Эти данные конфигурации можно хранить либо в базе данных Microsoft SQL Server®, либо во внутренней базе данных Windows \(WID\), которая входит в состав Windows Server® 2008, Windows Server 2008 R2 и Windows Server® 2012.  
