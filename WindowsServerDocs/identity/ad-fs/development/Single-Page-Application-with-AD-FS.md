...
1.  ПОСТОЯННЫЙ Контроллер домена для домена, в котором будет размещаться AD FS
...
**Усердатаконтроллер. js** — показывает, как извлечь сведения о пользователе из кэшированного id_token.
...
![Пользователей](media/Single-Page-Application-with-AD-FS/singleapp4a.PNG)
