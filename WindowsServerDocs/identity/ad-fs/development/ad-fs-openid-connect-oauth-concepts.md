...
![Поток проверки подлинности AD FS](media/adfs-modern-auth-concepts/adfsauthflow.png)
 ...
 5. После проверки разрешений и областей AD FS проверяет подлинность пользователя с помощью настроенного [метода проверки](../operations/configure-authentication-policies.md)подлинности.   

 6. Если требуется [дополнительный метод проверки](../operations/configure-additional-authentication-methods-for-ad-fs.md) подлинности в соответствии с политикой ресурсов или глобальной политикой аутентификации, AD FS активирует дополнительную проверку подлинности. 
