...
* **ToDoListClient**: Он будет выступать в качестве клиента OpenID Connect, с которым будет взаимодействовать пользователь.
* **ToDoListService**: Это будет приложение или служба сервера среднего уровня, которые будут взаимодействовать с другой серверной WebAPI, OBO прошедший проверку подлинности пользователь
...
* Для ключа Ida: ClientID укажите идентификатор клиента, который AD FS задан при настройке MySampleGroup_ClientApplication.
...
* Укажите имя соответствующего контроллера
