...
4.  В разделе **выберите Дополнительные методы проверки подлинности** в нижней части страницы, установите флажок для AdminName вашего поставщика. Нажмите кнопку **Применить**.
...
1.  Во-первых включите поставщик в глобальную политику:
    ...
    > [!NOTE]
    > Обратите внимание, что значение, указанное для параметра AdditionalAuthenticationProvider соответствует значению, заданное для параметра «Name» в командлете Register-AdfsAuthenticationProvider выше и свойство «Name» из Выходные данные командлета Get-AdfsAuthenticationProvider. 
    > <P></P>

    
    Пример:`PS C:\>Set-AdfsGlobalAuthenticationPolicy –AdditionalAuthenticationProvider “MyMFAAdapter”`
...
4.  В разделе **выберите Дополнительные методы проверки подлинности**, установите флажок для AdminName вашего поставщика. Нажмите кнопку **Применить**.
