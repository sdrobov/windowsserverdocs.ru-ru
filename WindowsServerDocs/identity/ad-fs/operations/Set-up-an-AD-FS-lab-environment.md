...
-   [Пошаговое руководство. Управление рисками с помощью контроля условного доступа](Walkthrough-Guide--Manage-Risk-with-Conditional-Access-Control.md)  
...
Сведения о создании учетных записей пользователей и групп в Active Directory (AD) см. в разделе [https://technet.microsoft.com/library/cc783323%28v=ws.10%29.aspx](https://technet.microsoft.com/library/cc783323%28v=ws.10%29.aspx).  
