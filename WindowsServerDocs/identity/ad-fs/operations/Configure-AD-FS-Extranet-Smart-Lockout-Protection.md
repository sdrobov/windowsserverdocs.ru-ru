...
ESL доступна только для имени пользователя и пароль проверки подлинности запросов, которые были переданы через за пределами корпоративной сети с помощью прокси веб-приложения или сторонней стороннего прокси-сервера. Любые сторонние сторона прокси-сервер должен поддерживать протокол MS-ADFSPIP для использования вместо прокси веб-приложения, такие как [F5 BIG-IP Access Policy Manager](https://devcentral.f5.com/s/articles/ad-fs-proxy-replacement-on-f5-big-ip-30191). В документации сторонних производителей прокси-сервера для определения того, если прокси-сервер поддерживает протокол MS-ADFSPIP.   
