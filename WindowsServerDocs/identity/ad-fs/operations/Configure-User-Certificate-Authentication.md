...
7) При использовании проверки подлинности на основе смарт-карты или сертификата субъект сертификата может не соответствовать УсерприЦипалнаме в учетной записи AD. В этом случае вход завершается неудачей с параметром "пользователь не найден".
