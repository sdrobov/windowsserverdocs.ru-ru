...
- **Баккупкоммент &lt;STRING [] &gt;** — информационная строка, которая будет отображаться во время восстановления, аналогично концепции именования контрольных точек Hyper-V. Значение по умолчанию — пустая строка.
...
- **&lt;СтрокаStorageType&gt;** — тип хранилища, который пользователь хочет использовать.
...
- **&lt;Строкадбконнектионстринг&gt;** . Если пользователь хочет использовать другую базу данных для восстановления, он должен передать строку подключения SQL или тип в WID для WID.
...
>[!NOTE]
> При выполнении восстановления может быть создан файл PostRestore_Instructions, содержащий общие сведения о дополнительных поставщиках проверки подлинности, хранилищах атрибутов и локальных отношениях доверия поставщиков утверждений, которые устанавливаются вручную перед запуском службы AD FS.

## <a name="version-release-history"></a>Журнал выпусков версий

### <a name="version-10820"></a>Версия 1.0.82.0
Отпускании 2019 июля
...
Отпускании Июля 2018 г.

**Исправлены проблемы:**

   - Исправление ошибки: Исправлена. Установщик MSI для поддержки обновлений на месте 
