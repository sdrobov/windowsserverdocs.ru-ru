...
## <a name="BKMK_2"></a>Шаг 2. Проверка механизма проверки подлинности AD FS по умолчанию
...
## <a name="BKMK_3"></a>Шаг 3. Настройка MFA на сервере федерации
...
## <a name="BKMK_4"></a>Шаг 4. Проверка механизма MFA
