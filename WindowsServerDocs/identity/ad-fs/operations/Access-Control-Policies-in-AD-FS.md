...
| --- | --- |  
|Для доступа к экстрасети требуется MFA<p>Все пользователи разрешены|**#1 правила**<p>из **экстрасети**<p>и с MFA<p>Пуст<p>**Правило 2**<p>из **интрасети**<p>Пуст|  
|Внешний доступ не разрешен, кроме FTE<p>Разрешен доступ к интрасети для устройства с присоединением FTE на рабочем месте|**#1 правила**<p>из **экстрасети**<p>и из группы **не FTE**<p>Пуст<p>**#2 правила**<p>из **интрасети**<p>и с **присоединенного устройства на рабочем месте**<p>и из группы **FTE**<p>Пуст|  
|Для доступа к экстрасети требуется MFA, за исключением администратора службы<p>Всем пользователям разрешен доступ|**#1 правила**<p>из **экстрасети**<p>и с MFA<p>Пуст<p>Кроме **группы администраторов службы**<p>**#2 правила**<p>постоянно<p>Пуст|  
|для доступа к подключенному к рабочему месту устройству из экстрасети требуется MFA<p>Разрешите AD Fabric доступ к интрасети и экстрасети|**#1 правила**<p>из **интрасети**<p>И из группы " **структура AD** "<p>Пуст<p>**#2 правила**<p>из **экстрасети**<p>и с устройства, **не присоединенного к рабочему месту**<p>И из группы " **структура AD** "<p>и с MFA<p>Пуст<p>**#3 правила**<p>из **экстрасети**<p>и с **присоединенного устройства на рабочем месте**<p>И из группы " **структура AD** "<p>Пуст|  
