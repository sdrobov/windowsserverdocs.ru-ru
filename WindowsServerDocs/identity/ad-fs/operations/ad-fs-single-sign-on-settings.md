...
AD FS 2016 изменяет PSSO при прохождении проверки подлинности запрашивающей стороне с зарегистрированного устройства, увеличение максимального 90 дней, но проверка подлинности (окно использования устройства) в течение 14 дней.
