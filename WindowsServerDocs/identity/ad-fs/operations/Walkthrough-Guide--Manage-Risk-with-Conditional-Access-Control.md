...
В этом пошаговом руководстве приводятся инструкции по управлению риском с использованием одного из факторов (данных пользователя), доступного в рамках механизма условного управления доступом в федерации служб Active Directory (AD FS) в Windows Server 2012 R2. Дополнительные сведения о механизмах условного доступа и авторизации в AD FS в Windows Server 2012 R2 см. в разделе [Manage Risk with Conditional Access Control](../../ad-fs/operations/Manage-Risk-with-Conditional-Access-Control.md).
...
-   Домен Active Directory с помощью тестового пользователя и групповые учетные записи, под управлением Windows Server 2008, Windows Server 2008 R2 или Windows Server 2012 со схемой, обновленной до Windows Server 2012 R2 или домен Active Directory под управлением Windows Server 2012 R2
