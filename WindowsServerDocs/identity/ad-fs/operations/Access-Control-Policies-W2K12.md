...
- 10.0.0.1 – 10.0.0.14  
  ...
  Это дает возможность ввести любое количество адресов. Если необходимо разрешить диапазон адресов, например 192.168.1.1 – 192.168.1.25, то сопоставление должно выполняться по символу: \b192\\.\\168\\. [1-9] &#124;1 [0-9]&#124;2 [0-5]) \b  
...
- И поместив их вместе, следующее выражение должно соответствовать всем адресам для "192.168.1.1 ~ 25" и "10.0.0.1 ~ 14": \b192\\. 168\\0,1\\. ( [1-9] &#124;1 [0-9]&#124;2 [0-5]) \b&#124;\b10\\0\\0\\. ( [1-9] &#124;1 [0-4]) \b  
