...
- Чтобы проверить очистку метаданных, выполните **команду repadmin/виевлист \\** *, чтобы получить список всех контроллеров домена в лесу. Выполните команду **nltest/дклист:** *<\>домена* , чтобы получить список всех контроллеров домена в домене. 
