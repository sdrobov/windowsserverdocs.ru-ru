...
### <a name="rid-block-size-limit"></a><a name="BKMK_RIDBlockMaxSize"></a>Ограничение размера блока RID  
...
### <a name="global-rid-space-size-unlock"></a><a name="BKMK_GlobalRidSpaceUnlock"></a>Разблокирование глобального размера пространства RID  
...
## <a name="troubleshooting-rid-issuance"></a><a name="BKMK_Tshoot"></a>Устранение неполадок выдачи RID  
