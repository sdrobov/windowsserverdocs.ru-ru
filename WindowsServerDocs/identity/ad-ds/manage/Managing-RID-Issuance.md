...
Дополнительные сведения можно найти в [блоге аскдс](http://blogs.technet.com/b/askds/archive/2012/08/10/managing-rid-issuance-in-windows-server-2012.aspx).  
...
|Source|Directory-Services-SAM|  
|severity|Сведения|  
|`Message`|Глобальный максимум идентификаторов учетных записей (относительных идентификаторов) был увеличен до %1.|  
