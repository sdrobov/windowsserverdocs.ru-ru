...
|        **Source**        |                                                                                                                                                                                                     Microsoft-Windows-ActiveDirectory_DomainService                                                                                                                                                                                                     |
|       **Серьезности**       |                                                                                                                                                                                                                      Сведения                                                                                                                                                                                                                      |
|       **Сообщение**        | *<COMPUTERNAME>* установите следующее значение реестра, чтобы включить обновления DNS.<br /><br />Раздел реестра:%1<br /><br />Значение реестра:% 2<br /><br />Данные значения реестра:% 3<br /><br />В ходе клонирования локальный компьютер в течение короткого времени может иметь то же имя, что и клонируемый компьютер. Регистрация А- и АААА-записей DNS на это время отключается, чтобы клиенты не могли направлять запросы на локальный компьютер, участвующий в клонировании. |
| **Примечания и разрешение** |                                                                                                                                                                                                Это событие успешного выполнения операции, которое является неполадкой только в случае непредвиденного возникновения.                                                                                                                                                                                                 |
...
|Source|Microsoft-Windows-ActiveDirectory_DomainService|  
|severity|Ошибка|  
|`Message`|<COMPUTERNAME> не удалось создать объекты для клонированного контроллера домена.<br /><br />Дополнительные данные:<br /><br />Идентификатор клона:% 6<br /><br />Клонировать имя контроллера домена:% 1<br /><br />Цикл повторных попыток:% 2<br /><br />Значение исключения:% 3<br /><br />Значение ошибки:% 4<br /><br />ДСИД:% 5|  
...
|Source|Microsoft-Windows-ActiveDirectory_DomainService|  
|severity|Сведения|  
|`Message`|<COMPUTERNAME> создал объекты для клонированного контроллера домена.<br /><br />Дополнительные данные:<br /><br />Идентификатор клона:% 3<br /><br />Клонировать имя контроллера домена:% 1<br /><br />Цикл повторных попыток:% 2|  
...
|Source|Microsoft-Windows-ActiveDirectory_DomainService|  
|severity|Сведения|  
|`Message`|<COMPUTERNAME> начал создавать объекты для клонированного контроллера домена.<br /><br />Дополнительные данные:<br /><br />Идентификатор клона:% 1<br /><br />Имя клона:% 2<br /><br />Клонировать сайт:% 3<br /><br />Клонировать RODC:% 4|  
|Примечания и решение|Это событие успешного выполнения операции, которое является неполадкой только в случае непредвиденного возникновения.|  
...
|Source|Microsoft-Windows-ActiveDirectory_DomainService|  
|severity|Сведения|  
|`Message`|<COMPUTERNAME> создал новый объект KrbTgt для клонирования контроллера домена только для чтения.<br /><br />Дополнительные данные:<br /><br />Идентификатор клона:% 1<br /><br />Новый GUID объекта KrbTgt:% 2|  
|Примечания и решение|Это событие успешного выполнения операции, которое является неполадкой только в случае непредвиденного возникновения.|  
...
|Source|Microsoft-Windows-ActiveDirectory_DomainService|  
|severity|Сведения|  
|`Message`|<COMPUTERNAME> создаст объект-компьютер для клонированного контроллера домена.<br /><br />Дополнительные данные:<br /><br />Идентификатор клона:% 1<br /><br />Исходный контроллер домена:% 2<br /><br />Клонирование контроллера домена:% 3|  
|Примечания и решение|Это событие успешного выполнения операции, которое является неполадкой только в случае непредвиденного возникновения.|  
...
|Source|Microsoft-Windows-ActiveDirectory_DomainService|  
|severity|Сведения|  
|`Message`|<COMPUTERNAME> добавит клонированный контроллер домена в следующий сайт.<br /><br />Дополнительные данные:<br /><br />Идентификатор клона:% 1<br /><br />Сайт:% 2|  
|Примечания и решение|Это событие успешного выполнения операции, которое является неполадкой только в случае непредвиденного возникновения.|  
...
|Source|Microsoft-Windows-ActiveDirectory_DomainService|  
|severity|Сведения|  
|`Message`|<COMPUTERNAME> создаст контейнер серверов для клонированного контроллера домена.<br /><br />Дополнительные данные:<br /><br />Идентификатор клона:% 1<br /><br />Контейнер серверов:% 2|  
|Примечания и решение|Это событие успешного выполнения операции, которое является неполадкой только в случае непредвиденного возникновения.|  
...
|Source|Microsoft-Windows-ActiveDirectory_DomainService|  
|severity|Сведения|  
|`Message`|<COMPUTERNAME> создаст объект-сервер для клонированного контроллера домена.<br /><br />Дополнительные данные:<br /><br />Идентификатор клона:% 1<br /><br />Объект сервера:% 2|  
|Примечания и решение|Это событие успешного выполнения операции, которое является неполадкой только в случае непредвиденного возникновения.|  
...
|Source|Microsoft-Windows-ActiveDirectory_DomainService|  
|severity|Сведения|  
|`Message`|<COMPUTERNAME> создаст объект параметров NTDS для клонированного контроллера домена.<br /><br />Дополнительные данные:<br /><br />Идентификатор клона:% 1<br /><br />Объект:% 2|  
|Примечания и решение|Это событие успешного выполнения операции, которое является неполадкой только в случае непредвиденного возникновения.|  
...
|Source|Microsoft-Windows-ActiveDirectory_DomainService|  
|severity|Сведения|  
|`Message`|<COMPUTERNAME> создаст объекты подключения для клонированного контроллера домена только для чтения.<br /><br />Дополнительные данные:<br /><br />Идентификатор клона:% 1|  
|Примечания и решение|Это событие успешного выполнения операции, которое является неполадкой только в случае непредвиденного возникновения.|  
...
|Source|Microsoft-Windows-ActiveDirectory_DomainService|  
|severity|Сведения|  
|`Message`|<COMPUTERNAME> создаст объекты SYSVOL для клонированного контроллера домена только для чтения.<br /><br />Дополнительные данные:<br /><br />Идентификатор клона:% 1|  
|Примечания и решение|Это событие успешного выполнения операции, которое является неполадкой только в случае непредвиденного возникновения.|  
...
|Source|Microsoft-Windows-ActiveDirectory_DomainService|  
|severity|Ошибка|  
|`Message`|<COMPUTERNAME> не удалось создать случайный пароль для клонированного контроллера домена.<br /><br />Дополнительные данные:<br /><br />Идентификатор клона:% 1<br /><br />Клонировать имя контроллера домена:% 2<br /><br />Ошибка:% 3% 4|  
...
|Source|Microsoft-Windows-ActiveDirectory_DomainService|  
|severity|Ошибка|  
|`Message`|<COMPUTERNAME> не удалось задать пароль для клонированного контроллера домена.<br /><br />Дополнительные данные:<br /><br />Идентификатор клона:% 1<br /><br />Клонировать имя контроллера домена:% 2<br /><br />Ошибка:% 3% 4|  
...
|Source|Microsoft-Windows-ActiveDirectory_DomainService|  
|severity|Сведения|  
|`Message`|<COMPUTERNAME> успешно задал пароль учетной записи компьютера для клонированного контроллера домена.<br /><br />Дополнительные данные:<br /><br />Идентификатор клона:% 1<br /><br />Клонировать имя контроллера домена:% 2<br /><br />Общее время повтора:% 3|  
|Примечания и решение|Это событие успешного выполнения операции, которое является неполадкой только в случае непредвиденного возникновения.|  
...
|Source|Microsoft-Windows-ActiveDirectory_DomainService|  
|severity|Ошибка|  
|`Message`|Возникло исключение при попытке удалить кэшированные секреты с локального контроллера домена.<br /><br />Дополнительные данные:<br /><br />Значение исключения:% 1<br /><br />Значение ошибки:% 2<br /><br />ДСИД:% 3<br /><br />После клонирования контроллера домена, предназначенного только для чтения, секреты, кэшированные на нем, необходимо удалить с клона. Если не сделать этого, злоумышленники могут получить учетные данные с украденного или скомпрометированного клона. Если какой-либо из этих субъектов безопасности является учетной записью с высокими привилегиями, которую следует защитить от этого, вручную очистите секреты на локальном контроллере с помощью операции rODCPurgeAccount в rootDSE.|  
|Примечания и решение|Просмотрите журналы событий системы и служб каталогов для получения дополнительных сведений.|  
...
|        Source        |                                                                                                                                                                                                                                                                                   Microsoft-Windows-DirectoryServices-DSROLE-Server                                                                                                                                                                                                                                                                                    |
|       severity       |                                                                                                                                                                                                                                                                                                         Ошибка                                                                                                                                                                                                                                                                                                          |
|       `Message`        | Процессу клонирования виртуального контроллера домена не удалось сбросить IP-адреса клонированного компьютера.<br /><br />Возвращен код ошибки: %1 (%2).<br /><br />Эта ошибка может быть вызвана неправильной конфигурацией в разделах конфигурации сети в файле конфигурации виртуального контроллера домена.<br /><br />Дополнительные сведения об ошибках сброса IP-адресов при попытках клонирования виртуального контроллера домена см. в журнале %systemroot%\debug\dcpromo.log.<br /><br />Сведения о сбросе IP-адресов компьютеров на клонированном компьютере можно найти по адресу https://go.microsoft.com/fwlink/?LinkId=208030. |
...
|||  
|-|-|  
|Проблемы|**Нет доступных серверов входа в систему DSRM**|  
...
|   **2191**   | ActiveDirectory_DomainService | Доменные службы Active Directory задали следующий параметр реестра для отключения обновлений DNS.<br /><br />Раздел реестра:<br /><br />SYSTEM\CurrentControlSet\Services\Dnscache\Parameters<br /><br />Параметр реестра:<br /><br />RegistrationEnabled<br /><br />Данные параметра реестра:<br /><br />0<br /><br />В ходе клонирования локальный компьютер в течение короткого времени может иметь то же имя, что и клонируемый компьютер. Регистрация А- и АААА-записей DNS на это время отключается, чтобы клиенты не могли направлять запросы на локальный компьютер, участвующий в клонировании. По завершении клонирования процесс вновь включит обновление DNS.<br /><br />"Information 2/7/2012 3:12:49 PM Microsoft-Windows-ActiveDirectory_DomainService 2191 внутренняя настройка" домен Active Directory Services, установите следующее значение реестра, чтобы отключить обновления DNS.<br /><br />Раздел реестра:<br /><br />SYSTEM\CurrentControlSet\Services\Tcpip\Parameters<br /><br />Параметр реестра:<br /><br />DisableDynamicUpdate<br /><br />Данные параметра реестра:<br /><br />1<br /><br />В ходе клонирования локальный компьютер в течение короткого времени может иметь то же имя, что и клонируемый компьютер. Регистрация А- и АААА-записей DNS на это время отключается, чтобы клиенты не могли направлять запросы на локальный компьютер, участвующий в клонировании. По завершении клонирования процесс вновь включит обновление DNS. |
...
|   **326**    |           NTDS ISAM           |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                NTDS (536) NTDSA: Ядро СУБД присоединило базу данных (1, C:\Windows\NTDS\ntds.dit). (Время=0 с)<br /><br />Внутренняя последовательность времени: [1] 0,000, [2] 0,000, [3] 0,000, [4 0,000], [5] 0,000, [6] 0,016, [7] 0,000, [8] 0,000, [9] 0,000, [10] 0,000, [11] 0,000, [12] 0,000.<br /><br />Сохраненный кэш: 1                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
|   **103**    |           NTDS ISAM           |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  NTDS (536) NTDSA: Ядром СУБД остановлен экземпляр (0).<br /><br />Неправильное отключение: 0<br /><br />Внутренняя последовательность времени: [1] 0,000, [2] 0,000, [3] 0,000, [4] 0,000, [5] 0,032, [6] 0,000, [7] 0,000, [8] 0,000, [9] 0,031, [10] 0,000, [13] 0,000, [14] 0,000, [15] 0,000.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
|   **102**    |           NTDS ISAM           |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             NTDS (536) NTDSA: Ядро СУБД (6.02.8225.0000) запускает новый экземпляр (0).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
|   **105**    |           NTDS ISAM           |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               NTDS (536) NTDSA: Запущен новый экземпляр СУБД (0). (Время=0 с)<br /><br />Внутренняя последовательность времени: [1] 0,016, [2] 0,000, [3] 0,015, [4 0,078], [5] 0,000, [6] 0,000, [7] 0,000, [8] 0,000, [9] 0,046, [10] 0,000, [11] 0,000.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
|   **1004**   | ActiveDirectory_DomainService |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          Работа доменных служб Active Directory успешно завершена.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
|   **102**    |           NTDS ISAM           |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             NTDS (536) NTDSA: Ядро СУБД (6.02.8225.0000) запускает новый экземпляр (0).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
|   **326**    |           NTDS ISAM           |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                NTDS (536) NTDSA: Ядро СУБД присоединило базу данных (1, C:\Windows\NTDS\ntds.dit). (Время=0 с)<br /><br />Внутренняя последовательность времени: [1] 0,000, [2] 0,015, [3] 0,016, [4 0,000], [5] 0,031, [6] 0,000, [7] 0,000, [8] 0,000, [9] 0,000, [10] 0,000, [11] 0,000, [12] 0,000.<br /><br />Сохраненный кэш: 1                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
|   **105**    |           NTDS ISAM           |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               NTDS (536) NTDSA: Запущен новый экземпляр СУБД (0). (Время = 1 секунда)<br /><br />Внутренняя последовательность времени: [1] 0,031, [2] 0,000, [3] 0,000, [4 0,391], [5] 0,000, [6] 0,000, [7] 0,000, [8] 0,000, [9] 0,031, [10] 0,000, [11] 0,000.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
|   **1109**   | ActiveDirectory_DomainService |                                                                                                                                                                                                                           Атрибут invocationID для данного сервера каталогов изменен. В момент создания резервной копии использовался следующий наибольший номер последовательного обновления:<br /><br />Атрибут InvocationID (старое значение):<br /><br />*<GUID>*<br /><br />Атрибут InvocationID (новое значение):<br /><br />*<GUID>*<br /><br />Номер последовательного обновления:<br /><br />*<Number>*<br /><br />Атрибут invocationID изменяется при восстановлении сервера каталогов с резервного носителя, настройке его для хранения доступного для записи раздела каталога приложений, возобновления работы после применения моментального снимка виртуальной машины, после операции импорта виртуальной машины или после операции динамической миграции. Для восстановления виртуализованных контроллеров домена не следует использовать моментальные снимки виртуальной машины. Поддерживаемый метод восстановления или отката содержимого базы данных доменных служб Active Directory — восстановление резервной копии состояния системы, созданной с помощью приложения резервного копирования, поддерживающего доменные службы Active Directory.                                                                                                                                                                                                                            |
...
|   **103**    |           NTDS ISAM           |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  NTDS (536) NTDSA: Ядром СУБД остановлен экземпляр (0).<br /><br />Неправильное отключение: 0<br /><br />Внутренняя последовательность времени: [1] 0,000, [2] 0,000, [3] 0,000, [4] 0,000, [5] 0,047, [6] 0,000, [7] 0,000, [8] 0,000, [9] 0,016, [10] 0,000, [13] 0,000, [14] 0,000, [15] 0,000.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
|   **1004**   | ActiveDirectory_DomainService |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          Работа доменных служб Active Directory успешно завершена.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
...
|  **13565**   |   NtFrs    |                                                                         Служба репликации файлов инициализирует системный том с помощью данных с другого контроллера домена. Компьютер DC2 не может принять роль контроллера домена, пока этот процесс не будет завершен. Этот системный том станет общим ресурсом под именем SYSVOL.<br /><br />Чтобы проверить наличие общего ресурса SYSVOL, введите:<br /><br />net share<br /><br />После завершения процесса инициализации службой репликации файлов должен появиться общий ресурс SYSVOL.<br /><br />Для инициализации системного тома требуется некоторое время. Оно зависит от объема данных на системном томе, от наличия других контроллеров домена, и от частоты репликаций между контроллерами доменов.                                                                         |
|  **13501**   |   NtFrs    |                                                                                                                                                                                                                                                                                                                                                                                                   Запуск службы репликации файлов.                                                                                                                                                                                                                                                                                                                                                                                                   |
|  **13553**   |   NtFrs    |                                                                                                                                                                          Служба репликации файлов успешно добавила этот компьютер к следующему набору репликации:<br /><br />"СИСТЕМНЫЙ ТОМ ДОМЕНА (ОБЩИЙ РЕСУРС SYSVOL)"<br /><br />К этому событию относится следующая информация:<br /><br />DNS-имя компьютера — *@no__t – 1*<br /><br />Имя члена набора реплик — *<Domain Controller>*<br /><br />Корневой путь к набору реплик — *<path>*<br /><br />Путь к промежуточному каталогу реплики — *<path>*<br /><br />Путь к рабочему каталогу реплики — *<path>*                                                                                                                                                                           |
|  **13520**   |   NtFrs    |                Служба репликации файлов переместила ранее существовавшие файлы в <path>to *<path>* \NtFrs_PreExisting___See_EventLog.<br /><br />Служба репликации файлов может удалить файлы в *<path>* \NtFrs_PreExisting___See_EventLog в любое время. Файлы можно сохранить после удаления, скопировав их из *<path>* \NtFrs_PreExisting___See_EventLog. Копирование этих файлов в c:\windows\sysvol\domain может привести к конфликту имен, если эти файлы уже существуют на другом компьютере, являющемся партнером репликации.<br /><br />В некоторых случаях служба репликации файлов может скопировать файл с *<path>* \NtFrs_PreExisting___See_EventLog в *<path>* вместо репликации файла от другого партнера по репликации.<br /><br />Пространство можно восстановить в любое время, удалив файлы в *<path>* \NtFrs_PreExisting___See_EventLog. ".                 |
|  **13508**   |   NtFrs    | Службе репликации файлов не удается включить репликацию с *\\ @ no__t-2 @ no__t-3* на *<Domain Controller>* для *<path>* с помощью<br /><br />Имя DNS *\\ @ no__t-2 @ no__t-3*. Служба репликации файлов (FRS) продолжит повторные попытки.<br /><br />Ниже приведены некоторые из причин, по которым вы увидите это предупреждение.<br /><br />[1] служба FRS не может правильно разрешить DNS-имя *\\ @ no__t-2 @ no__t-3* с этого компьютера.<br /><br />[2] служба FRS не запущена на *\\ @ no__t-2 @ no__t-3*.<br /><br />[3] Сведения о топологии в доменных службах Active Directory для этой реплики реплицированы еще не на все контроллеры домена.<br /><br />Это сообщение об ошибке записывается в журнал для каждого подключения один раз. После исправления ошибки в журнал будет записано другое сообщение, означающее, что соединение установлено. |
|  **13509**   |   NtFrs    |                                                                                                                                                                                                                                                                                                                                            Служба репликации файлов включила репликацию с *\\ @ no__t-2 @ no__t-3* на *<Domain Controller>* для *<Path>* после повторных попыток.                                                                                                                                                                                                                                                                                                                                             |
...
|        **Source**        |                                                                                                                                                                                                                                                                                                                                                             Microsoft-Windows-ActiveDirectory_DomainService                                                                                                                                                                                                                                                                                                                                                             |
|       **Серьезности**       |                                                                                                                                                                                                                                                                                                                                                                              Сведения                                                                                                                                                                                                                                                                                                                                                                              |
|       **Сообщение**        |                                                                                      *<COMPUTERNAME>* остановлена служба FRS или DFSR, используемая для репликации папки SYSVOL.<br /><br />Имя службы:%1<br /><br />Active Directory обнаружил, что виртуальная машина, на которой размещен контроллер домена, возвращена в предыдущее состояние. *<COMPUTERNAME>* должно инициализировать неполномочное восстановление в локальной реплике SYSVOL. Для этого необходимо остановить службу FRS или DFSR, используемую для репликации папки SYSVOL, а затем запустить ее с надлежащими разделами и параметрами реестра, чтобы инициализировать восстановление. После перезапуска службы FRS или DFSR в журнале будет зарегистрировано событие 2187.                                                                                       |
...
|        **Source**        |                                                                                                                                                                                                                                                                                                                                                             Microsoft-Windows-ActiveDirectory_DomainService                                                                                                                                                                                                                                                                                                                                                             |
|       **Серьезности**       |                                                                                                                                                                                                                                                                                                                                                                                  Ошибка                                                                                                                                                                                                                                                                                                                                                                                  |
|       **Сообщение**        | *<COMPUTERNAME>:* не удалось запустить службу FRS или DFSR, используемую для репликации папки SYSVOL.<br /><br />Имя службы:%1<br /><br />Код ошибки:% 2<br /><br />Сообщение об ошибке:% 3<br /><br />Active Directory обнаружил, что виртуальная машина, на которой размещен контроллер домена, возвращена в предыдущее состояние. *<COMPUTERNAME>* должно инициализировать неполномочное восстановление в локальной реплике SYSVOL. Для этого необходимо остановить службу репликации FRS или DFSR, используемую для репликации папки SYSVOL, а затем запустить ее с надлежащими разделами и параметрами реестра, чтобы инициализировать восстановление. *<COMPUTERNAME>* не удалось завершить работу текущей выполняющейся службы и не может выполнить неполномочное восстановление. Выполните не заслуживающее доверия восстановление вручную. |
...
|        **Source**        |                                                                                                                                                                                                                                                                                      Microsoft-Windows-ActiveDirectory_DomainService                                                                                                                                                                                                                                                                                      |
|       **Серьезности**       |                                                                                                                                                                                                                                                                                                       Сведения                                                                                                                                                                                                                                                                                                       |
|       **Сообщение**        | *<COMPUTERNAME>* задайте следующие значения реестра для инициализации реплики SYSVOL во время неполномочного восстановления:<br /><br />Раздел реестра:%1<br /><br />Значение реестра:% 2<br /><br />Данные значения реестра:% 3<br /><br />Active Directory обнаружил, что виртуальная машина, на которой размещен контроллер домена, возвращена в предыдущее состояние. *<COMPUTERNAME>* необходимо инициализировать неполномочное восстановление в локальной реплике SYSVOL. Для этого необходимо остановить службу FRS или DFSR, используемую для репликации папки SYSVOL, а затем запустить ее с надлежащими разделами и параметрами реестра, чтобы инициализировать восстановление. |
| **Примечания и разрешение** |                                                                                                                                                                                                                                                    Ожидается при восстановлении снимка. Все данные SYSVOL на этом контроллере домена заменяются копией с партнерского контроллера домена.                                                                                                                                                                                                                                                    |
...
|        **Source**        |                                                                                                               Microsoft-Windows-ActiveDirectory_DomainService                                                                                                               |
|       **Серьезности**       |                                                                                                                                    Ошибка                                                                                                                                    |
|       **Сообщение**        | Active Directory обнаружил, что виртуальная машина, на которой размещен контроллер домена, возвращена в предыдущее состояние. *<COMPUTERNAME>* не удалось выполнить репликацию для обновления контроллера домена. Контроллер домена будет обновлен после следующей репликации по расписанию. |
...
|        **Source**        |                                                                     Microsoft-Windows-ActiveDirectory_DomainService                                                                     |
|       **Серьезности**       |                                                                                          ОШИБКА                                                                                          |
|       **Сообщение**        | *<COMPUTERNAME>* не удалось восстановить после того, как виртуальный контроллер домена был возвращен в предыдущее состояние. Был запрошен перезапуск в режим восстановления службы каталогов (DSRM). Для получения дополнительных сведений проверьте предыдущие события. |
...
|        **Source**        |                                                                                                                                         Microsoft-Windows-ActiveDirectory_DomainService                                                                                                                                         |
|       **Серьезности**       |                                                                                                                                                          Сведения                                                                                                                                                          |
|       **Сообщение**        |                                                                                                            *<COMPUTERNAME>* удалил базы данных DFSR для инициализации реплики SYSVOL во время неполномочного восстановления.                                                                                                             |
...
|--------------|-------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **ИД события** |       **Source**        |                                                                                                                                                                                                       **Сообщение**                                                                                                                                                                                                       |
|    **1**     |     Kernel-General      |                                                                                                                                   Системное время изменилось на *? <now>* *< > времени или даты моментального снимка*.<br /><br />Причина изменения: Время изменено приложением или компонентом системы.                                                                                                                                   |
...
|--------------|------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **ИД события** | **Source** |                                                                                                                                                                                           **Сообщение**                                                                                                                                                                                            |
|   **103**    |   ESENT    |        DFSR (1360) \\ @ no__t-1. \ C: \System Volume Информатион\дфср\датабасе @ no__t-2_ @ no__t-3 @ no__t-4\dfsr.DB: Ядром СУБД остановлен экземпляр (0).<br /><br />Неправильное отключение: 0<br /><br />Внутренняя последовательность времени: [1] 0,000, [2] 0,000, [3] 0,000, [4] 0,000, [5] 0,141, [6] 0,000, [7] 0,000, [8] 0,000, [9] 0,000, [10] 0,000, [13] 0,016, [14] 0,000, [15] 0,000.         |
|   **102**    |   ESENT    |                                                                                                                    DFSR (532) \\ @ no__t-1. \ C: \System Volume Информатион\дфср\датабасе @ no__t-2_ @ no__t-3 @ no__t-4\dfsr.DB: Ядро СУБД (6.02.8189.0000) запускает новый экземпляр (0).                                                                                                                    |
|   **105**    |   ESENT    |                                      DFSR (532) \\ @ no__t-1. \ C: \System Volume Информатион\дфср\датабасе @ no__t-2_ @ no__t-3 @ no__t-4\dfsr.DB: Запущен новый экземпляр СУБД (0). (Время=0 с)<br /><br />Внутренняя последовательность времени: [1] 0,000, [2] 0,000, [3] 0,000, [4 0,000], [5] 0,000, [6] 0,000, [7] 0,000, [8] 0,000, [9] 0,031, [10] 0,000, [11] 0,000.                                      |
|              |            | DFSR (532) \\ @ no__t-1. \ C: \System Volume Информатион\дфср\датабасе @ no__t-2 @ no__t-3 @ no__t-4 @ no__t-5\dfsr.DB: Ядро СУБД создало новую базу данных (1, \\ @ no__t-1. \ C: \System Volume Информатион\дфср\датабасе @ no__t-2 @ no__t-3 @ no__t-4 @ no__t-5\dfsr.DB). (Время=0 с)<br /><br />Внутренняя последовательность времени: [1] 0,000, [2] 0,000, [3] 0,016, [4 0,062], [5] 0,000, [6] 0,016, [7] 0,000, [8] 0,000, [9] 0,015, [10] 0,000, [11] 0,000. |
...
|  **13554**   |   NTFRS    |                                                                                                                                                                                                                     Служба репликации файлов успешно добавила перечисленные ниже подключения к набору репликации:<br /><br />"СИСТЕМНЫЙ ТОМ ДОМЕНА (ОБЩИЙ РЕСУРС SYSVOL)"<br /><br />Входящий трафик из " *<partner domain controller FQDN>* "<br /><br />Исходящий трафик в " *<partner domain controller FQDN>* "<br /><br />Дополнительная информация может появиться в последующих сообщениях журнала событий.                                                                                                                                                                                                                     |
...
|-|-|-|  
|**ИД события**|**Source**|**Сообщение**|  
|**327**|ESENT|ntfrs (1424) Ядро СУБД присоединило базу данных (1, c:\windows\ntfrs\jet\ntfrs.jdb). (Время=0 с)<br /><br />Внутренняя последовательность времени: [1] 0,000, [2] 0,015, [3] 0,000, [4 0,000], [5] 0,000, [6] 0,516, [7] 0,000, [8] 0,000, [9] 0,000, [10] 0,000, [11] 0,063, [12] 0,000.<br /><br />Восстановленный кэш: 0|  
|**103**|ESENT|ntfrs (1424) Ядром СУБД остановлен экземпляр (0).<br /><br />Неправильное отключение: 0<br /><br />Внутренняя последовательность времени: [1] 0,000, [2] 0,000, [3] 0,000, [4] 0,000, [5] 0,000, [6] 0,000, [7] 0,000, [8] 0,000, [9] 0,031, [10] 0,000, [13] 0,016, [14] 0,000, [15] 0,000.|  
...
|**103**|ESENT|NTFRS (3000) ядро СУБД остановило экземпляр (0).<br /><br />Неправильное отключение: 0<br /><br />Внутренняя последовательность времени: [1] 0,000, [2] 0,000, [3] 0,000, [4] 0,000, [5] 0,000, [6] 0,000, [7] 0,000, [8] 0,000, [9] 0,000, [10] 0,000, [13] 0,000, [14] 0,000, [15] 0,015.|  
|**102**|ESENT|ntfrs (3000) Ядро СУБД (6.02.8189.0000) запускает новый экземпляр (0).|  
...
|**103**|ESENT|NTFRS (3000) ядро СУБД остановило экземпляр (0).<br /><br />Неправильное отключение: 0<br /><br />Внутренняя последовательность времени: [1] 0,000, [2] 0,000, [3] 0,000, [4] 0,000, [5] 0,078, [6] 0,000, [7] 0,000, [8] 0,000, [9] 0,125, [10] 0,016, [13] 0,000, [14] 0,000, [15] 0,000.|  
|**102**|ESENT|ntfrs (3000) Ядро СУБД (6.02.8189.0000) запускает новый экземпляр (0).|  
