...
## <a name="troubleshooting-virtualized-domain-controller-cloning"></a><a name="BKMK_TshootVDCCloning"></a>Устранение неполадок клонирования виртуализированного контроллера домена  
Содержание раздела:  
...
### <a name="general-methodology-for-troubleshooting-domain-controller-cloning"></a><a name="BKMK_GeneralMethodology"></a>Общая методика устранения неполадок клонирования контроллеров домена  
...
### <a name="troubleshooting-specific-problems"></a><a name="BKMK_SpecificProblems"></a>Устранение конкретных проблем  
...
|       **Серьезности**       |                                                                                                                                                                                                       Информационное                                                                                                                                                                                                        |
|       **Сообщение**        | Локальный *<COMPUTERNAME>* обнаружил файл конфигурации клонирования виртуального контроллера домена.<p>Файл конфигурации клонирования виртуального контроллера домена находится в: %1<p>Существование этого файла указывает на то, что локальный виртуальный контроллер домена является клоном другого виртуального контроллера домена. *<COMPUTERNAME>* начнет клонирование самого себя. |
...
|**Источник**|Microsoft-Windows-ActiveDirectory_DomainService|  
|**Серьезности**|Ошибка|  
|**Сообщение**|Сбой клонирования виртуального контроллера домена.<p>Для получения дополнительных сведений об ошибках при попытке клонирования виртуального контроллера домена просмотрите события, записанные в журналах событий системы и в журнале %systemroot%\debug\dcpromo.log.<p>Код ошибки: %1|  
...
|        **Источник**        |                                                                   Microsoft-Windows-ActiveDirectory_DomainService                                                                   |
|       **Серьезности**       |                                                                                        Ошибка                                                                                        |
|       **Сообщение**        | *<COMPUTERNAME>* не удалось запустить поток во время клонирования локального виртуального контроллера домена.<p>Код ошибки:%1<p>Сообщение об ошибке:%2<p>Имя потока:%3 |
...
|        **Источник**        |                                                       Microsoft-Windows-ActiveDirectory_DomainService                                                       |
|       **Серьезности**       |                                                                            Ошибка                                                                            |
|       **Сообщение**        | *<COMPUTERNAME>* требуется служба RPCSS для запуска перезагрузки в режиме DSRM. Сбой при ожидании инициализации RPCSS в состоянии выполнения.<p>Код ошибки:%1 |
...
|        **Источник**        |                                                              Microsoft-Windows-ActiveDirectory_DomainService                                                               |
|       **Серьезности**       |                                                                                   Ошибка                                                                                    |
|       **Сообщение**        | *<COMPUTERNAME>* не удалось инициализировать базу знаний виртуального контроллера домена. Дополнительные сведения см. в предыдущей записи журнала событий.<p>Дополнительные данные<p>Код ошибки:%1 |
| **Примечания и разрешение** |                                                           Следуйте инструкциям в сообщении, это ошибка общего характера.                                                           |
...
|**Источник**|Microsoft-Windows-ActiveDirectory_DomainService|  
|**Серьезности**|Информационное|  
|**Сообщение**|Microsoft-Windows-ActiveDirectory_DomainService<p>Контроллер домена запущен на поддерживаемой низкоуровневой оболочке. Обнаружен ИД создания виртуальной машины.<p>Текущее значение идентификатора создания виртуальной машины: %1|  
...
|**Источник**|Microsoft-Windows-ActiveDirectory_DomainService|  
|**Серьезности**|Информационное|  
|**Сообщение**|Не удалось обнаружить изменение ИД создания.<p>ИД создания в доменных службах (старое значение):%1<p>Текущий ИД создания в виртуальной машине (новое значение):%2|  
...
|**Источник**|Microsoft-Windows-ActiveDirectory_DomainService|  
|**Серьезности**|Информационное|  
|**Сообщение**|Прочтите атрибут msDS-GenerationId объекта-компьютера контроллера домена.<p>Значение атрибута msDS-GenerationId:%1|  
|**Примечания и разрешение**|Это событие успешного выполнения операции, если вы собираетесь выполнить клонирование. В противном случае изучите журнал событий системы.|  
...
|**Источник**|Microsoft-Windows-ActiveDirectory_DomainService|  
|**Серьезности**|Информационное|  
|**Сообщение**|Файл конфигурации клона виртуального контроллера домена переименован.<p>Дополнительные данные<p>Старое имя файла:%1<p>Новое имя файла:%2|  
...
|**Источник**|Microsoft-Windows-ActiveDirectory_DomainService|  
|**Серьезности**|Ошибка|  
|**Сообщение**|Сбой переименования файла конфигурации клона виртуального контроллера домена.<p>Дополнительные данные<p>Имя файла:%1<p>Код ошибки:%2 %3|  
...
|**Источник**|Microsoft-Windows-ActiveDirectory_DomainService|  
|**Серьезности**|Информационное|  
|**Сообщение**|Для атрибута msDS-GenerationId объекта-компьютера контроллера домена задан следующий параметр:<p>Атрибут GenerationID:%1|  
|**Примечания и разрешение**|Это событие успешного выполнения операции, которое является неполадкой только в случае непредвиденного возникновения.|  
...
|**Источник**|Microsoft-Windows-ActiveDirectory_DomainService|  
|**Серьезности**|Предупреждение|  
|**Сообщение**|Не удалось задать атрибут msDS-GenerationId объекта-компьютера контроллера домена.<p>Дополнительные данные<p>Код ошибки:%1|  
...
|        **Источник**        |                                                                                                          Microsoft-Windows-ActiveDirectory_DomainService                                                                                                          |
|       **Серьезности**       |                                                                                                                           Информационное                                                                                                                           |
|       **Сообщение**        | Внутреннее событие: *<COMPUTERNAME>* выполнил запрос на клонирование агента системы удаленного каталога.<p>Имя исходного контроллера домена:%3<p>Имя клонируемого контроллера домена в запросе:%4<p>Сайт клонируемого контроллера домена в запросе:%5<p>Дополнительные данные<p>Значение ошибки:%1 %2 |
| **Примечания и разрешение** |                                                                                                     Это событие успешного выполнения операции, которое является неполадкой только в случае непредвиденного возникновения.                                                                                                      |
...
|        **Источник**        |                                                                                                                                                                                                     Microsoft-Windows-ActiveDirectory_DomainService                                                                                                                                                                                                     |
|       **Серьезности**       |                                                                                                                                                                                                                      Информационное                                                                                                                                                                                                                      |
|       **Сообщение**        | *<COMPUTERNAME>* задать следующее значение реестра для включения обновлений DNS.<p>Раздел реестра:%1<p>Значение реестра: %2<p>Данные значения реестра: %3<p>В ходе клонирования локальный компьютер в течение короткого времени может иметь то же имя, что и клонируемый компьютер. Регистрация А- и АААА-записей DNS на это время отключается, чтобы клиенты не могли направлять запросы на локальный компьютер, участвующий в клонировании. |
| **Примечания и разрешение** |                                                                                                                                                                                                Это событие успешного выполнения операции, которое является неполадкой только в случае непредвиденного возникновения.                                                                                                                                                                                                 |
...
|        **Источник**        |                                                                                                                                                                                                                                    Microsoft-Windows-ActiveDirectory_DomainService                                                                                                                                                                                                                                     |
|       **Серьезности**       |                                                                                                                                                                                                                                                         Ошибка                                                                                                                                                                                                                                                          |
|       **Сообщение**        | *<COMPUTERNAME>* не удалось задать следующее значение реестра для включения обновлений DNS.<p>Раздел реестра:%1<p>Значение реестра: %2<p>Данные значения реестра: %3<p>Код ошибки: %4<p>Сообщение об ошибке: %5<p>В ходе клонирования локальный компьютер в течение короткого времени может иметь то же имя, что и клонируемый компьютер. Регистрация А- и АААА-записей DNS на это время отключается, чтобы клиенты не могли направлять запросы на локальный компьютер, участвующий в клонировании. |
| **Примечания и разрешение** |                                                                                                                                                                                                 Изучите журналы событий приложений и системы. Выполните поиск приложений сторонних разработчиков, которые могли воспрепятствовать обновлениям реестра.                                                                                                                                                                                                  |
...
|**Источник**|Microsoft-Windows-ActiveDirectory_DomainService|  
|**Серьезности**|Ошибка|  
|**Сообщение**|Не удалось задать режим загрузки DSRM.<p>Код ошибки:%1<p>Сообщение об ошибке:%2<p>Если при клонировании виртуального контроллера домена происходит сбой или файл конфигурации клона виртуального контроллера домена находится на неподдерживаемой низкоуровневой оболочке, локальный компьютер будет перезагружен в режиме DSRM для устранения неполадок. Сбой установки режима загрузки DSRM.|  
|**Примечания и разрешение**|Изучите журналы событий приложений и системы. Выполните поиск приложений сторонних разработчиков, которые могли воспрепятствовать обновлениям реестра.|  
...
|**Источник**|Microsoft-Windows-ActiveDirectory_DomainService|  
|**Серьезности**|Ошибка|  
|**Сообщение**|Не удалось инициировать завершение работы системы.<p>Код ошибки:%1<p>Сообщение об ошибке:%2<p>Если при клонировании виртуального контроллера домена происходит сбой или файл конфигурации клона виртуального контроллера домена находится на неподдерживаемой низкоуровневой оболочке, локальный компьютер будет перезагружен в режиме DSRM для устранения неполадок. Сбой инициализации завершения работы системы.|  
|**Примечания и разрешение**|Изучите журналы событий приложений и системы. Выполните поиск приложений сторонних разработчиков, которые могли воспрепятствовать использованию привилегий.|  
...
|        **Источник**        |                                                                  Microsoft-Windows-ActiveDirectory_DomainService                                                                  |
|       **Серьезности**       |                                                                                       Ошибка                                                                                       |
|       **Сообщение**        | *<COMPUTERNAME>* не удалось создать или изменить следующий клонированный объект контроллера домена.<p>Дополнительные данные:<p>Объект:<p>%1<p>Значение ошибки: %2<p>%3 |
...
|        **Источник**        |                                                                                                                                                                                               Microsoft-Windows-ActiveDirectory_DomainService                                                                                                                                                                                                |
|       **Серьезности**       |                                                                                                                                                                                                                    Ошибка                                                                                                                                                                                                                     |
|       **Сообщение**        |                                                                                                                     *<COMPUTERNAME>* не удалось создать следующий клонированный объект контроллера домена, так как объект уже существует.<p>Дополнительные данные:<p>Исходный контроллер домена:<p>%1<p>Объект:<p>%2                                                                                                                     |
...
|Источник|Microsoft-Windows-ActiveDirectory_DomainService|  
|Severity|Ошибка|  
|Message|<COMPUTERNAME> не удалось создать объекты для клонированного контроллера домена.<p>Дополнительные данные:<p>Идентификатор клона: %6<p>Клонировать имя контроллера домена: %1<p>Цикл повторных попыток: %2<p>Значение исключения: %3<p>Значение ошибки: %4<p>ДСИД: %5|  
...
|Message|<COMPUTERNAME> создал объекты для клонированного контроллера домена.<p>Дополнительные данные:<p>Идентификатор клона: %3<p>Клонировать имя контроллера домена: %1<p>Цикл повторных попыток: %2|  
...
|Источник|Microsoft-Windows-ActiveDirectory_DomainService|  
|Severity|Информационное|  
|Message|<COMPUTERNAME> начал создавать объекты для клонированного контроллера домена.<p>Дополнительные данные:<p>Идентификатор клона: %1<p>Имя клона: %2<p>Клонировать сайт: %3<p>Клонировать RODC: %4|  
|Примечания и решение|Это событие успешного выполнения операции, которое является неполадкой только в случае непредвиденного возникновения.|  
...
|Источник|Microsoft-Windows-ActiveDirectory_DomainService|  
|Severity|Информационное|  
|Message|<COMPUTERNAME> создал новый объект KrbTgt для клонирования контроллера домена только для чтения.<p>Дополнительные данные:<p>Идентификатор клона: %1<p>Новый GUID объекта KrbTgt: %2|  
|Примечания и решение|Это событие успешного выполнения операции, которое является неполадкой только в случае непредвиденного возникновения.|  
...
|Источник|Microsoft-Windows-ActiveDirectory_DomainService|  
|Severity|Информационное|  
|Message|<COMPUTERNAME> создаст объект-компьютер для клонированного контроллера домена.<p>Дополнительные данные:<p>Идентификатор клона: %1<p>Исходный контроллер домена: %2<p>Клонирование контроллера домена: %3|  
|Примечания и решение|Это событие успешного выполнения операции, которое является неполадкой только в случае непредвиденного возникновения.|  
...
|Источник|Microsoft-Windows-ActiveDirectory_DomainService|  
|Severity|Информационное|  
|Message|<COMPUTERNAME> добавит клонированный контроллер домена в следующий сайт.<p>Дополнительные данные:<p>Идентификатор клона: %1<p>Сайт: %2|  
|Примечания и решение|Это событие успешного выполнения операции, которое является неполадкой только в случае непредвиденного возникновения.|  
...
|Источник|Microsoft-Windows-ActiveDirectory_DomainService|  
|Severity|Информационное|  
|Message|<COMPUTERNAME> создаст контейнер серверов для клонированного контроллера домена.<p>Дополнительные данные:<p>Идентификатор клона: %1<p>Контейнер серверов: %2|  
|Примечания и решение|Это событие успешного выполнения операции, которое является неполадкой только в случае непредвиденного возникновения.|  
...
|Источник|Microsoft-Windows-ActiveDirectory_DomainService|  
|Severity|Информационное|  
|Message|<COMPUTERNAME> создаст объект-сервер для клонированного контроллера домена.<p>Дополнительные данные:<p>Идентификатор клона: %1<p>Объект сервера: %2|  
|Примечания и решение|Это событие успешного выполнения операции, которое является неполадкой только в случае непредвиденного возникновения.|  
...
|Источник|Microsoft-Windows-ActiveDirectory_DomainService|  
|Severity|Информационное|  
|Message|<COMPUTERNAME> создаст объект параметров NTDS для клонированного контроллера домена.<p>Дополнительные данные:<p>Идентификатор клона: %1<p>Объект: %2|  
|Примечания и решение|Это событие успешного выполнения операции, которое является неполадкой только в случае непредвиденного возникновения.|  
...
|Источник|Microsoft-Windows-ActiveDirectory_DomainService|  
|Severity|Информационное|  
|Message|<COMPUTERNAME> создаст объекты подключения для клонированного контроллера домена только для чтения.<p>Дополнительные данные:<p>Идентификатор клона: %1|  
|Примечания и решение|Это событие успешного выполнения операции, которое является неполадкой только в случае непредвиденного возникновения.|  
...
|Источник|Microsoft-Windows-ActiveDirectory_DomainService|  
|Severity|Информационное|  
|Message|<COMPUTERNAME> создаст объекты SYSVOL для клонированного контроллера домена только для чтения.<p>Дополнительные данные:<p>Идентификатор клона: %1|  
|Примечания и решение|Это событие успешного выполнения операции, которое является неполадкой только в случае непредвиденного возникновения.|  
...
|Источник|Microsoft-Windows-ActiveDirectory_DomainService|  
|Severity|Ошибка|  
|Message|<COMPUTERNAME> не удалось создать случайный пароль для клонированного контроллера домена.<p>Дополнительные данные:<p>Идентификатор клона: %1<p>Клонировать имя контроллера домена: %2<p>Ошибка: %3 %4|  
...
|Источник|Microsoft-Windows-ActiveDirectory_DomainService|  
|Severity|Ошибка|  
|Message|<COMPUTERNAME> не удалось задать пароль для клонированного контроллера домена.<p>Дополнительные данные:<p>Идентификатор клона: %1<p>Клонировать имя контроллера домена: %2<p>Ошибка: %3 %4|  
...
|Источник|Microsoft-Windows-ActiveDirectory_DomainService|  
|Severity|Информационное|  
|Message|<COMPUTERNAME> успешно задал пароль учетной записи компьютера для клонированного контроллера домена.<p>Дополнительные данные:<p>Идентификатор клона: %1<p>Клонировать имя контроллера домена: %2<p>Общее время повтора: %3|  
|Примечания и решение|Это событие успешного выполнения операции, которое является неполадкой только в случае непредвиденного возникновения.|  
...
|Источник|Microsoft-Windows-ActiveDirectory_DomainService|  
|Severity|Информационное|  
|Message|Кэшированные секреты следующего субъекта безопасности были успешно удалены с локального контроллера домена:<p>%1<p>После клонирования контроллера домена, предназначенного только для чтения, секреты, кэшированные на нем, будут удалены с клона.|  
|Примечания и решение|Это событие успешного выполнения операции, которое является неполадкой только в случае непредвиденного возникновения.|  
...
|Источник|Microsoft-Windows-ActiveDirectory_DomainService|  
|Severity|Ошибка|  
|Message|Не удалось удалить кэшированные секреты следующего субъекта безопасности с локального контроллера домена:<p>%1<p>Ошибка: %2 (%3)<p>После клонирования контроллера домена, предназначенного только для чтения, секреты, кэшированные на нем, необходимо удалить с клона. Если не сделать этого, злоумышленники могут получить учетные данные с украденного или скомпрометированного клона. Если субъект безопасности является учетной записью с высокими привилегиями, которую следует защитить от этого, вручную очистите секреты на локальном контроллере с помощью операции rODCPurgeAccount в rootDSE.|  
...
|Источник|Microsoft-Windows-ActiveDirectory_DomainService|  
|Severity|Ошибка|  
|Message|Возникло исключение при попытке удалить кэшированные секреты с локального контроллера домена.<p>Дополнительные данные:<p>Значение исключения: %1<p>Значение ошибки: %2<p>ДСИД: %3<p>После клонирования контроллера домена, предназначенного только для чтения, секреты, кэшированные на нем, необходимо удалить с клона. Если не сделать этого, злоумышленники могут получить учетные данные с украденного или скомпрометированного клона. Если какой-либо из этих субъектов безопасности является учетной записью с высокими привилегиями, которую следует защитить от этого, вручную очистите секреты на локальном контроллере с помощью операции rODCPurgeAccount в rootDSE.|  
|Примечания и решение|Просмотрите журналы событий системы и служб каталогов для получения дополнительных сведений.|  
...
|Источник|Microsoft-Windows-DirectoryServices-DSROLE-Server|  
|Severity|Ошибка|  
|Message|Процессу клонирования виртуального контроллера домена не удалось получить уведомление Winlogon. Возвращен код ошибки: %1 (%2).<p>Дополнительные сведения об этой ошибке см. в журнале %systemroot%\debug\dcpromo.log (ошибки при попытке клонирования виртуального контроллера домена).|  
...
|Источник|Microsoft-Windows-DirectoryServices-DSROLE-Server|  
|Severity|Ошибка|  
|Message|При клонировании виртуального контроллера домена не удалось проанализировать файл конфигурации виртуального контроллера домена.<p>Возвращен код ошибки (HRESULT): %1.<p>Файл конфигурации:%2<p>Исправьте ошибки в файле конфигурации и попробуйте выполнить клонирование еще раз.<p>Подробные сведения об этой ошибке можно найти в журнале %systemroot%\debug\dcpromo.log.|  
...
|        Источник        |                                                                                                                                                                                                                                                                                   Microsoft-Windows-DirectoryServices-DSROLE-Server                                                                                                                                                                                                                                                                                    |
|       Severity       |                                                                                                                                                                                                                                                                                                         Ошибка                                                                                                                                                                                                                                                                                                          |
|       Message        | Процессу клонирования виртуального контроллера домена не удалось сбросить IP-адреса клонированного компьютера.<p>Возвращен код ошибки: %1 (%2).<p>Эта ошибка может быть вызвана неправильной конфигурацией в разделах конфигурации сети в файле конфигурации виртуального контроллера домена.<p>Дополнительные сведения об ошибках сброса IP-адресов при попытках клонирования виртуального контроллера домена см. в журнале %systemroot%\debug\dcpromo.log.<p>Дополнительные сведения о сбросе IP-адресов компьютеров на клонированном компьютере можно найти по адресу https://go.microsoft.com/fwlink/?LinkId=208030 |
...
|        Источник        |                                                                                                                                                         Microsoft-Windows-DirectoryServices-DSROLE-Server                                                                                                                                                          |
|       Severity       |                                                                                                                                                                               Ошибка                                                                                                                                                                                |
|       Message        | При клонировании виртуального контроллера домена не удалось выполнить привязку к основному контроллеру домена %1.<p>Возвращен код ошибки %2 (%3).<p>Убедитесь, что основной контроллер домена %1 находится в сети и работает. Убедитесь, что на клонируемом компьютере имеется подключение LDAP/RPC к основному контроллеру домена через требуемые порты и протоколы. |
| Примечания и решение |                                   Проверьте, заданы ли сведения об IP-адресах и DNS для клонированного контроллера домена. Используйте Dcdiag. exe/Test: локаторчекк, чтобы проверить, находится ли ПДЦЕ в сети, использовать Nltest. exe/Server: *<PDCE>* /дклист: *<domain>* в качестве допустимого RPC, получить запись сети из пдце, в то время как клонирование завершится сбоем и проанализировать трафик.                                   |
...
|Источник|Microsoft-Windows-DirectoryServices-DSROLE-Server|  
|Severity|Ошибка|  
|Message|Сбой клонирования виртуального контроллера домена.<p>При попытке создать объекты в основном контроллере домена %1, необходимые для клонирования образа, возвращена ошибка %2 (%3).<p>Убедитесь, что клонированный контроллер домена имеет право на клонирование самого себя. Проверьте связанные с этой ошибкой события в журнале событий службы каталогов для основного контроллера домена %1.|  
...
|Источник|Microsoft-Windows-DirectoryServices-DSROLE-Server|  
|Severity|Ошибка|  
|Message|Сбой при попытке установить флаг "Загружать в режим восстановления служб каталогов" с кодом ошибки %1.<p>Дополнительные сведения об ошибках см. в файле %systemroot%\debug\dcpromo.log.|  
...
|Источник|Microsoft-Windows-DirectoryServices-DSROLE-Server|  
|Severity|Ошибка|  
|Message|Клонирование виртуального контроллера домена выполнено. При попытке перезагрузки компьютера произошел сбой с кодом ошибки %1.<p>Перезагрузите компьютер для завершения операции клонирования.|  
...
|Источник|Microsoft-Windows-DirectoryServices-DSROLE-Server|  
|Severity|Ошибка|  
|Message|Сбой при попытке снять флаг "Загружать в режим восстановления служб каталогов" с кодом ошибки %1.<p>Дополнительные сведения об ошибках см. в файле %systemroot%\debug\dcpromo.log.|  
|Примечания и решение|Просмотрите журнал служб каталогов и файл dcpromo.log для получения дополнительных сведений. Изучите журналы событий приложений и системы. Выполните поиск приложений сторонних разработчиков, которые могли воспрепятствовать использованию привилегий.|  
...
|Источник|Microsoft-Windows-DirectoryServices-DSROLE-Server|  
|Severity|Ошибка|  
|Message|При клонировании виртуального контроллера домена не удалось проверить список разрешенных приложений для клонирования виртуального контроллера домена.<p>Возвращен код ошибки: %1 (%2).<p>Эта ошибка может быть вызвана синтаксической ошибкой в файле списка разрешений клона (в настоящее время проверяется файл: %3). Подробные сведения об этой ошибке можно найти в журнале %systemroot%\debug\dcpromo.log.|  
...
|**Разрешение и примечания**|Это происходит, когда PDC доступен для обнаружения, но не выполнил достаточный объем репликации, чтобы взять роль на себя. Например, когда клонирование запущено, а другой администратор перемещает роль PDCE FSMO на новый контроллер домена.<p>Описывается в KB 2742916.|  

|||  
|-|-|  
|**Проблема**|**Клонирование завершается сбоем, Загрузка в режиме DSRM, общие ошибки сети**|  
|**Явление**|Клон загружается в режиме восстановления служб каталогов. Имеются общие ошибки сети.|  
|**Разрешение и примечания**|Убедитесь, что у нового клона нет дублирующегося статического MAC-адреса, назначенного с исходного контроллера домена. Чтобы определить, использует ли виртуальная машина статический MAC-адрес, выполните следующую команду на узле Hyper-V как для исходной, так и для клонированной виртуальной машины:<p>Get-VM-VMName *Test-ВМ* &#124; Get-VMNetworkAdapter &#124; FL *<p>Измените MAC-адрес на уникальный статический адрес или переключитесь на использование динамических MAC-адресов.<p>Описано в статье базы знаний 2742844.|  
...
|**Разрешение и примечания**|Убедитесь, что dccloneconfig.xml содержит определение схемы (см. sampledccloneconfig.xml, строка 2):<p>**< D3C: Дкклонеконфиг xmlns:D3C = "Ури:Микрософт. com: schemas: Дкклонеконфиг" >**<p>Описано в статье базы знаний KB 2742844.|  

|||  
|-|-|  
|Проблема|**Нет доступных серверов входа в систему DSRM**|  
|**Явление**|Процесс клонирования загружается в режиме восстановления служб каталогов. вы пытаетесь выполнить вход и получаете ошибку:<p>**В настоящее время нет доступных серверов входа для обслуживания запроса на вход.**|  
|**Разрешение и примечания**|Убедитесь, что вы выполняете вход с использованием учетной записи администратора DSRM, а не учетной записи домена. Используйте стрелку влево и введите следующее имя пользователя:<p>**.\administrator**<p>Описывается в KB 2742908|  
...
|**Явление**|При выполнении командлета new-addccloneconfigfile возникает ошибка:<p>Индекс находился вне допустимого диапазона. Индекс должен быть неотрицательным и меньшим, чем размер коллекции.|  
|**Разрешение и примечания**|Вам следует запустить командлет в консоли Windows PowerShell для администратора с повышенными правами. Эта ошибка вызвана отсутствием членства в группе локальных администраторов на компьютере.<p>Описывается в KB 2742927|  
...
|**Явление**|При выполнении New-ADDCCloneConfigFile для создания файла dccloneconfig.xml возникает ошибка:<p>Код-сервер не работает|  
...
### <a name="advanced-troubleshooting"></a>Диагностика проблем повышенной сложности  
...
|   **2160**   | ActiveDirectory_DomainService |                                                                                                                                                                                                                                                                                                                                                                                                                                                                         Локальные доменные службы Active Directory обнаружили файл конфигурации клонирования виртуального контроллера домена.<p>Путь к файлу:<p>*<path>* \дкклонеконфиг.ксмл<p>Существование этого файла указывает на то, что локальный виртуальный контроллер домена является клоном другого виртуального контроллера домена. Доменные службы Active Directory запустят клонирование самих себя.                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
...
|**3096**|Netlogon|Не удалось найти основной контроллер домена для данного домена.|  
...
|**7023**|Диспетчер управления службами|Служба межсайтовых сообщений завершена из-за ошибки:<p>Указанный сервер не может выполнить запрошенную операцию.|  
|**7036**|Диспетчер управления службами|Служба межсайтовых сообщений находится в режиме остановки.|  
|**5806**|Netlogon|На данном контроллере домена динамическое обновление отключено вручную.<p>ДЕЙСТВИЕ ПОЛЬЗОВАТЕЛЯ<p>Измените настройку контроллера домена, включив динамическое обновление, или вручную добавьте записи DNS из файла "%SystemRoot%\System32\Config\Netlogon.dns" в базу данных DNS".|  
|**16651**|Directory-Services-SAM|Запрос нового пула идентификаторов учетных записей не выполнен. Данная операция повторяется, пока запрос не будет выполнен. Ошибка:<p>Ошибка требуемой операции FSMO. Нет связи с текущим владельцем FSMO.|  
...
#### <a name="general-methodology-for-troubleshooting-domain-controller-safe-restore"></a><a name="BKMK_TshhotSafeRestore"></a>Общая методика устранения неполадок безопасного восстановления контроллера домена  
...
### <a name="troubleshooting-specific-problems"></a><a name="BKMK_TshootSpecificSafeRestore"></a>Устранение конкретных проблем  
...
|        **Источник**        |                                                                                                                                                                                                                                                                                      Microsoft-Windows-ActiveDirectory_DomainService                                                                                                                                                                                                                                                                                      |
|       **Серьезности**       |                                                                                                                                                                                                                                                                                                       Информационное                                                                                                                                                                                                                                                                                                       |
|       **Сообщение**        | *<COMPUTERNAME>* задать следующие значения реестра для инициализации реплики SYSVOL во время неполномочного восстановления:<p>Раздел реестра:%1<p>Значение реестра: %2<p>Данные значения реестра: %3<p>Active Directory обнаружил, что виртуальная машина, на которой размещен контроллер домена, возвращена в предыдущее состояние. *<COMPUTERNAME>* необходимо инициализировать неполномочное восстановление в локальной реплике SYSVOL. Для этого необходимо остановить службу FRS или DFSR, используемую для репликации папки SYSVOL, а затем запустить ее с надлежащими разделами и параметрами реестра, чтобы инициализировать восстановление. |
| **Примечания и разрешение** |                                                                                                                                                                                                                                                    Ожидается при восстановлении снимка. Все данные SYSVOL на этом контроллере домена заменяются копией с партнерского контроллера домена.                                                                                                                                                                                                                                                    |
...
|        **Источник**        |                                                                                                                                                                                                                                                                                                                                                                                                          Microsoft-Windows-ActiveDirectory_DomainService                                                                                                                                                                                                                                                                                                                                                                                                           |
|       **Серьезности**       |                                                                                                                                                                                                                                                                                                                                                                                                                               Ошибка                                                                                                                                                                                                                                                                                                                                                                                                                                |
|       **Сообщение**        | *<COMPUTERNAME>* не удалось задать следующие значения реестра для инициализации реплики SYSVOL во время неполномочного восстановления:<p>Раздел реестра:%1<p>Значение реестра: %2<p>Данные значения реестра: %3<p>Код ошибки: %4<p>Сообщение об ошибке: %5<p>Active Directory обнаружил, что виртуальная машина, на которой размещена роль контроллера домена, возвращена в предыдущее состояние. *<COMPUTERNAME>* необходимо инициализировать неполномочное восстановление в локальной реплике SYSVOL. Для этого необходимо остановить службу FRS или DFSR, используемую для репликации папки SYSVOL, а затем запустить ее с надлежащими разделами и параметрами реестра, чтобы инициализировать восстановление. *<COMPUTERNAME>* не удалось задать указанные выше значения реестра и выполнить неполномочное восстановление. Выполните не заслуживающее доверия восстановление вручную. |
| **Примечания и разрешение** |                                                                                                                                                                                                                                                                                                                                                                       Изучите журналы событий приложений и системы. Выполните поиск приложений сторонних разработчиков, которые могли воспрепятствовать обновлениям реестра.                                                                                                                                                                                                                                                                                                                                                                       |
...
|        **Источник**        |                                                                             Microsoft-Windows-ActiveDirectory_DomainService                                                                             |
|       **Серьезности**       |                                                                                                  ОШИБКА                                                                                                  |
|       **Сообщение**        | *<COMPUTERNAME>* не удалось сделать текущий пул RID недействительным после того, как виртуальный контроллер домена был возвращен в предыдущее состояние.<p>Дополнительные данные:<p>Код ошибки: %1<p>Значение ошибки: %2 |
...
|**Явление**|После восстановления снимка попытки создать новый субъект безопасности (пользователя, компьютер, группу) на этом контроллере домена завершаются с ошибкой:<p>Ошибка 0x2010<p>Служба каталогов не смогла выделить относительный идентификатор.|  
...
|   **1210**   |    DFSR    |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    Служба репликации DFS успешно настроила прослушиватель RPC на принятие запросов на репликацию.<p>Дополнительные сведения.<p>Порт: 0                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
|   **4614**   |    DFSR    | Служба репликации DFS инициализировала SYSVOL по локальному пути C:\Windows\SYSVOL\domain и готова к начальной репликации. Реплицированная папка останется в состоянии начальной синхронизации до выполнения репликации со своим партнером. Если в это время выполнялось назначение сервера контроллером домена, контроллер домена не будет делать объявления и функционировать как контроллер домена, пока данная проблема не будет решена. Это могло произойти, если указанный партнер также находится в состоянии начальной синхронизации или обнаружены нарушения общего доступа на этом сервере или партнере синхронизации. Если данное событие произошло в результате миграции SYSVOL от службы репликации файлов (FRS) к репликации DFS, изменения не будут реплицироваться до тех пор, пока эта проблема не будет решена. В результате этого папка SYSVOL на данном сервере может стать не синхронизированной с другими контроллерами домена.<p>Дополнительные сведения.<p>Имя реплицированной папки: общий ресурс SYSVOL<p>Идентификатор реплицированной папки: *<GUID>*<p>Имя группы репликации: системный том домена<p>Идентификатор группы репликации: *<GUID>*<p>Идентификатор элемента: *<GUID>*<p>Только для чтения: 0 |
|   **4604**   |    DFSR    |                                                                                                                                                                                                                                                                   Служба репликации DFS успешно инициализировала реплицированную папку SYSVOL по локальному пути C:\Windows\SYSVOL\domain. Этот участник завершил начальную синхронизацию SYSVOL с партнером dc1.corp.contoso.com.  Чтобы проверить наличие общей папки SYSVOL, откройте окно командной строки и введите "net share".<p>Дополнительные сведения.<p>Имя реплицированной папки: общий ресурс SYSVOL<p>Идентификатор реплицированной папки: *<GUID>*<p>Имя группы репликации: системный том домена<p>Идентификатор группы репликации: *<GUID>*<p>Идентификатор элемента: *<GUID>*<p>Партнер синхронизации: *<partner domain controller FQDN>*                                                                                                                                                                                                                                                                    |
