...
#### <a name="BKMK_ADDSInstallPrerequisiteTests"></a>Тесты необходимых компонентов
...
|VerifyExchange<br /><br />SchemaFixed|LDAP, WMI, DCOM, RPC|Проверка существующей схемы леса по-прежнему не содержит проблем с расширениями Exchange 2000 MS-дов-Assistant-Name, MS-дов-Лабеледури и MS-дов-House-identifier ([https://support.microsoft.com/kb/314649](https://support.microsoft.com/kb/314649))|  
