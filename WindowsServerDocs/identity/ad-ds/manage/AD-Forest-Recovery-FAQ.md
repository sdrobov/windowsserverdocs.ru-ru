...
**ФОРМАТЕ Что можно сделать для ускорения восстановления?**
...
- Сократите время получения носителей резервных копий, выполнив следующие действия.  
   ...
   - Использование служба теневого копирования томов с сетью хранения данных (SAN) для сохранения резервных копий с разных точек во времени. Дополнительные сведения см. в статье [Windows Server 2003 Active Directory быстрое восстановление с Служба теневого копирования томов и службой виртуальных дисков](https://go.microsoft.com/fwlink/?LinkId=70781) (https://go.microsoft.com/fwlink/?LinkId=70781) ).  
...
**ФОРМАТЕ Можно ли автоматизировать процесс восстановления леса?**
