...
|   | Центр обновления Windows| Завершение работы — g-t 0  | Перезагрузки, инициированные пользователем | API-интерфейсы с флагами SHUTDOWN_ARSO/EWX_ARSO |
| --- | :---: | :---: | :---: | :---: |
| Управляемые устройства | :heavy_check_mark:  | :heavy_check_mark: |   | :heavy_check_mark: |
| Неуправляемые устройства | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |
...
![Страница параметров](media/Winlogon-Automatic-Restart-Sign-On--ARSO-/gtr-adds-lockscreenapp.png)
...
- Платформы Windows 10 и более поздние версии
...
| --- | :---: | :---: | :---: | :---: |
| Локальная учетная запись | :heavy_check_mark: | :heavy_check_mark: |   |   |
| Учетная запись MSA | :heavy_check_mark: | :heavy_check_mark: |   |   |
| Учетная запись присоединения к Azure AD | :heavy_check_mark: | :heavy_check_mark: | : heavy_check_mark: (если гибридная) | :heavy_check_mark: |
| Учетная Запись присоединена к домену | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: | : heavy_check_mark: (если гибридная) |
