...
**Таблица SEQ таблица \\\* Арабский 2. коды ошибок для уникальности имени участника-пользователя и имени участника-службы**  
  
|Decimal|Шестнадцатеричная|Символические|Строка|  
|-----------|-------|------------|----------|  
...
**Рис. SEQ. рис. \\\* Арабской ошибки, отображаемой в центре администрирования Active Directory при неудачном создании нового пользователя из-за повторяющегося UPN**  
...
**Рис. SEQ. рис. \\\* Арабской 2 события с кодом 2974 с ошибкой 8648**  
...
**Рис. SEQ. рис. \\\* арабском 3 событие 2974, показывающее все объекты, содержащие повторяющееся имя участника-пользователя**  
...
**Рис. SEQ. рис. \\\* в ADSIEdit сообщение об ошибке 4 (Арабский), если Добавление повторяющегося имени участника-пользователя заблокировано**  
...
**Рис. SEQ. рис. \\\* на арабском 5 ДСАК ошибка создания пользователя на компьютере, отличном от Windows Server 2012 R2 и предназначенном для Windows Server 2012 R2 DC**  
...
**Рис. SEQ. рис. \\\* арабском 6 ДСАК ошибка изменения пользователя в системе, отличной от Windows Server 2012 R2, при использовании Windows Server 2012 R2 DC**  
...
**Рис. SEQ. рисунок \\\* Арабской 8 сообщения об ошибке, отображаемое в ADSIEdit, если Добавление повторяющегося имени субъекта-службы заблокировано**  
...
**Рис. SEQ. \\\* Арабский 9 ошибка, регистрируемая при создании повторяющегося имени субъекта-службы**  
