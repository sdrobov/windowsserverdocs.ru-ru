...
|----------|---------|-----------|  
|**Restore-Каролесервице К:\адксбаккуп**|Restore-Каролесервице: процесс не может получить доступ к файлу, так как он используется другим процессом. (Исключение HRESULT:<p>0x80070020|Перед запуском командлета Restore-Каролесервице завершите работу службы служб сертификатов Active Directory|  
