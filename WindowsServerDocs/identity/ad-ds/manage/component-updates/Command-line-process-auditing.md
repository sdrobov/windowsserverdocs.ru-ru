...
**Рисунок SEQ. рис. \\ @ no__t-2 Арабский 16 событие 4688**  
...
Объем событий: От низкого до среднего в зависимости от использования системы  
...
**Таблица SEQ таблица \\ @ no__t-2 Арабский 19 параметр политики процесса командной строки**  
...
5.  Дважды щелкните Аудит: Настройте параметры подкатегории политики аудита (Windows Vista или более поздней версии), чтобы переопределить параметры категории политики аудита, а затем щелкните определить этот параметр политики.  
...
@no__t 0AppLocker: вопросы и ответы](https://technet.microsoft.com/library/ee619725(v=ws.10).aspx)  
  
## <a name="try-this-explore-command-line-process-auditing"></a>Попробуйте следующее: Просмотр аудита обработки командной строки  
