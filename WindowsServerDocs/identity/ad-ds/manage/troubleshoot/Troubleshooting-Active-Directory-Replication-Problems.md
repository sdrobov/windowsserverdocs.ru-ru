...
|Доступ запрещен.|Между двумя контроллерами домена существует связь репликации, но в результате сбоя проверки подлинности репликация не может быть выполнена должным образом.|Устранение проблем с безопасностью при репликации| 
