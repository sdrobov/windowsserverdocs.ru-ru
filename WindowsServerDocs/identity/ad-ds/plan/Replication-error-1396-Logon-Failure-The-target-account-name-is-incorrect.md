...
<developerConceptualDocument xmlns="https://ddue.schemas.microsoft.com/authoring/2003/5" xmlns:xlink="https://www.w3.org/1999/xlink" xmlns:xsi="https://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="https://ddue.schemas.microsoft.com/authoring/2003/5 http://clixdevr3.blob.core.windows.net/ddueschema/developer.xsd"> <introduction>
    <para>В этой статье описываются симптомы, причины и способы устранения проблем репликации Active Directory, ошибка Win32 1396: &quot;Ошибка входа: Указано неверное имя целевой учетной записи.&quot; </para>
    <list class="bullet">
      <listItem>
        <para>
  ...
  <section address="BKMK_Symptoms">
    ...
    <content>
      <para />
      <list class="ordered">
<listItem><para>Отчеты DCDIAG, Active Directory репликациями теста завершилось ошибкой 1396: Ошибка входа: Указано неверное имя целевой учетной записи.&quot;</para><code>Testing server: &lt;Site name&gt;&lt;DC Name&gt;
    ...
    <content>
      <list class="ordered">
        <listItem>
          ...
          <para>Имя участника-службы искомых (E3514235-4B06-11D1-AB04-00C04FC2DCD2 /&lt;guid для объекта параметров NTDS контроллеры домена источника объекта&gt;/&lt;целевой домен&amp;amp; gt;. &amp;amp; lt; tld&amp;amp; gt; @&lt;целевой домен&gt;.&lt; домена верхнего уровня&gt;</para>
