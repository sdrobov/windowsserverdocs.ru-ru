...
|------------|------------------------|------------------|-----------------|---------------------|--------------------|  
|[Сценарий 1. Присоединение существующего леса к автономности данных @ no__t-0|Нет|Нет|Да|Нет|Нет|  
|[Сценарий 2. Использование леса или домена организации для автономности службы @ no__t-0|Нет|Нет|Н/Д|Нет|Да|  
|@no__t 0Scenario 3: Использование леса организации или леса ресурсов для изоляции служб @ no__t-0|Нет|Нет|Н/Д|Да|Н/Д|  
|@no__t 0Scenario 4: Использование леса организации или ограниченного доступа для изоляции данных @ no__t-0|Н/Д|Да|Н/Д|Н/Д|Н/Д|  
|@no__t 0Scenario 5: Используйте организационный лес или перенастройте брандмауэр для ограниченного подключения @ no__t-0|Да|Нет|Н/Д|Нет|Нет|  
|@no__t 0Scenario 6: Используйте организационный лес или домен и перенастройте брандмауэр для автономности службы с ограниченным подключением @ no__t-0|Да|Нет|Н/Д|Нет|Да|  
|@no__t 0Scenario 7: Используйте лес ресурсов и перенастройте брандмауэр для изоляции служб с ограниченным подключением @ no__t-0|Да|Нет|Н/Д|Да|Н/Д|  

## <a name="BKMK_1"></a>Сценарий 1. Присоединение существующего леса к автономности данных  
...
## <a name="BKMK_2"></a>Сценарий 2. Использование леса или домена организации для автономной работы служб  
...
## <a name="BKMK_3"></a>Сценарий 3. Использование леса организации или леса ресурсов для изоляции служб  
...
## <a name="BKMK_4"></a>Сценарий 4. Использование леса организации или ограниченного доступа для изоляции данных  
...
## <a name="BKMK_5"></a>Сценарий 5. Используйте организационный лес или перенастройте брандмауэр для ограниченного подключения.  
...
## <a name="BKMK_6"></a>Сценарий 6. Используйте организационный лес или домен и перенастройте брандмауэр для автономности службы с ограниченным подключением.  
...
## <a name="BKMK_7"></a>Сценарий 7. Используйте лес ресурсов и перенастройте брандмауэр для изоляции служб с ограниченным подключением.  
