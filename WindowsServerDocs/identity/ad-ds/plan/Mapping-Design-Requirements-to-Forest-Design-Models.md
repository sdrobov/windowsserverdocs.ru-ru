...
|[Сценарий 2. использование леса организации или домена для автономной работы служб](#BKMK_2)|Нет|Нет|Нет данных|Нет|Да|  
|[Сценарий 3. использование леса организации или леса ресурсов для изоляции служб](#BKMK_3)|Нет|Нет|Нет данных|Да|Нет данных|  
|[Сценарий 4. использование леса организации или ограниченного доступа для изоляции данных](#BKMK_4)|Нет данных|Да|Нет данных|Нет данных|Нет данных|  
|[Сценарий 5. Используйте организационный лес или перенастройте брандмауэр для ограниченного подключения.](#BKMK_5)|Да|Нет|Нет данных|Нет|Нет|  
|[Сценарий 6. использование леса или домена организации и перенастройка брандмауэра для автономной работы службы с ограниченным подключением](#BKMK_6)|Да|Нет|Нет данных|Нет|Да|  
|[Сценарий 7. использование леса ресурсов и перенастройка брандмауэра для изоляции служб с ограниченным подключением](#BKMK_7)|Да|Нет|Нет данных|Да|Нет данных|  

## <a name="BKMK_1"></a>Сценарий 1. присоединение существующего леса к автономной среде данных  
...
## <a name="BKMK_2"></a>Сценарий 2. использование леса организации или домена для автономной работы служб  
...
## <a name="BKMK_6"></a>Сценарий 6. использование леса или домена организации и перенастройка брандмауэра для автономной работы службы с ограниченным подключением  
...
## <a name="BKMK_7"></a>Сценарий 7. использование леса ресурсов и перенастройка брандмауэра для изоляции служб с ограниченным подключением  
