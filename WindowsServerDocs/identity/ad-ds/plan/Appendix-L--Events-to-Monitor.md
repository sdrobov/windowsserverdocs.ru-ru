...
|4711|Н/Д|Низкий|Может содержать один из следующих вариантов. Модуль PAStore применить локальную копию хранилища Active Directory политику IPsec на компьютере. Модуль PAStore применить политику IPsec хранилища Active Directory на компьютере. Модуль PAStore применить политику IPsec из хранилища локального реестра на компьютере. Не удалось применить локальную копию хранилища Active Directory политику IPsec на компьютере Модуль PAStore. Не удалось применить политику IPsec для хранилища Active Directory на компьютере Модуль PAStore. Не удалось применить политику IPsec из хранилища локального реестра на компьютере Модуль PAStore. Не удалось применить некоторые правила активной политики IPsec на компьютере Модуль PAStore. Не удалось загрузить каталог хранилища политики IPsec на компьютере Модуль PAStore. Модуль PAStore загрузить каталог хранилища политики IPsec на компьютере. Не удалось загрузить локальное хранилище политики IPsec на компьютере Модуль PAStore. Модуль PAStore загрузить локального хранилища политики IPsec на компьютере. PAStore опрашивается на предмет изменений действующей политики IPsec и изменения не обнаружены.|  
