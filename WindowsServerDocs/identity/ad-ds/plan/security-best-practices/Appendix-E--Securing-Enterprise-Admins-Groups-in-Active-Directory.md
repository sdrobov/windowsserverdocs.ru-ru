...
---
# <a name="appendix-e-securing-enterprise-admins-groups-in-active-directory"></a>Приложение Д. Защита групп администраторов предприятия в Active Directory

>Область применения. Windows Server 2016, Windows Server 2012 R2, Windows Server 2012


## <a name="appendix-e-securing-enterprise-admins-groups-in-active-directory"></a>Приложение Д. Защита групп администраторов предприятия в Active Directory  
Группа администраторов предприятия (EA), размещенная в корневом домене леса, не должна содержать пользователей ежедневно, за исключением учетной записи администратора корневого домена, если она защищена, как описано в разделе [Appendix D: Защита встроенных учетных записей администраторов в Active Directory @ no__t-0.  
...
2.  Если вы не управляете корневым доменом для леса, в дереве консоли щелкните правой кнопкой мыши <Domain>, а затем выберите команду **изменить домен** (где <Domain> — имя домена, на котором выполняется администрирование).  
