...
@no__t 0Computer \ политики \ \ конфигурация \ локальные политики \ Оптионс\интерактиве \ вход в систему: Требовать смарт-карту @ no__t-0  
