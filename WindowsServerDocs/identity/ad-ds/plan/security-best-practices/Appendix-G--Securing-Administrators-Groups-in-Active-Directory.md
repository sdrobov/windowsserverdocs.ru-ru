...
1.  Удалите всех участников из группы "Администраторы" с возможным исключением встроенной учетной записи администратора для домена, если оно защищено, как описано в разделе [Appendix D: Защита встроенных учетных записей администраторов в Active Directory @ no__t-0.  
...
2.  В дереве консоли разверните узел &lt;Forest @ no__t-1\Domains @ no__t-2 @ no__t-3Domain @ no__t-4, а затем **Групповая политика объекты** (где &lt;Forest @ no__t-7 — имя леса, а &lt;Domain @ no__t-9 — имя домена, в котором вы хотите Задайте групповая политика).  
...
11. В **Групповая политика управления**свяжите объект групповой политики с подразделениями рядового сервера и рабочей станции, выполнив следующие действия.  
    ...
    1.  Перейдите к &lt;Forest @ no__t-1 > \Домаинс @ no__t-2 @ no__t-3Domain @ no__t-4 (где &lt;Forest @ no__t-6 — это имя леса, а &lt;Domain @ no__t-8 — имя домена, в котором вы хотите задать групповая политика).  
