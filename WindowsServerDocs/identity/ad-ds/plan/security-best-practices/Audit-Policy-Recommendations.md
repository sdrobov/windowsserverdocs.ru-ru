...
title: Рекомендации по настройке политик аудита
...
ms.locfileid: "80821347"
---
# <a name="audit-policy-recommendations"></a>Рекомендации по настройке политик аудита
...
-   [Аудит доступа к глобальным объектам — это волшебная](https://blogs.technet.com/b/askds/archive/2011/03/10/global-object-access-auditing-is-magic.aspx) информация о настройке и использовании расширенной конфигурации политики аудита, добавленной в Windows 7 и windows Server 2008 R2.  

-   [Введение в аудит изменений в windows 2008](https://blogs.technet.com/b/askds/archive/2007/10/19/introducing-auditing-changes-in-windows-2008.aspx) — введение в аудит изменений, внесенных в Windows 2008.  

-   Полезные [Советы по аудиту в Vista и 2008](https://blogs.technet.com/b/askds/archive/2007/11/16/cool-auditing-tricks-in-vista-and-2008.aspx) — объясняются интересные новые функции аудита в Windows Vista и windows Server 2008, которые можно использовать для устранения неполадок или для просмотра данных в вашей среде.  
