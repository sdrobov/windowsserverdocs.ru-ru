...
5.  В окне **командной строки** введите **net use \\\\<Server Name>\c $/User:<Server Name>\ администратор**, где <Server Name> — имя рядового сервера или рабочей станции, к которой вы пытаетесь получить доступ по сети.  
