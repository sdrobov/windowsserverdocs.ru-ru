...
* [Аудит доступа к глобальным объектам — это волшебное](http://blogs.technet.com/b/askds/archive/2011/03/10/global-object-access-auditing-is-magic.aspx) описание механизма управления, называемого расширенной конфигурацией политики аудита, которая была добавлена в Windows 7 и windows Server 2008 R2, которая позволяет задать типы данных, которые вы хотите легко проследить, а также не управлять сценариями и Auditpol. exe.  
