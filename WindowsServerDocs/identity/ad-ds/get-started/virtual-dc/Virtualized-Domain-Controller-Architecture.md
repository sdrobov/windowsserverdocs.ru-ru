...
## <a name="virtualized-domain-controller-cloning-architecture"></a><a name="BKMK_CloneArch"></a>Архитектура виртуализированного клонированного контроллера домена  
...
### <a name="cloning-detailed-processing"></a><a name="BKMK_CloneProcessDetails"></a>Клонирование подробной обработки  
...
## <a name="virtualized-domain-controller-safe-restore-architecture"></a><a name="BKMK_SafeRestoreArch"></a>Архитектура безопасного восстановления с виртуализированным контроллером домена  
