...
-   [Архитектура виртуализированного клонированного контроллера домена](../../../ad-ds/get-started/virtual-dc/Virtualized-Domain-Controller-Architecture.md#BKMK_CloneArch)  
  
-   [Архитектура безопасного восстановления с виртуализированным контроллером домена](../../../ad-ds/get-started/virtual-dc/Virtualized-Domain-Controller-Architecture.md#BKMK_SafeRestoreArch)  
  
## <a name="BKMK_CloneArch"></a>Архитектура виртуализированного клонированного контроллера домена  
...
### <a name="BKMK_CloneProcessDetails"></a>Клонирование подробной обработки  
...
## <a name="BKMK_SafeRestoreArch"></a>Архитектура безопасного восстановления с виртуализированным контроллером домена  
...
-   При использовании DFSR Гостевая служба останавливает службу DFSR и удаляет файлы базы данных DFSR (расположение по умолчанию:%системрут%\систем Volume информатион\дфср @ no__t-0 *<database GUID>* ). Затем она запускает службу DFSR, которая непринудительно реплицирует входящие данные, по возможности используя имеющиеся неизмененные данные SYSVOL.  
