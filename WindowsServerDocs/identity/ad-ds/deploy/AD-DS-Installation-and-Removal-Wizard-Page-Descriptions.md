...
## <a name="review-options"></a><a name="BKMK_ViewInstallOptionsPage"></a>Параметры проверки  
...
## <a name="review-options"></a><a name="BKMK_ConfirmRoleRemovalPage"></a>Параметры проверки  
