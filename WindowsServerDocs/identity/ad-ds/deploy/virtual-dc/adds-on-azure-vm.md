...
Приведенный ниже скрипт можно запустить непосредственно из портал Azure. Если вы решили установить и использовать CLI локально, для работы с этим руководством вам потребуется Azure CLI версии 2.0.4 или более поздней. Выполните `az --version` команду, чтобы найти версию. Если необходимо установить или обновить, см. статью [install Azure CLI 2,0](https://docs.microsoft.com/cli/azure/install-azure-cli?view=azure-cli-latest).
...
Сведения о расширении локальной сети в Azure можно найти в статье [Creating VPN-подключение типа "сеть — сеть" @ no__t-1.
...
* Инициализируйте и отформатируйте диск данных как F:
   ...
   * Перейдите к **хранилищу @no__t хранилище**-1.**Управление дисками**
