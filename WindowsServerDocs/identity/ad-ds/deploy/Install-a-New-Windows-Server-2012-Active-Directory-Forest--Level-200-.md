...
Дополнительные сведения о необходимости создания DNS-делегирования см. в статье [Общее представление о делегировании зоны](https://technet.microsoft.com/library/cc771640.aspx).  
  
#### <a name="additional-options"></a>Дополнительные варианты  
