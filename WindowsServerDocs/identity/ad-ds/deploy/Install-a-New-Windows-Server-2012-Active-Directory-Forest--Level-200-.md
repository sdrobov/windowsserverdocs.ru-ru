...
## <a name="active-directory-domain-services-simplified-administration"></a><a name="BKMK_SimplifiedAdmin"></a>Упрощенное администрирование служб домен Active Directory Services  
...
## <a name="deploying-a-forest-with-server-manager"></a><a name="BKMK_SMForest"></a>Развертывание леса с диспетчер сервера  
...
|Install-WindowsFeature/Add-WindowsFeature|***-Имя***<p>*-Restart*<p>*-Инклудеаллсубфеатуре*<p>*-IncludeManagementTools*<p>-Source<p>*-ComputerName*<p>-Credential<p>-LogPath<p>*— Виртуальный жесткий диск*<p>*-Конфигуратионфилепас*|  
...
### <a name="create-an-ad-ds-forest-root-domain-with-windows-powershell"></a><a name="BKMK_PS"></a>Создание AD DS корневого домена леса с помощью Windows PowerShell  
...
|install-addsforest|-Confirm<p>*-Креатеднсделегатион*<p>*-DatabasePath*<p>*-Домаинмоде*<p>***-Имя_домена***<p>***-Домаиннетбиоснаме***<p>*-Днсделегатионкредентиал*<p>*-Леса*<p>-Force<p>*-Инсталлднс*<p>*-LogPath*<p>-NoDnsOnNetwork<p>-NoRebootOnCompletion<p>*-SafeModeAdministratorPassword*<p>-SkipAutoConfigureDNS<p>-SkipPreChecks<p>*-Сисволпас*<p>*-WhatIf*|  
...
[Обратитесь к группе по службам каталогов (официальный блог по технической поддержке корпорации Майкрософт)](https://blogs.technet.com/b/askds)  
