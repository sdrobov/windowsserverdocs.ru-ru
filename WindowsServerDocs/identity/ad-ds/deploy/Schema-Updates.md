...
---
# <a name="schema-updates"></a>Обновление схемы

>Область применения: Windows Server 2016, Windows Server 2012 R2, Windows Server 2012

В этом разделе перечислены LDF-файлы, которые включают изменения, которые Adprep.exe вносит.  

Ниже перечислены LDF-файлов, включенных в Windows Server 2016:
...
Ниже перечислены LDF-файлов, включенных в Windows Server 2012 R2:  
...
Ниже перечислены LDF-файлов, включенных в Windows Server 2012:  
