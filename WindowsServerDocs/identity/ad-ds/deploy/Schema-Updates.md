...
title: Обновление схемы в Windows Server
description: Изменения схемы, вносимые файлом Adprep.exe по версиям операционной системы
...
ms.locfileid: "59822665"
---
# <a name="windows-server-active-directory-schema-updates"></a>Обновление схемы Windows Server Active Directory

>Область применения. Windows Server

В этом разделе перечислены файлы LDF, содержат изменения, которые вносит Adprep.exe.  

Это файл LDF, включенные в Windows Server 2019:

-   [Sch88.ldf](#BKMK_Sch88)

Ниже приведены LDF-файлы, включенные в Windows Server 2016.
...
Ниже приведены LDF-файлы, включенные в Windows Server 2012 R2.  
...
Ниже приведены LDF-файлы, включенные в Windows Server 2012.  
...
## <a name="schema-update-in-windows-server-2019"></a>Обновление схемы в Windows Server 2019 г.
...
## <a name="schema-updates-in-windows-server-2016"></a>Обновление схемы в Windows Server 2016
...
## <a name="BKMK_SchemaUpdates2012R2"></a>Обновление схемы в Windows Server 2012 R2  
...
## <a name="BKMK_SchemaUpdates2012"></a>Обновление схемы в Windows Server 2012  
