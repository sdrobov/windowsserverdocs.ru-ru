...
title: Обновления схемы в Windows Server
description: Изменения схемы, внесенные Adprep по версии операционной системы
...
ms.locfileid: "71369610"
---
# <a name="windows-server-active-directory-schema-updates"></a>Обновления схемы Active Directory Windows Server

>Область применения. Windows Server

В этом разделе перечислены файлы LDF, которые содержат изменения, вносимые в средство Adprep. exe.  

Это LDF-файл, входящий в Windows Server 2019:

-   [Sch88. ldf](#BKMK_Sch88)

Это файлы LDF, входящие в Windows Server 2016:
...
Это файлы LDF, входящие в Windows Server 2012 R2:  
...
Это файлы LDF, входящие в Windows Server 2012:  
...
## <a name="schema-update-in-windows-server-2019"></a>Обновление схемы в Windows Server 2019
...
## <a name="schema-updates-in-windows-server-2016"></a>Обновления схемы в Windows Server 2016
...
## <a name="BKMK_SchemaUpdates2012R2"></a>Обновления схемы в Windows Server 2012 R2  
...
## <a name="BKMK_SchemaUpdates2012"></a>Обновления схемы в Windows Server 2012  
