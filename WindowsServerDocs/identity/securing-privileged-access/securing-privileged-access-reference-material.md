...
|Использование оснасток MMC для удаленного компьютера|Network|-|Пример. Управление компьютерами, Просмотр событий, диспетчер устройств, службы|
|WinRM PowerShell|Network|-|Пример. Сервер Enter-PSSession|
