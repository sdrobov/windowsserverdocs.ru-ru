...
1.  Войдите на контроллер домена adatum.com как администратор с паролем **pass@word1**.  
...
1.  Войдите в контроллер домена, домен contoso.com как администратор с паролем **pass@word1**.  
...
1.  Войдите в клиент компьютер CLIENT1 с учетной записью Jeff Low с паролем **pass@word1**.  
