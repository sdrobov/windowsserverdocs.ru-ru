...
![решения,](media/Deploy-Encryption-of-Office-Files--Demonstration-Steps-/PowerShellLogoSmall.gif)***<em>эквивалентные командам Windows PowerShell</em>***  
...
## <a name="BKMK_3"></a>Шаг 3. Использование задач управления файлами для автоматической защиты документов с помощью AD RMS  
...
11. Правой кнопкой мыши щелкните документ Finance Memo и выберите пункт **Свойства**. Перейдите на вкладку **классификация** . Обратите внимание, что свойство **воздействие** теперь имеет значение **высокий**. Нажмите кнопку **Отмена**.  
  
12. Щелкните правой кнопкой документ Request for Approval to Hire и выберите пункт **Свойства**.  
  
13. . Перейдите на вкладку **классификация** . Обратите внимание, что свойство **личные сведения** теперь имеет значение **высокий**. Нажмите кнопку **Отмена**.  
