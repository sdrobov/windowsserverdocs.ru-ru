...
## <a name="step-3-use-file-management-tasks-to-automatically-protect-documents-with-ad-rms"></a><a name="BKMK_3"></a>Шаг 3. Использование задач управления файлами для автоматической защиты документов с помощью AD RMS  
...
## <a name="step-5-verify-protection-with-ad-rms"></a><a name="BKMK_5"></a>Шаг 5. Проверка защиты с помощью AD RMS  
