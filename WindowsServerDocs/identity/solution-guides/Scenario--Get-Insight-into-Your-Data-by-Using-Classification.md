...
title: Сценарий Get представление о данных с помощью классификации
description: ''
author: billmath
ms.author: billmath
manager: femila
...
ms.locfileid: "59881485"
---
# <a name="scenario-get-insight-into-your-data-by-using-classification"></a>Сценарий: получите четкое представление о ваших данных с помощью классификации
...
Вы найдете пошаговые инструкции для автоматической классификации файлов в [развертывание автоматической классификации файлов &#40;Поэтапная&#41;](Deploy-Automatic-File-Classification--Demonstration-Steps-.md).  
