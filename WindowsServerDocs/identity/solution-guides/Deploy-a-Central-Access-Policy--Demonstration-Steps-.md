...
|Этап|Описание  
|---------|---------------  
|@no__t 0Plan: Указание необходимости в политике и конфигурации, необходимой для развертывания @ no__t-0|Определение необходимости в политике и конфигурации для развертывания. 
|@no__t 0Implement: Настройка компонентов и политики @ no__t-0|Настройка компонентов и политики.  
...
|@no__t 0Maintain: Изменение и размещение политики @ no__t-0|Изменения политик и промежуточное хранение. 

## <a name="BKMK_1.1"></a>Настройка тестовой среды  
Прежде чем приступать, вам необходимо настроить лабораторию для тестирования этого сценария. Шаги по настройке лаборатории подробно описаны в разделе @no__t 0Appendix B. Идет Настройка тестовой среды @ no__t-0.  

## <a name="BKMK_1.2"></a>Планов Определение необходимости в политике и конфигурации для развертывания.  
...
## <a name="BKMK_1.3"></a>Применить Настройка компонентов и политики  
...
1. Откройте сервер DC1 в диспетчере Hyper-V и войдите в систему как CONTOSO\Administrator, используя пароль <strong>pass@word1</strong>.  
...
![solution руководство по использованию](media/Deploy-a-Central-Access-Policy--Demonstration-Steps-/PowerShellLogoSmall.gif)***<em>эквивалентных команд Windows PowerShell</em>***  
...
## <a name="BKMK_1.5"></a>Обеспечивать изменение и сверка политики  
...
4. Дважды щелкните ярлык рабочего стола, чтобы \\ \ FILE1\Finance документы. У пользователя EValle по-прежнему должен быть доступ к файлам. Переключитесь на сервер FILE1.  
