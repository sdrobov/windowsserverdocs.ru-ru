...
|1.3|Выразить политику доступа в конструкциях Windows Server 2012|Целевая платформа:<p>-Resource. Department содержит финансовый отдел<p>Правила доступа:<p>— Разрешить чтение пользователя. страна = ресурс. страна и пользователь. штат = ресурс. Отдел<br />-Разрешить полный доступ User. MemberOf (Финанцеадмин)<p>Исключение:<p>Allow read memberOf(FinanceException)|  
