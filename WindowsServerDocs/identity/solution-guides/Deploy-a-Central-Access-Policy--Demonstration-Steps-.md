...
1. Откройте сервер DC1 в диспетчере Hyper-V и войдите с учетной записью contoso\administrator, используя пароль <strong>pass@word1</strong>.  
...
![руководства по решениям](media/Deploy-a-Central-Access-Policy--Demonstration-Steps-/PowerShellLogoSmall.gif)***<em>эквивалентные команды Windows PowerShell</em>***  
...
3. Вам также необходимо обновить глобальные свойства ресурсов из Active Directory. Откройте командное окно Windows PowerShell с повышенными привилегиями и введите: `Update-FSRMClassificationpropertyDefinition`. Нажмите клавишу ВВОД и закройте Windows PowerShell.  
   ...
   > 
   > 1. Войдите на файловый сервер FILE1 как contoso\administrator, используя пароль <strong>pass@word1</strong>.  
...
1. Подключитесь к файловому серверу FILE1 в диспетчере Hyper-V и войдите как contoso\administrator, используя пароль <strong>pass@word1</strong>.  
