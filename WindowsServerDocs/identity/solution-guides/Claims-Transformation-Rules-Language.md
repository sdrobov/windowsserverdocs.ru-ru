...
4.  Пример.  
    ...
    **Сообщение об ошибке:**  
    *POLICY0002: Не удалось проанализировать данные о политике.*  
    *Номер строки: 1, номер столбца: 23, токен ошибки. 1. Line: 'c1:[type=="x1", value==1, valuetype=="bool"]=>Issue(claim=c1);'.**Parser error: "POLICY0029: Непредвиденные входные данные.*  
