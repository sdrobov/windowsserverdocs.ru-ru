...
##### [Развертывание централизованной политики доступа (демонстрация последовательности действий)](solution-guides/Deploy-a-Central-Access-Policy--Demonstration-Steps-.md)
#### [Сценарий: аудит доступа к файлам](solution-guides/Scenario--File-Access-Auditing.md)
##### [План аудита доступа к файлам](solution-guides/Plan-for-File-Access-Auditing.md)
##### [Развертывание аудита безопасности при помощи централизованной политики аудита (поэтапная демонстрация)](solution-guides/Deploy-Security-Auditing-with-Central-Audit-Policies--Demonstration-Steps-.md)
#### [Сценарий: помощь при отказе в доступе](solution-guides/Scenario--Access-Denied-Assistance.md)
##### [Развертывание помощи при отказе в доступе (поэтапная демонстрация)](solution-guides/Deploy-Access-Denied-Assistance--Demonstration-Steps-.md)
...
##### [Развертывание шифрования файлов Office (поэтапная демонстрация)](solution-guides/Deploy-Encryption-of-Office-Files--Demonstration-Steps-.md)
...
##### [Развертывание автоматической классификации данных (поэтапная демонстрация)](solution-guides/Deploy-Automatic-File-Classification--Demonstration-Steps-.md)
...
##### [Развертывание реализации хранения сведений на файловых серверах (обучающий пример)](solution-guides/Deploy-Implementing-Retention-of-Information-on-File-Servers--Demonstration-Steps-.md)
#### [Развертывание утверждений между лесами](solution-guides/Deploy-Claims-Across-forests.md)
##### [Развертывание утверждений между лесами (обучающий пример)](solution-guides/Deploy-Claims-Across-forests--Demonstration-Steps-.md)
...
##### [Корзина AD, детально настроенная политика паролей и журнал PowerShell](ad-ds/get-started/adac/Introduction-to-active-directory-Administrative-Center-Enhancements--Level-100-.md)
##### [Расширенная настройка управления AD DS с помощью центра администрирования Active Directory](ad-ds/get-started/adac/Advanced-AD-DS-Management-Using-active-directory-Administrative-Center--Level-200-.md)
...
###### [Под управлением Active Directory на виртуальных машинах Azure](ad-ds/deploy/virtual-dc/adds-on-azure-vm.md)
...
####[Службы времени Windows и AD DS](../networking/windows-time-service/windows-time-service.md)

### [Планирование и проектирование доменных служб Active Directory](ad-ds/plan/AD-DS-Design-and-Planning.md)

#### [Общее представление о схеме доменных служб Active Directory](ad-ds/plan/Understanding-AD-DS-Design.md)
...
##### [Развертывание доменных служб Active Directory в новой организации](ad-ds/plan/Deploying-AD-DS-in-a-New-Organization.md)
...
###### [DNS и доменные службы ActiveDirectory](ad-ds/plan/DNS-and-AD-DS.md)
####### [Расположение контроллера домена](ad-ds/plan/Domain-Controller-Location.md)
####### [Зоны DNS, интегрированные с ActiveDirectory](ad-ds/plan/active-directory-Integrated-DNS-Zones.md)
####### [Именование компьютеров](ad-ds/plan/computer-Naming.md)
####### [Несвязанное пространство имен](ad-ds/plan/Disjoint-Namespace.md)
###### [Назначение DNS для роли владельца доменных служб ActiveDirectory](ad-ds/deploy/assigning-the-DNS-for-AD-DS-Owner-Role.md)
###### [Интеграция доменных служб ActiveDirectory в имеющуюся инфраструктуру DNS](ad-ds/plan/Integrating-AD-DS-into-an-Existing-DNS-Infrastructure.md)
...
###### [Понятия репликации ActiveDirectory](ad-ds/get-started/replication/active-directory-Replication-Concepts.md)
...
###### [Задание свойств связи сайтов](ad-ds/plan/Setting-Site-Link-Properties.md)
...
##### [Установка нового дочернего домена или домена в виде дерева Windows Server Active Directory](ad-ds/deploy/Install-a-New-Windows-Server-2012-active-directory-Child-or-tree-Domain--Level-200-.md)
##### [Установка контроллера домена только для чтения (RODC) Windows Server 2012 Active Directory](ad-ds/deploy/RODC/Install-a-Windows-Server-2012-active-directory-Read-Only-Domain-Controller--RODC---Level-200-.md)
#### [Понижение уровня контроллеров доменов](ad-ds/deploy/Demoting-Domain-Controllers-and-Domains--Level-200-.md)
##### [Очистка метаданных AD DS](ad-ds/deploy/ad-ds-metadata-cleanup.md)
#### [Описание страниц мастера установки и удаления AD DS](ad-ds/deploy/AD-DS-Installation-and-removal-Wizard-Page-Descriptions.md)
#### [Изменения, вносимые файлом Adprep.exe](ad-ds/deploy/adprep/changes-Made-by-Adprep.md)
##### [Обновление схемы](ad-ds/deploy/Schema-Updates.md)
##### [Обновление контроллера домена только для чтения](ad-ds/deploy/RODC/Read-Only-Domain-Controller-Updates.md)
...
#### [Устранение неполадок развертывания контроллера домена](ad-ds/deploy/Troubleshooting-Domain-Controller-Deployment.md)
...
#### [Управление выдачей RID](ad-ds/manage/Managing-RID-Issuance.md)
...
##### [Обновление компонентов удостоверений](ad-ds/manage/component-updates/Identity-component-updates.md)
...
#### [Способ обработки файлов cookie сервера LDAP](ad-ds/manage/How-LDAP-Server-Cookies-Are-Handled.md)

### [Диагностика доменных служб Active Directory](ad-ds/manage/AD-DS-Troubleshooting.md)
#### [Настройка компьютера для диагностики](ad-ds/manage/troubleshoot/Configuring-a-computer-for-Troubleshooting.md)
#### [Устранение неполадок репликации Active Directory](ad-ds/manage/troubleshoot/Troubleshooting-active-directory-Replication-Problems.md)
...
### [Обзор служб федерации AD FS](ad-fs/AD-FS-Overview.md)
...
###### [Определение целей по развертыванию AD FS](ad-fs/design/Identify-Your-AD-FS-Deployment-Goals.md)
###### [Планирование топологии развертывания AD FS](ad-fs/design/Plan-Your-AD-FS-Deployment-Topology.md)
...
###### [Требования AD FS](ad-fs/design/AD-FS-Requirements.md)
##### [Руководство по разработке служб AD FS в Windows Server 2012](ad-fs/design/AD-FS-Design-Guide-in-Windows-Server-2012.md)
###### [Определение целей по развертыванию AD FS](ad-fs/design/Identifying-Your-AD-FS-Deployment-Goals.md)
...
###### [Сопоставление целей развертывания с разработкой AD FS](ad-fs/design/Mapping-Your-Deployment-Goals-to-an-AD-FS-Design.md)
...
###### [Определение топологии развертывания AD FS](ad-fs/design/Determine-Your-AD-FS-Deployment-Topology.md)
####### [Некоторые аспекты топологии развертывания AD FS](ad-fs/design/AD-FS-Deployment-Topology-Considerations.md)
####### [Независимый сервер федерации с использованием WID](ad-fs/design/Stand-Alone-Federation-Server-Using-WID.md)
...
####### [Планирование взаимодействия со службами федерации Active Directory1.x](ad-fs/design/Planning-for-Interoperability-with-AD-FS-1.x.md)
####### [Использование делегирования удостоверений](ad-fs/design/When-to-Use-Identity-delegation.md)
####### [Развертывание служб федерации Active Directory в партнерской организации по учетным записям](ad-fs/design/Deploying-AD-FS-in-the-Account-Partner-Organization-2012.md)
...
####### [Развертывание служб федерации Active Directory в партнерской организации по ресурсам](ad-fs/design/Deploying-AD-FS-in-the-Resource-Partner-Organization-2012.md)
...
####### [Когда следует создавать ферму серверов федерации](ad-fs/design/When-to-create-a-Federation-Server-Farm.md)
####### [Требования к сертификатам для серверов федерации](ad-fs/design/Certificate-Requirements-for-Federation-Servers.md)
######## [Сертификаты подписи токена](ad-fs/design/Token-Signing-Certificates.md)
...
####### [Когда следует создавать прокси-сервер федерации](ad-fs/design/When-to-create-a-Federation-Server-Proxy.md)
####### [Размещение прокси-сервера федерации](ad-fs/design/Where-to-Place-a-Federation-Server-Proxy.md)
####### [Когда следует создавать ферму прокси-серверов федерации](ad-fs/design/When-to-create-a-Federation-Server-Proxy-Farm.md)
...
###### [Планирование производительности сервера AD FS](ad-fs/design/Planning-for-AD-FS-Server-Capacity.md)
####### [Планирование емкости сервера федерации](ad-fs/design/Planning-for-Federation-Server-Capacity.md)
####### [Планирование емкости прокси-сервера федерации](ad-fs/design/Planning-for-Federation-Server-Proxy-Capacity.md)
###### [Приложение A. Анализ требований AD FS](ad-fs/design/appendix-A--Reviewing-AD-FS-Requirements.md)
...
###### [Установка службы роли AD FS](ad-fs/deployment/Install-the-AD-FS-Role-Service.md)
...
###### [Проверка работоспособности сервера федерации Windows Server2012R2](ad-fs/deployment/verify-your-Windows-Server-2012-R2-Federation-Server-Is-Operational.md)
...
##### [Контрольный список: реализация проекта единого входа для интернет-решений](ad-fs/deployment/Checklist--Implementing-a-Web-SSO-Design.md)
##### [Контрольный список: реализация проекта единого входа федерации для интернет-решений](ad-fs/deployment/Checklist--Implementing-a-Federated-Web-SSO-Design.md)
##### [Настройка партнерских организаций](ad-fs/deployment/Configuring-Partner-Organizations.md)
###### [Контрольный список: настройка партнерской организации по учетным записям](ad-fs/deployment/Checklist--Configuring-the-Account-Partner-Organization.md)
...
###### [Распространение сертификатов на клиентские компьютеры с помощью групповой политики](ad-fs/deployment/Distribute-Certificates-to-Client-computers-by-Using-Group-Policy.md)
...
###### [Создание правила для отправки утверждения, совместимого с ADFS1.x](ad-fs/operations/create-a-Rule-to-Send-an-AD-FS-1x-compatible-Claim.md)
...
###### [Установка службы роли службы федерации](ad-fs/deployment/Install-the-Federation-Service-Role-Service.md)
...
###### [Создание автономного сервера федерации](ad-fs/deployment/create-a-Stand-Alone-Federation-Server.md)
...
###### [Добавление сертификата подписи токенов](ad-fs/deployment/add-a-Token-Signing-Certificate.md)
###### [Добавление сертификата расшифровки токенов](ad-fs/deployment/add-a-Token-Decrypting-Certificate.md)
###### [Задание сертификата связи со службой](ad-fs/deployment/Set-a-Service-Communications-Certificate.md)
...
###### [Установка службы роли прокси-агента службы федерации](ad-fs/deployment/Install-the-Federation-Service-Proxy-Role-Service.md)
...
###### [Контрольный список: настройка ADFS для использования утверждений из ADFS1.x](ad-fs/deployment/Checklist--Configuring-AD-FS--to-Consume-Claims-from-AD-FS-1.x.md)
###### [Контрольный список: настройка ADFS для отправки утверждений в службу федерации ADFS1.x](ad-fs/deployment/Checklist--Configuring-AD-FS-to-Send-Claims-to-an-AD-FS-1.x-Federation-Service.md)
###### [Контрольный список: настройка ADFS для отправки утверждений в веб-агент ADFS1.x, поддерживающий утверждения](ad-fs/deployment/Checklist--Configuring-AD-FS-to-Send-Claims-to-an-AD-FS-1.x-Claims-Aware-Web-Agent.md)
###### [Создание отношений доверия с проверяющей стороной вручную](ad-fs/operations/create-a-Relying-Party-Trust.md)
###### [Создание отношений доверия с поставщиком утверждений вручную](ad-fs/operations/create-a-Claims-Provider-Trust.md)
###### [Создание правила для отправки утверждения, совместимого с ADFS1.x](ad-fs/operations/create-a-Rule-to-Send-an-AD-FS-1x-compatible-Claim.md)
...
#####[Перенос прокси-сервера федерации ADFS](ad-fs/deployment/migrate-fed-server-proxy-r2.md)
...
######[Подготовка к переносу изолированного сервера AD FS 2.0 или фермы серверов с одним узлом](ad-fs/deployment/prepare-to-migrate-a-stand-alone-ad-fs-federation-server.md)
...
######[Перенос изолированного сервера AD FS 2.0 или фермы серверов с одним узлом](ad-fs/deployment/migrate-ad-fs-stand-alone-server.md)
...
#### [Пользовательские маркеры безопасности в AD FS](ad-fs/development/Custom-Id-Tokens-in-AD-FS.md)
#### [Проверка подлинности от имени пользователя AD FS в Windows Server 2016](ad-fs/development/AD-FS-On-behalf-of-Authentication-in-Windows-Server.md)
#### [Включение подключения OpenId с помощью AD FS 2016](ad-fs/development/Enabling-OpenId-Connect-with-AD-FS.md)
...
#### [Дополнительные способы проверки подлинности в AD FS 2019](ad-fs/operations/Additional-Authentication-Methods-AD-FS.md)
#### [Поддержка по параметру входа в запросе AD FS](ad-fs/operations/AD-FS-Prompt-Login.md)
#### [Разбитый на страницы процесс входа в AD FS](ad-fs/operations/AD-FS-paginated-sign-in.md)
#### [Параметры единого входа AD FS 2016](ad-fs/operations/AD-FS-Single-Sign-On-Settings.md)
#### [Средство ускоренного восстановления AD FS](ad-fs/operations/AD-FS-Rapid-Restore-Tool.md)
#### [Поддержка привязки альтернативного имени узла для проверки подлинности сертификата в AD FS](ad-fs/operations/AD-FS-support-for-alternate-hostname-binding-for-certificate-authentication.md)
...
#### [Настройка AD FS для проверки подлинности пользователя на основе сертификата](ad-fs/operations/Configure-User-Certificate-Authentication.md)
...
#### [Настройка дополнительных методов проверки подлинности для службы федерации Active Directory](ad-fs/operations/Configure-additional-Authentication-Methods-for-AD-FS.md)
...
#### [Настройка проверки подлинности интрасети на основе форм для устройств, не поддерживающих WIA](ad-fs/operations/Configure-intranet-forms-based-authentication-for-devices-that-do-not-support-WIA.md)
#### [Настройка альтернативного идентификатора входа](ad-fs/operations/Configuring-Alternate-Login-ID.md)
#### [Создание отношений доверия с поставщиком утверждений](ad-fs/operations/create-a-Claims-Provider-Trust.md) 
#### [Создание отношений доверия с проверяющей стороной, не поддерживающей утверждения](ad-fs/operations/create-a-Non-Claims-Aware-Relying-Party-Trust.md)
#### [Создание отношений доверия с проверяющей стороной](ad-fs/operations/create-a-Relying-Party-Trust.md) 
#### [Настройка заголовков ответа HTTP с помощью AD FS](ad-fs/operations/customize-http-security-headers-ad-fs.md)
#### [Передача прав доступа командлетов для AD FS Powershell для пользователей без прав администратора](ad-fs/operations/delegate-ad-fs-pshell-access.md)
#### [Элементы управления проверкой подлинности устройств в AD FS](ad-fs/operations/device-authentication-controls-in-AD-FS.md)
...
#### [Настройка лабораторной среды AD FS](ad-fs/operations/Set-up-an-AD-FS-lab-environment.md)
...
#### [Пошаговое руководство: подключение к рабочему месту с помощью устройства под управлением iOS](ad-fs/operations/Walkthrough--Workplace-Join-with-an-iOS-Device.md)
#### [Пошаговое руководство: подключение к рабочему месту с помощью устройства под управлением Android](ad-fs/operations/Walkthrough--Workplace-Join-to-an-Android-device.md)

### [Устранение неполадок в AD FS](ad-fs/troubleshooting/ad-fs-tshoot-overview.md)
#### [Средство анализа данных диагностики AD FS](ad-fs/troubleshooting/ad-fs-diagnostics-analyzer.md)
...
#### [Инициированный вход в систему](ad-fs/troubleshooting/ad-fs-tshoot-initiatedsignon.md)
#### [Встроенная проверка подлинности Windows](ad-fs/troubleshooting/ad-fs-tshoot-iwa.md)
#### [Ведение журналов](ad-fs/troubleshooting/ad-fs-tshoot-logging.md)
#### [Циклы](ad-fs/troubleshooting/ad-fs-tshoot-loop.md)
#### [SQL](ad-fs/troubleshooting/ad-fs-tshoot-sql.md)



### [Технический справочник по службам федерации AD FS](ad-fs/AD-FS-Technical-Reference.md)
...
#### [Усовершенствования аудита в AD FS под управлением Windows Server](ad-fs/technical-reference/auditing-enhancements-to-ad-fs-in-windows-server.md)
...
##### [Использование уникальных идентификаторов ресурса (URI) в AD FS](ad-fs/technical-reference/How-URIs-Are-Used-in-AD-FS.md)
...
### [Диагностика политик ограниченного использования программ](software-restriction-policies/troubleshoot-software-restriction-policies.md)
