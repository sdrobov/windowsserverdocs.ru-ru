...
ms.locfileid: "8976730"
---
# Обзор Semi-Annual Channel для Windows Server
...
# Еще по теме
[Каналы обслуживания Windows Server 2019: LTSC и SAC](https://docs.microsoft.com/windows-server/get-started-19/servicing-channels-19)

[Изменения сервера Nano Server в Semi-Annual Channel для Windows Server](nano-in-semi-annual-channel.md)

[Срок поддержки Windows Server](https://support.microsoft.com/en-us/lifecycle)
