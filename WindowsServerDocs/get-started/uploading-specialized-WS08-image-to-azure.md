...
- Настройка параметров брандмауэра Windows.   
   ...
   2. Отсортируйте результаты по **Портам** и выберите **порт 3389**.   
     ![Снимок экрана: брандмауэр WIndows параметры правила для входящих подключений.](media/3b_inboundrules.png)   
   3. Включите удаленный рабочий стол (TCP-IN) для профилей: **Домен**, **частного**, и **открытый** (как показано выше).
...
5. Выберите **срок действия пароля не ограничен** и выберите **ОК**
![снимок экрана свойств администратора.](media/6_adminprops.png)
...
6.  Создайте [диск](https://docs.microsoft.com/azure/virtual-machines/windows/prepare-for-upload-vhd-image) для вашего виртуального жесткого диска.   
     1. Перейдите в раздел "Диски" и нажмите кнопку **Добавить**.  
     2. Задайте диску имя. Выберите подписку, которую требуется использовать, задайте регион и выберите тип учетной записи.   
     ...
     Г. Выберите тип операционной системы Windows и размер (по умолчанию: 1023).   
...
7.  Перейдите в раздел "Созданные диски" и нажмите кнопку **Создать виртуальную машину**.   
     ...
     2. Выберите группу, созданную на шаге 5, в которую был загружен диск.   
