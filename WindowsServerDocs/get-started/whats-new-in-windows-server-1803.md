...
description: Каковы новые возможности вычислений, удостоверения, управления, автоматизации, сетей, безопасности, хранения.
...
| Варианты установки  | Server Core и Server с возможностями рабочего стола  | Server Core для узла контейнеров, образа контейнера и образа контейнера Nano Server |
...
- Сетевые подключения контейнеров: добавлена поддержка Localhost и HTTP-прокси, а также улучшены масштабируемость и время запуска контейнера.
...
- Оптимизация пути к данным: улучшения виртуальной платформы фильтрации и сетевой службы узлов позволяют выполнять балансировку нагрузки на основе ядра.
