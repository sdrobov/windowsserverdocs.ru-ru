...
-   [Контейнеры Windows](https://msdn.microsoft.com/virtualization/windowscontainers/containers_welcome):  Поддержка контейнеров Windows Server 2016 обеспечивает повышение производительности, упрощенное управления сетями и поддержка контейнеров Windows в Windows 10. Некоторые дополнительные сведения о контейнерах см. в разделе [контейнеров: Docker, Windows и тенденции](https://azure.microsoft.com/blog/2015/08/17/containers-docker-windows-and-trends/).  
...
## <a name="identity-and-accessidentityidentity-and-accessmd"></a>[Идентификация и доступ](../identity/Identity-and-Access.md)  
...
Дополнительные сведения о тестировании возможностей DSC в Windows Management Framework 5 см. в серии записей блога [Проверка компонентов PowerShell DSC](https://blogs.msdn.microsoft.com/powershell/2015/07/06/validate-features-of-powershell-dsc/). Для скачивания см. раздел [Windows Management Framework 5.1](https://docs.microsoft.com/powershell/wmf/5.1/install-configure).
...
- Поддержка заголовков узлов подстановочный знак, что позволяет администраторам настроить веб-сервер для домена и затем выполнять запросы для любой поддомен веб-сервера.
- Новый модуль PowerShell (IISAdministration) для управления IIS. 

Дополнительные сведения см. в статье [IIS](https://iis.net/learn).

### <a name="distributed-transaction-coordinator-msdtc"></a>Координатор распределенных транзакций (DTC)
