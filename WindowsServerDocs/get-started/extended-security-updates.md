...
Для других сред, таких как локальные виртуальные машины или физические серверы, дополнительные обновления для системы безопасности необходимо запросить и настроить вручную. Если вы уже приобрели дополнительные обновления для системы безопасности, доступные в рамках программ корпоративного лицензирования, таких как Соглашение Enterprise (EA), подписка с Соглашением Enterprise (EAS), Enrollment for Education Solutions (EES) или Server and Cloud Enrollment (SCE), для получения ключа активации можно использовать один из следующих шагов:

* Войдите в [центр поддержки корпоративных лицензий Майкрософт](https://www.microsoft.com/Licensing/servicecenter/default.aspx), чтобы просмотреть и получить ключи активации.
* Зарегистрируйтесь для получения дополнительных обновлений для системы безопасности на портале Azure, чтобы получить ключи активации для Windows Server 2008/R2.
    * Инструкции по выполнению этого процесса см. в следующих шагах этой статьи.
...
> [!IMPORTANT]
>
> Предыдущие действия по приобретению дополнительных обновлений для системы безопасности необходимо выполнить в рамках программы корпоративного лицензирования. Перед выполнением описанных ниже действий отправьте сообщение электронной почты по адресу [winsvresuchamps@microsoft.com](mailto:winsvresuchamps@microsoft.com), указав следующую информацию для получения разрешения на использование этой функции:
>
> * имя заказчика;
> * подписка Azure;
...
>
> Команда изучит предоставленную информацию и добавит пользователя или подписку в утвержденный список.
>
> Если запросившая сторона не занесена в утвержденный список, может возникнуть следующая ошибка:
>
