...
ms.locfileid: "5425198"
---
# Ключ установки клиента KMS

>Область применения: Windows Server 2019, Windows Server Semi-Annual Channel, Windows Server 2016, Windows 10
...
>[!NOTE]
> В таблицах «LTSC» означает «Long-Term Servicing Channel,» во время «LTSB» относится к «Долгосрочного обслуживания ветвь.» 

**Чтобы использовать перечисленные здесь ключи (универсальные ключи многократной установки), в своей среде сначала нужно запустить узел KMS.** Если узел KMS еще не настроен, см. раздел [Развертывание активации KMS](https://technet.microsoft.com/library/dn502531(v=ws.11).aspx), где рассматривается процедура настройки.
...
| Устраните ошибку, возникающую при попытке активации системы Windows 8.1, Windows Server 2012 R2 или более новых систем: "Ошибка: 0xC004F050. Служба лицензирования программного обеспечения сообщила, что данный ключ продукта недопустим"… | [Установите это обновление](https://support.microsoft.com/en-us/help/3172614/july-2016-update-rollup-for-windows-8-1-and-windows-server-2012-r2) на узле KMS, если он работает под управлением Windows 8.1, Windows Server 2012 R2, Windows 8 или Windows Server 2012. |

-   [Получить Windows10](https://www.microsoft.com/en-us/windows/get-windows-10)
...
## Версии Windows Server Semi-Annual Channel
...
## Версии Windows Server LTSC или LTSB
...
## Windows 10 для всех поддерживаемых версий Semi-Annual Channel

См. в разделе [Windows жизненного цикла справочные материалы](https://support.microsoft.com/en-us/help/13853/windows-lifecycle-fact-sheet) сведения о поддерживаемых версий и конец службы даты.

| Версия операционной системы          | Ключ установки клиента KMS          |
|-----------------------------------|-------------------------------|
|Windows 10 Pro|W269N-WFGWX-YVC9B-4J6C9-T83GX|
|Windows 10 Pro N|MH37W-N47XK-V7XM9-C7227-GCQG9|
|Windows 10 Pro рабочих станций|NRG8B-VKK3Q-CXVCJ-9G2XF-6Q84J|
|Windows 10 Pro на рабочие станции N|9FNHH-K3HBT-3W4TD-6383H-6XYWF|
...
## Версии Windows 10 LTSC или LTSB

### Windows 10 LTSC 2019 г.

|Версия операционной системы|Ключ установки клиента KMS|
|-|-|
|Windows 10 Корпоративная LTSC 2019 г.|M7XTQ-FN8P6-TTKYV-9D4CC-J462D|
|Windows 10 Корпоративная N LTSC 2019 г.|92NFX-8DJQP-P6BBQ-THF9C-7CG2H|

### Windows 10 LTSB 2016

|Версия операционной системы|Ключ установки клиента KMS|
|-|-|
|Windows 10 Корпоративная 2016 с долгосрочным Обслуживанием|DCPHK-NFMTC-H88MJ-PFHPY-QJ4BJ|
...
| Версия операционной системы               | Ключ установки клиента KMS          |
|----------------------------------------|-------------------------------|
| Windows8.1 Профессиональная               | GCRJD-8NW9H-F2CDX-CCM8D-9D6T9 |
| Windows 8.1 Профессиональная N             | HMCNV-VVBFX-7HMBH-CTY9B-B4FXY |
| Windows8.1 Корпоративная                 | MHF9N-XY6XB-WVXMC-BTDCT-MKKG7 |
...
| Windows7 Профессиональная E                         | W82YF-2Q76Y-63HXB-FGJG9-GF7QX |
| Windows 7 Корпоративная                             | 33PXH-7Y6KF-2VJC9-XBBR8-HVTHH |
| Windows 7 Корпоративная N                           | YDRBP-3D83W-TY26F-D46B2-XCKRJ |
| Windows7 Корпоративная E                           | C29WB-22CC8-VJ326-GHFJW-H9DH4 |
