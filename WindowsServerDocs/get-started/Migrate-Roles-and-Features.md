...
Обновленные руководства по миграции для Windows Server 2016 находятся на стадии разработки. Вернитесь на эту страницу, чтобы получить обновления, когда они станут доступны. Во многих случаях инструкции в руководствах по миграции Windows Server 2012 R2 применимы к Windows Server 2016.
