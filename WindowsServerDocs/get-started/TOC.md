...
## [Знакомство с Windows Server, версия 1809](get-started-with-1803.md)
## [Новые возможности Windows Server](whats-new-in-windows-server.md)
...
#### [Новые возможности консоли Windows в WindowsServer2016](whats-new-in-console.md)
## [Обзор Semi-Annual Channel для Windows Server](semi-annual-channel-overview.md)
...
## Заметки о выпуске. Известные проблемы в Windows Server
### [Заметки о выпуске. Важные проблемы в Windows Server версии 1803](server-1803-release-notes.md)
### [Заметки о выпуске. Важные проблемы в Windows Server версии 1709](server-1709-relnotes.md)
...
## Удаленные или подлежащие замене компоненты в выпусках Windows Server
### [Удаленные или подлежащие замене компоненты в Windows Server версии 1803](windows-server-1803-removed-features.md)
### [Удаленные или подлежащие замене компоненты в Windows Server версии 1709](Removed-Features-1709.md)
### [Удаленные или не рекомендуемые к использованию компоненты в Windows Server2016](Deprecated-Features.md)
...
### [Ключ установки клиента KMS](KMSclientkeys.md)
### [Устранение неполадок коды ошибок активации](activation-error-codes.md)
...
### [Настройка основных серверных компонентов с помощью средства Sconfig.cmd](Sconfig-on-WS2016.md)
