...
Канал Semi-Annual Channel позволяет клиентам, быстро внедряющим инновации, начать использовать возможности новой операционной системы раньше. Это касается как приложений, особенно основанных на контейнерах и микрослужбах, так и программного гибридного центра обработки данных. Дополнительные сведения см. в разделе [Обзор канала Semi-Annual Channel для Windows Server](semi-annual-channel-overview.md). Также клиенты могут продолжить пользоваться выпусками в канале Long-Term Servicing Channel, которые будут выходить каждые 2-3 года. Каждый выпуск Long-Term Servicing Channel получает 5 лет основной поддержки и 5 лет дополнительной поддержки.
...
|Windows Server версии 1809 (Semi-Annual Channel) (Datacenter Core, Standard Core)|1809|17763.107.1010129-1455|13.11.2018|11.05.2020|Просмотреть заметку|
...
| Windows Server версии 1709 (Semi-Annual Channel)| 1709 | 16299.15|   17.10.2017|09.04.2019|Н/Д|
| Windows Server 2016 (Long-Term Servicing Channel)| 1607 | 14393.0 | 15 октября 2016 г. |11 января 2022 г.| 11.01.2027|

>[!NOTE]
> В отношении Windows Server версий 1803 и 1809 действует [современная политика жизненного цикла](https://support.microsoft.com/help/30881). Просмотрите разделы [Вопросы и ответы о жизненном цикле Windows](https://support.microsoft.com/help/18581/lifecycle-faq-windows-products) и [Обзор Semi-Annual Channel для Windows Server](semi-annual-channel-overview.md), чтобы получить дополнительные сведения о требованиях для обслуживания и другую важную информацию.
