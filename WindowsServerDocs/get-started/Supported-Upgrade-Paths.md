...
Вы можете перейти с ознакомительной версии Windows Server2016 Standard, Windows Server2016 Standard (розничная версия) либо Datacenter (розничная версия). Точно так же вы можете перейти с ознакомительной версии Windows Server2016 Datacenter на розничную.
...
Для **Windows Server 2016 Essentials**: Можно преобразовать ознакомительную версию в коммерческую, введя розничной торговли, корпоративного лицензирования или ключ для изготовителей Оборудования в команде **slmgr.vbs**.
...
Windows Server 2016 Standard вы можете преобразовать системы в Windows Server 2016 Datacenter следующим образом: В командной строке с повышенными привилегиями определите имя текущего выпуска с помощью команды **DISM /online /Get-CurrentEdition**. Для Windows Server 2016 Standard это будет `ServerStandard`. Выполните команду **DISM / online/Get-TargetEditions** для получения идентификатора можно выполнить обновление до выпуска. Запишите этот идентификатор выпуска, представляющий собой сокращенное имя выпуска. Затем запустите **DISM / online/Set-Edition:\<идентификатор выпуска\> /ProductKey-XXXXX-XXXXX-XXXXX-XXXXX/ACCEPTEULA**, указав идентификатор выпуска на целевом сервере и его розничный ключ продукта. Сервер дважды перезагрузится.
