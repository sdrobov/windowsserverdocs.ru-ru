...
<div class="container">
<h1>Документация по Windows Server</h1>
<h3>Windows Server является платформой для создания инфраструктуры подключенных приложений, сетей и веб-служб: от рабочей группы до центра обработки данных.</h3>
<p> </p>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h2>Начало работы с<br>Windows Server 2019</h2>
                                            <p>Начало работы с Windows Server 2019.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h2>Обновление до Windows Server 2019</h2>
                                            <p>Посетите центр обновления Windows Server, чтобы получить пошаговые инструкции по обновлению Windows Server.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            ...
                                            <p>Управление Windows Server 2012 и более поздними версиями с помощью Windows Admin Center.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h2>Гиперконвергентная инфраструктура</h2>
                                            <p>Объединение программно-определяемых вычислительных ресурсов, хранилища и сети в одном кластере.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h2>Начало работы с<br>Windows Server 2016</h2>
                                            <p>Начало работы с Windows Server 2016.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h2>Завершение обслуживания<br> Windows Server 2008 R2 и Windows Server 2008</h2>
                                            <p>Подготовка к завершению расширенной поддержки 14 января 2020 года.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h2>Удостоверения и доступ</h2>
                                            <p>Защитите ресурсы компании от хакеров и атак на удостоверения, управляя безопасностью доступа с помощью проверенного решения Active Directory.</p>
<table>
     <tr>
       ...
       <hr width="80%">
        ...
        <td style="vertical-align: top;">
            ...
            <ol>
            <li>1. <a href="https://docs.microsoft.com/windows-server/identity/securing-privileged-access/privileged-access-workstations">Рабочие станции c привилегированным доступом</a></li>
       <hr width="80%">
            <li>2. <a href="https://docs.microsoft.com/windows-server/identity/securing-privileged-access/securing-privileged-access-reference-material">Справочные материалы по обеспечению безопасности привилегированного доступа</a></li>
       <hr width="80%">
            <li>3. <a href="https://docs.microsoft.com/windows-server/identity/solution-guides/dynamic-access-control--scenario-overview">Динамический контроль доступа. Обзор сценария</a></li>
            </ol>
        </td>
    </tr>
</table></a>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h2>Отказоустойчивая кластеризация</h2> 
                                            <p>Объедините отдельные серверы в группы с отказоустойчивой кластеризацией, чтобы повысить отказоустойчивость и доступность систем, на которых размещены важные для бизнеса приложения и службы.</p>
<table>
     <tr>
        <td style="vertical-align: top;">
            <h4><u>Наивысшая оценка</u></h4>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h2>Management</h2>
                                            <p>Управляйте системами и средами Windows Server, собирайте сведения об инвентаре оборудования и программного обеспечения, настройте серверы для повышения производительности и автоматизируйте администрирование, чтобы повысить эффективность.</p>
<table>
     <tr>
        <td style="vertical-align: top;">
            <h4><u>Наивысшая оценка</u></h4>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h2>Сеть</h2>
                                            <p>Подключите компьютеры и системы, используя такие фундаментальные технологии, как <a href="https://docs.microsoft.com/windows-server/networking/dns/dns-top">DNS</a> и <a href="https://docs.microsoft.com/windows-server/networking/technologies/dhcp/dhcp-top">DHCP</a>, чтобы обеспечить безопасность, производительность, качество обслуживания и доступность, или виртуализируйте подключения с помощью <a href="https://docs.microsoft.com/windows-server/networking/sdn/software-defined-networking">программно-конфигурируемой сети</a>.</p>
<table>
     <tr>
        <td style="vertical-align: top;">
            <h4><u>Наивысшая оценка</u></h4>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h2>Пульт ДУ</h2>
                                            <p>Получайте доступ к компьютерам и устройствам и управляйте ими удаленно, чтобы обеспечить доступность корпоративных служб в любой точке мира и в любое время. Для этого используйте такие технологии, как службы удаленных рабочих столов, удаленный доступ и инструменты удаленного администрирования сервера.</p>
<table>
     <tr>
        <td style="vertical-align: top;">
            <h4><u>Наивысшая оценка</u></h4>
                                ...
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            ...
                                            <p>Защитите центры обработки данных под управлением Windows Server как виртуальную машину в любом облаке. Ограничьте возможности, позволяющие злоумышленникам компрометировать учетные данные, запускать вредоносные программы и оставаться незамеченными в вашей сети, с помощью таких технологий, как экранированные виртуальные машины, Device Guard, Credential Guard и Защитник Windows.</p>
<table>
     <tr>
        <td style="vertical-align: top;">
            <h4><u>Наивысшая оценка</u></h4>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h2>Хранилище</h2>
                                            <p>Воспользуйтесь преимуществами устойчивых, высокопроизводительных и экономичных хранилищ, обеспечивающих масштабирование до нескольких петабайт и использующих гиперконвергентную инфраструктуру для программно-определяемого хранилища, службы миграции хранилища и других технологий.</p>
<table>
     <tr>
        <td style="vertical-align: top;">
            <h4><u>Наивысшая оценка</u></h4>
                                ...
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            ...
                                            <p>Узнайте, как устранить неполадки некоторых из наиболее часто используемых технологий и функций Windows Server.</p>
<table>
     <tr>
        <td style="vertical-align: top;">
            <h4><u>Наивысшая оценка</u></h4>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h2>Виртуализация</h2>
                                             <p>Microsoft Hyper-V, платформа для виртуализации Windows Server, предоставляет виртуализацию вычислений для современной инфраструктуры приложений и облаков, включая контейнеры, последовательное обновление кластеров, экранированные виртуальные машины и другие улучшенные функции безопасности.</p>
<table>
     <tr>
        <td style="vertical-align: top;">
            <h4><u>Наивысшая оценка</u></h4>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Windows Server 2008 и<br> Windows Server 2008 R2</h3>
                                            <p></p>
                                            </div>
                                    </div>
                                </div>
