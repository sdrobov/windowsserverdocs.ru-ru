...
> Сообщение: Сбой запроса с кодом состояния HTTP 503: Служба недоступна.
> 
...
Помимо указанных выше, пытается получить доступ к URL-адресу сайта администрирования WSUS (т. е. `http://CM12CAS:8530`) с ошибкой:
