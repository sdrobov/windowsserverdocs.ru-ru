...
### <a name="synchronizing-device-updates-by-inventory-inventory-based-synchronization"></a>Синхронизация обновлений для устройства при инвентаризации (синхронизации на основе инвентаризации)
