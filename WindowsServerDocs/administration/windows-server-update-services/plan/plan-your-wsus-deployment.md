...
|[1.3. Выбор стратегии хранения данных WSUS](#13-choose-a-wsus-storage-strategy)|Выберите, какая из стратегий хранения данных для службы WSUS наиболее подходит для данного развертывания.|
|[1.4. Выберите языки обновления WSUS](#14-choose-wsus-update-languages)|Выберите те языки обновления для службы WSUS, которые будут установлены.|
|[1.5. Планирование групп компьютеров WSUS](#15-plan-wsus-computer-groups)|Спланируйте, какой подход относительно групп компьютеров службы WSUS вы будете использовать в ходе развертывания.|
|[1.6. WSUS рекомендации по планированию производительности: Фоновая интеллектуальная служба передачи](#16-plan-wsus-performance-considerations)|Разработайте модель службы WSUS, которая позволяла бы добиться оптимизированной производительности.|
|[1.7. Планирование параметров автоматического обновления](#17-plan-automatic-updates-settings)|Продумайте, как будете настраивать параметры автоматического обновления в своем сценарии.|
...
> [!NOTE]
> Внутреннюю базу данных Windows (WID) впервые появился в Windows Server 2008.
...
Существуют некоторые области, которые необходимо тщательно спланировать перед развертыванием служб WSUS, таким образом, вы можете оптимизировать производительность. Ключевые моменты
