...
> [!NOTE]
> Если политика "Настройка автоматического обновления" выключена или не настроена, то данная политика не оказывает воздействия.
...
Если вы не используете службу Центра обновления Майкрософт, параметр политики "Уведомления о наличии программ" не действует.
