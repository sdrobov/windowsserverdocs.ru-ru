---
title: Шаг 3 - утверждение и развертывание обновлений в WSUS
description: Раздел службы Windows Server Update Service (WSUS) - утверждение и развертывание обновлений в WSUS находится на третьем шаге в четыре этапа развертывания WSUS
...
ms.locfileid: "59841295"
---
# <a name="step-3-approve-and-deploy-updates-in-wsus"></a>Шаг 3. Утверждение и развертывание обновлений в WSUS
...
3.  В списке обновлений выберите обновления, которые вы хотите утвердить для установки в вашей тестовой группе компьютеров. Сведения о выбранном обновлении отображаются в нижней области панели **Обновления**. Чтобы выбрать несколько обновлений подряд, удерживайте нажатой **shift** ключа, щелкая мышью имена обновлений. Чтобы выбрать несколько непоследовательных обновлений, нажмите и удерживайте клавишу **CTRL**, щелкая мышью имена обновлений.
...
3.  В разделе **Правила обновления** нажмите кнопку **Создать правило**. **Добавить правило** откроется диалоговое окно.

4.  В **добавить правило**в **шаг 1: выберите свойства**, выберите любой параметр или сочетание параметров из следующего:

    -   **Когда обновление является затрагивает конкретный класс**

    -   **Когда обновление является затрагивает конкретный продукт**

    -   **Установить крайний срок для утверждения**

5.  В **шаг 2: изменение свойств**, щелкните каждый из перечисленных параметров и затем выберите соответствующие параметры для каждого.

6.  В **шаг 3: Укажите имя**, введите имя для правила и нажмите кнопку **ОК**.
