...
|[2,2. Настройка WSUS с помощью мастера настройки WSUS](#22-configure-wsus-by-using-the-wsus-configuration-wizard)|Мастер настройки WSUS служит для выполнения базовой настройки служб WSUS.|
...
4.  В окне командной строки перейдите в папку C:\Program Files\Update Services\Tools. Введите следующую команду:
    ...
    **WSUSutil конфигуресслпрокси [< proxy_server proxy_port >] — включить**, где:
...
-   [Шаг 4. Настройка параметров групповая политика для автоматическое обновление](4-configure-group-policy-settings-for-automatic-updates.md)
