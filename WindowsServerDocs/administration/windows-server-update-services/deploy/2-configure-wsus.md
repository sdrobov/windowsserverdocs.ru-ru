...
После установки на ваш сервер роли сервера служб WSUS необходимо должным образом произвести его настройку. Следующий контрольный список перечислены шаги, необходимые для выполнения начальной настройки сервера WSUS.
...
|[2.5. Безопасность WSUS с помощью протокола SSL](#25-secure-wsus-with-the-secure-sockets-layer-protocol)|Настройте протокол SSL для защиты служб Windows Server Update Services (WSUS).|
...
-   [2.3. Настройка групп компьютеров](#23-configure-wsus-computer-groups) в этом разделе
