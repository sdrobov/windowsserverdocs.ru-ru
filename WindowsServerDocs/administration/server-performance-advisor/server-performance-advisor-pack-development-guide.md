...
---- | ---- | ---- | ---- | ----
13:45:52.630 | Физический диск | Среднее время обращения к диску (сек.) | 0.00100008362473995 |0.00100008362473995
13:45:53.629 | Физический диск | Среднее время обращения к диску (сек.) | 0.00280023414927187 | 0.00280023414927187
13:45:54.627 | Физический диск | Среднее время обращения к диску (сек.) | 0.00385999853230048 | 0.00385999853230048
13:45:55.626 | Физический диск | Среднее время обращения к диску (сек.) | 0.000933297607934224 | 0.000933297607934224
...
---- | ---- | ---- | ----
Физический диск | _Всего | Среднее время обращения к диску (сек.) | 0.00100008362473995
Физический диск | 0 C: D: | Среднее время обращения к диску (сек.) | 0.00100008362473995
Физический диск | _Всего | Среднее время обращения к диску (сек.) | 0.00280023414927187
Физический диск | 0 C: D: | Среднее время обращения к диску (сек.) | 0.00280023414927187
Физический диск | _Всего | Среднее время обращения к диску (сек.) | 0.00385999853230048
Физический диск | 0 C: D: | Среднее время обращения к диску (сек.) | 0.00385999853230048
Физический диск | _Всего | Среднее время обращения к диску (сек.) | 0.000933297607934224
Физический диск | 0 C: D: | Среднее время обращения к диску (сек.) | 0.000933297607934224
...
Дисковое пространство | Свободный размер диска (ГБ) | Общий размер (ГБ)
---- | ---- | ----
0 | 100 | 500
1 | 20 | 320
...
ИДЕНТИФИКАТОР | Имя | Тип | Скорость (Мбит/с) | MAC-адрес;
--- | --- | --- | --- | ---
 | <br> | | |
 | | | |
...
в предыдущем примере системные администраторы могут заинтересовать только ключи, в которых значение InstanceName \_Total или CPU1. Фильтр можно определить следующим образом:
...
--- | --- | ---
guid | GUID | GUID поставщика
пиринга BGP | string | Имя сеанса ETW (необязательно, требуется только для событий ядра)
кэйвордсани | Шестнадцатеричная | Любые ключевые слова (необязательно, без префикса 0x)
кэйвордсалл | Шестнадцатеричная | Все ключевые слова (необязательно)
подключения | Шестнадцатеричная | Свойства (необязательно)
level | Шестнадцатеричная | Level (необязательно)
bufferSize | Целочисленный | Размер буфера (необязательно)
флуштиме | Целочисленный | Время записи на диск (необязательно)
максбуффер | Целочисленный | Максимальный буфер (необязательно)
минбуффер | Целочисленный | Минимальный буфер (необязательно)
