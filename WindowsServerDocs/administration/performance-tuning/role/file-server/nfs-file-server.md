...
Следующие параметры реестра REG @ no__t-0DWORD могут повлиять на производительность файловых серверов NFS:
...
-   **оптималреадс**
    ...
    Значение по умолчанию — 0. Этот параметр определяет, открываются ли файлы для FILE @ no__t-0RANDOM @ no__t-1ACCESS или for FILE @ no__t-2SEQUENTIAL @ no__t-3ONLY в зависимости от характеристик операций ввода-вывода рабочей нагрузки. Задайте для этого параметра значение 1, чтобы принудительно открывать файлы для FILE @ no__t-0RANDOM @ no__t-1ACCESS. FILE @ no__t-0RANDOM @ no__t-1ACCESS предотвращает предварительную выборку файловой системы и диспетчера кэша.
...
-   **филехандлекачесизеинмб**
    ...
    Значение по умолчанию — 4. Этот параметр задает максимальный объем памяти, который будет использоваться записями кэша обработки файлов. Минимальное значение равно 1, а максимальное — 1 @ no__t-01024 @ no__t-11024 @ no__t-21024 (1073741824).
