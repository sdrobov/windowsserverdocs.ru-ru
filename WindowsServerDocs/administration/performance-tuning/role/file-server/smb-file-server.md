...
Дополнительные сведения о счетчиках клиента SMB см. в разделе [Совет файлового сервера Windows Server 2012: новые счетчики производительности для каждого общего ресурса SMB обеспечивают превосходную аналитику](http://blogs.technet.com/b/josebda/archive/2012/11/19/windows-server-2012-file-server-tip-new-per-share-smb-client-performance-counters-provide-great-insight.aspx).
