...
Следующие параметры можно оптимизировать производительность во многих случаях на компьютере. Параметры не оптимальным или соответствующие на всех компьютерах. Следует оценить влияние отдельных параметров перед их применением.
