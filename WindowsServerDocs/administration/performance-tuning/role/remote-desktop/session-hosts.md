...
Сжатие протокол удаленного рабочего стола можно настроить с помощью групповая политика в разделе **Конфигурация компьютера** &gt; **Административные шаблоны** &gt; **компоненты Windows** &gt; **службы удаленных рабочих столов** &gt;, удаленный рабочий стол **Узел сеансов** &gt; **среду удаленного сеанса** &gt; **настроить сжатие для данных RemoteFX**. Возможны три значения:
...
Перенаправление устройств можно настроить с помощью групповая политика в разделе **Конфигурация компьютера** &gt; **Административные шаблоны** &gt; **компонентов Windows** &gt; службы удаленных рабочих столов **&gt; удаленный рабочий стол** **Узел сеансов** &gt; **перенаправления устройств и ресурсов** либо с помощью поля свойства **коллекции сеансов** в Диспетчер сервера.
