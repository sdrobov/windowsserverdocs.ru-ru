...
-   [Настройка приложений для узла сеансов удаленных рабочих столов](#tuning-applications-for-remote-desktop-session-host)

-   [Настройка параметров узла сеансов удаленных рабочих столов](#remote-desktop-session-host-tuning-parameters)
...
## <a name="tuning-applications-for-remote-desktop-session-host"></a>Настройка приложений для узла сеансов удаленных рабочих столов
...
## <a name="remote-desktop-session-host-tuning-parameters"></a>Настройка параметров узла сеансов удаленных рабочих столов
