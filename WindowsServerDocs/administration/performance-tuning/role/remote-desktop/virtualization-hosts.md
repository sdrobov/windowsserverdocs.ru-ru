...
## <a name="general-considerations"></a>Общие соображения
...
Тома также должен быть настроен на использование типа оптимизации дедупликации «Virtual Desktop Infrastructure (VDI)». Это можно настроить с помощью диспетчера серверов (**файловых служб и служб хранилища**  - &gt; **тома**  - &gt; **параметры дедупликации**) или с помощью Windows PowerShell следующие команды:
...
> [!NOTE]
> Оптимизация дедупликации данных для открытых файлов поддерживается только для сценариев VDI с Hyper-V с использованием удаленного хранилища через SMB 3.0.
