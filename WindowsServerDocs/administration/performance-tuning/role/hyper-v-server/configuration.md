...
- **Логический процессор гипервизора Hyper-V (\*) \\% времени выполнения гипервизора** Время, затраченное на выполнение в низкоуровневой оболочке
