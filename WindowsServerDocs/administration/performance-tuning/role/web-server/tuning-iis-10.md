...
|&lt;Files, &gt; элемент|Указывает имена файлов, которые настроены в качестве документов по умолчанию.|Список по умолчанию — Default.htm, Default. ASP, Index.htm, Index.html, Iisstart.htm и Default. aspx.|
...
|Атрибут|Описание|Значение по умолчанию|
|--- |--- |--- |
|Включено|Указывает, включено ли централизованное ведение журнала в двоичном формате.|False|
...
||URL-адрес запроса|Время запроса|Разностная версия|
|--- |--- |--- |--- |
