...
|ОЗУ|Размер базы данных<br />Рекомендации по основным операционным системам<br />Приложения сторонних производителей|
|Network|1 ТБ|
...
## <a name="virtualization-considerations"></a>Вопросы виртуализации
...
RAID 1 + 0, ведет себя точно так же, как и RAID 1, в отношении расходов на чтение и запись. Однако теперь операции ввода-вывода распределяются по каждому зеркальному набору. Если  
