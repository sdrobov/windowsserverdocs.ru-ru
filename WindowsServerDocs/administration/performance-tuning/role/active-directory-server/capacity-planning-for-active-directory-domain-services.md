...
- В **существующих &ndash; средах** в разделе "Включение ведения журнала дискового пространства, освобожденного путем дефрагментации" раздела " [ограничения хранилища](https://docs.microsoft.com/en-us/previous-versions/windows/it-pro/windows-2000-server/cc961769(v=technet.10))статей".
...
> *Чтение* ввода- &times; вывода *+ 4* = операций ввода-вывода  
