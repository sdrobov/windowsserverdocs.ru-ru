...
| **Название** | **Поведение на основе P-состояния** | **Поведение КППК** |
|--------------------------|------------------------|-------------------|
| 0 (отключено) | Отключено. | Отключено. |
| 1 (включено) | Активировать | Эффективность включена |
| 2 (агрессивно) | Активировать | Aggressive |
| 3 (эффективность включена) | Эффективность | Эффективность включена |
| 4 (эффективный агрессивный) | Эффективность | Aggressive |
