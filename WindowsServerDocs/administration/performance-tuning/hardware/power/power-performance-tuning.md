...
Один из способов определить, поддерживает ли ваш сервер отслеживание и бюджетирование, — просматривать [каталог Windows Server](http://www.windowsservercatalog.com). Если модель сервера соответствует новой расширенной квалификации по управлению питанием в программе сертификации оборудования Windows, то гарантируется поддержка функций измерения и бюджетирования.
...
| **Name** | **Поведение на основе P-состояния** | **Поведение КППК** |
|--------------------------|------------------------|-------------------|
| 0 (отключено) | Отключено | Отключено |
| 1 (включено) | Enabled | Эффективность включена |
| 2 (агрессивно) | Enabled | Активная |
| 3 (эффективность включена) | Эффективность | Эффективность включена |
| 4 (эффективный агрессивный) | Эффективность | Активная |
...
Если сервер имеет определенные основные требования к стоянке, можно управлять количеством ядер, доступных для приостановки, с помощью параметра максимального количества ядер **ядра производительности процессора** или **минимального числа ядер ядра производительности процессора.** в Windows Server 2016.
