...
Рабочие нагрузки выбраны для охвата усилия набор «типичный? Рабочие нагрузки Windows Server. Очевидно, что этот набор не является представлять весь спектр реальных серверных средах.
...
Все проверенные тесты используют пропускную способность как метрики производительности. Время ответа считается как требование соглашение об уровне ОБСЛУЖИВАНИЯ для этих рабочих нагрузок (за исключением SAP, где он представляет собой основной показатель). Например выполнения теста производительности допустимый «? Если среднее или максимальное время отклика меньше определенного значения.
...
-   **Политики увеличение производительности процессора** — «один? политики замедляет ответ perf Повышенная и продолжительного действия; «Rocket? политики быстро реагирует на увеличение числа операций

-   **Политики снижение производительности процессора** — «один? политики более постепенно снижается производительность периодов больше простоя; «Rocket? политика удаляет power очень быстро при вводе периода простоя
