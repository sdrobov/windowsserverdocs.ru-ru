---
title: bitsadmin
description: Справочный раздел о команде битсадмин, которая представляет собой средство командной строки, используемое для создания, загрузки и передачи заданий, а также отслеживания хода выполнения.
