...
|    Параметр    |                                                                                                                                                                                                                                                                                          Описание                                                                                                                                                                                                                                                                                           |
|-----------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|   @no__t 0KeyName1 >   |                                                               Задает полный путь к первому подразделу для сравнения. Чтобы указать удаленный компьютер, укажите имя компьютера (в формате \\ @ no__t-1ComputerName @ no__t-2 в составе *keyName*. Пропуск \\ @ no__t-1ComputerName \ приводит к тому, что по умолчанию операция выполняется на локальном компьютере. *KeyName* должен содержать допустимый корневой ключ. Допустимые корневые ключи для локального компьютера: HKLM, HKCU, HKCR, HKU и ХККК. Если указан удаленный компьютер, допустимые корневые ключи: HKLM и HKU.                                                                |
|   @no__t 0KeyName2 >   | Задает полный путь к второму подразделу для сравнения. Чтобы указать удаленный компьютер, укажите имя компьютера (в формате \\ @ no__t-1ComputerName @ no__t-2 в составе *keyName*. Пропуск \\ @ no__t-1ComputerName \ приводит к тому, что по умолчанию операция выполняется на локальном компьютере. Указание только имени компьютера в *KeyName2* приводит к тому, что операция использует путь к подразделу, указанному в *KeyName1*. *KeyName* должен содержать допустимый корневой ключ. Допустимые корневые ключи для локального компьютера: HKLM, HKCU, HKCR, HKU и ХККК. Если указан удаленный компьютер, допустимые корневые ключи: HKLM и HKU. |
| /v @no__t — 0ValueName > |                                                                                                                                                                                                                                                                     Указывает имя значения для сравнения в подразделе.                                                                                                                                                                                                                                                                      |
