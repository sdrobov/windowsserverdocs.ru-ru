...
|Параметр|Описание|
|---------|-----------|
|@no__t 0FileType >|Указывает тип файла для просмотра или изменения.|
|@no__t 0OpenCommandString >|Указывает командную строку открытия, используемую при открытии файлов указанного типа.|
...
|%~ @ NO__T-1N >|Возвращает все оставшиеся параметры, начиная с *n*-го параметра, где *N* может быть любым числом от 2 до 9.|
