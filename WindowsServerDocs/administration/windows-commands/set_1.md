...
|Параметр|Описание|
|---------|-----------|
|@no__t 0Variable >|Задает переменную среды, которую необходимо задать или изменить.|
|@no__t 0String >|Указывает строку, связываемую с указанной переменной среды.|
|/p|Устанавливает значение *переменной* в строку входных данных, введенную пользователем.|
|@no__t 0PromptString >|Необязательно. Указывает сообщение, предлагающее пользователю ввести данные. Этот параметр используется с параметром командной строки **/p** .|
|/|Задает *строковое* значение числового выражения, которое вычисляется.|
|@no__t 0Expression >|Задает числовое выражение. Допустимые операторы, которые можно использовать в *выражении*, см. в разделе Примечания.|
...
- Использование специальных символов
  ...
  Символы **<** , **>** , **|** , **&** , **^** — это специальные символы командной оболочки, которым должны предшествовать escape-символы ( **@no__t – 11**) или заключены в кавычки. При использовании в *строке* (например, **"стрингконтаининг & Symbol"** ). При использовании кавычек для заключения строки, содержащей один из специальных символов, кавычки задаются как часть значения переменной среды.
