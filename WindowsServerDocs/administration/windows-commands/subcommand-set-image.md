...
description: Справочный раздел по подкоманде Set-Image, который изменяет атрибуты изображения.
...
-образ" с помощью команды[Replace](using-the-replace-image-command.md) -Image.
