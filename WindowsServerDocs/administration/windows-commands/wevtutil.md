...
|{обмена мгновенными сообщениями \| install-manifest} \<манифест >|Устанавливает издателей событий и журналов из манифеста. Дополнительные сведения о манифестах событий и с помощью этого параметра см. в разделе журнала событий Windows SDK на веб-узле Microsoft Developer Network (MSDN) ([https://msdn.microsoft.com](https://msdn.microsoft.com)).|
|{единой системы обмена сообщениями \| удалить манифест} \<манифест >|Удаление всех издателей и журналы из манифеста. Дополнительные сведения о манифестах событий и с помощью этого параметра см. в разделе журнала событий Windows SDK на веб-узле Microsoft Developer Network (MSDN) ([https://msdn.microsoft.com](https://msdn.microsoft.com)).|
...
|/CA:\<канала >|Задает разрешение на доступ для журнала событий. \<Канал > задает дескриптор безопасности, который использует язык определения дескрипторов безопасности (SDDL). Дополнительные сведения о формате SDDL см. в разделе веб-узла Microsoft Developer Network (MSDN) ([https://msdn.microsoft.com](https://msdn.microsoft.com)).|
