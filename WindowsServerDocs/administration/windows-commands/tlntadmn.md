---
title: tlntadmn
description: Раздел команд Windows для tlntadmn, который управляет локальным или удаленным компьютером, на котором запущена служба Telnet-сервера.
...
|                     начало                      |                                                                                                                                            запускает службу Telnet Server.                                                                                                                                             |
