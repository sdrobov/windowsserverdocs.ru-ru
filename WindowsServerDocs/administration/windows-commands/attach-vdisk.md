...
| SD =<SDDL string> | Задает фильтр пользователей на виртуальном жестком диске. Строка фильтра должна быть в формате языка определения дескрипторов безопасности (SDDL). По умолчанию фильтр пользователя разрешает доступ как к физическому диску.<br /><br />Строки SDDL могут быть сложными, но в простейшей форме дескриптор безопасности, защищающий доступ, называется списком управления доступом на уровне пользователей (DACL). Он имеет вид: D: < dacl_flags > < string_ace1 > < string_ace2 >... < string_acen ><br /><br />Общие флаги DACL:<br /><br />-   **разрешение** доступа<br />-   **D** Deny Access<br /><br />Общие права:<br /><br />-   **полный** доступ<br />-   **GR** доступ для чтения<br />доступ на запись -   **GW**<br /><br />Общие учетные записи пользователей:<br /><br />-   **Ба** Встроенные администраторы<br />Пользователи с проверкой подлинности -   **Au**<br />владелец **-   соавторам**<br />-   **WD** -Everyone<br /><br />Примеры<br /><br />**д:п: (A;; GR;;; AU** предоставляет доступ для чтения всем прошедшим проверку пользователям.<br /><br />**д:п: (A;; Общедоступный;;; WD** предоставляет всем пользователям полный доступ |
