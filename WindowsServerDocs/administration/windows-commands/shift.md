...
|Параметр|Описание|
|---------|-----------|
|/n @no__t — 0N >|Задает начало сдвига с помощью *n*-го аргумента, где *n* — любое значение от 0 до 8. Требуются расширения команд, которые включены по умолчанию.|
...
- Команда **SHIFT** не влияет на параметр Batch **% @ no__t-3***.
