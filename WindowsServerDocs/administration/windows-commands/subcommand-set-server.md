...
description: Раздел команд Windows для подкоманд set-Server, который настроил параметры для сервера служб развертывания Windows.
...
подкоманды [: Start](subcommand-start-server.md) -сервера
[параметром Uninitialize-Server](the-uninitialize-server-option.md) [.](subcommand-stop-server.md)
