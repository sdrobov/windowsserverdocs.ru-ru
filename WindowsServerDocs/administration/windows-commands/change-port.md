---
title: change port
description: Справочный раздел по команде изменения порта, который перечисляет или изменяет сопоставления COM-портов для совместимости с приложениями MS-DOS.
