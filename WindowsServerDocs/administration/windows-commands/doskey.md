...
- Создание макроса
  ...
  |      $\*      | Представляет все сведения командной строки, которые необходимо указать при вводе имени макроса. ** $ ** Специальный символ \* — это заменяемый параметр, аналогичный пакетным параметрам с **$1** по **$9**, с одним важным отличием: все, что вводится в командной строке после замены ** $ ** имени макроса \* в макросе. |
