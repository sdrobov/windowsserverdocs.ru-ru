---
title: doskey
description: Справочный раздел по команде Doskey и Doskey. exe, который вызывает ранее указанные команды командной строки, редактирует командные строки и создает макросы.
...
- Doskey. exe можно использовать для редактирования текущей командной строки, но нельзя использовать параметры командной строки в командной строке программы. Перед запуском программы необходимо запустить параметры командной строки **Doskey** . Если программа Doskey. exe используется в программе, ее сочетания клавиш имеют приоритет и некоторые ключи редактирования doskey. exe могут не работать.
...
- Чтобы отозвать команду, можно использовать любой из следующих разделов после запуска программы Doskey. exe:
