...
|/l|Список всех допустимых идентификаторов часовых поясов и отображаемых имен. Выходные данные будут:<br /><br />-   \<отображаемое имя ><br />-   идентификатор часового пояса \<>|
