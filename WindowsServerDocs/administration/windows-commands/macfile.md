...
|   TargetFile<Filepath>   | Обязательный. Указывает расположение файла, который создается путем присоединения к компоненту данных и вилке ресурса, или указывает расположение файла, тип или автор которого изменяется. Файл должен находиться на указанном сервере. |
|             /?             |                                                                                               Отображение справки в командной строке.                                                                                               |
