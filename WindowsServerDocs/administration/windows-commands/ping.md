...
|число \</n\>|Указывает число отправленных сообщений с эхо-запросом. Значение по умолчанию — 4.|
...
|/w \<время ожидания\>|Указывает время (в миллисекундах) ожидания получения сообщения о эхо-ответе, соответствующего заданному сообщению запроса эха. Если ответное сообщение не получено в течение времени ожидания, отображается сообщение об ошибке "запрос был превышен). Время ожидания по умолчанию — 4000 (4 секунды).|
...
Отображение выходных данных команды **ping** :
