...
|Параметр|Описание|
|---------|-----------|
|[@no__t 0Drive1 >:] [\<Path1 >] @no__t 2FileName >|Указывает расположение и имя исходного файла или набора файлов. *Имя файла* является обязательным и может содержать подстановочные знаки **&#42;** (и **?** ).|
|[@no__t 0Drive2 >:] [\<Path2 >]|Указывает расположение целевого файла. Нельзя указать имя файла для заменяемых файлов. Если диск или путь не указаны, **Replace** использует текущий диск и каталог в качестве места назначения.|
