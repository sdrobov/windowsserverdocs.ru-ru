...
|DAILY (ежедневная)|1 - 365|Задача выполняется каждые \<N > дней.|
|Запуск|1 - 52|Задача выполняется каждые \<N > недель.|
|После|Без модификаторов.|Задача выполняется один раз.|
|ONSTART|Без модификаторов.|Задача выполняется при запуске.|
|Вход в систему|Без модификаторов.|Задача выполняется, когда пользователь, заданный параметром **/u** , входит в систему.|
|ОБРАБОТЧИК|Без модификаторов.|Задача выполняется после бездействия системы в течение числа минут, заданного параметром **/i** , который необходим для использования с OnIdle.|
...
|    ЕЖЕМЕСЯЧНО    |          Нет или {1-12}          |          1 - 31          | Необязательный параметр и допустимый только без модификатора ( **/mo**) (конкретный график даты) или, если параметру **/mo** присвоено значение 1-12 (каждое расписание \<N > месяцев). Значение по умолчанию — день 1 (первый день месяца). |
...
Пример см. в следующих статьях:
-   Чтобы запланировать выполнение задачи, выполняемой каждые 3 часа, в течение 10 часов в разделе, **чтобы запланировать выполнение задачи каждые** \<N > **ч** .
...
|         Термин          |                                                                                                                                                                 Определение                                                                                                                                                                  |
|-----------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|    /TN \<"имя_задания" >    |                                                                                                                                                       Обязательное. Определяет задачу.                                                                                                                                                        |
|    /s \<> компьютера     |                                                                                                           Указывает имя или IP-адрес удаленного компьютера (с обратными косыми чертами или без них). По умолчанию используется локальный компьютер.                                                                                                           |
...
|         Термин          |                                                                                                                                                               Определение                                                                                                                                                                |
|-----------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|    /TN \<"имя_задания" >    |                                                                                                                                         Обязательное. Определяет задачу, которая запустила программу.                                                                                                                                         |
