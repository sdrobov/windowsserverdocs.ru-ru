...
|               <VolumePath>                |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       Указывает имя диска, за которым следует двоеточие или GUID в формате **тома {** <em>GUID</em> **}** .                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
...
|              /l [<log file>]              |                                                                                                                                                                                                                                                                                                                                                                                                                                                                  Указывает файл журнала, куда будут записываться сведения.<br /><br />Если **/l** параметр не указан, все данные записываются в файл журнала по умолчанию:<br /><br />**% temp%\8dot3_removal_log@ (** <em>GMT гггг-мм-дд чч-мм сс</em> **) .log**                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
