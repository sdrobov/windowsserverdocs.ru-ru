...
|Параметр|Описание|
|---------|-----------|
|@no__t 0RealmName >|Имя области указывается как DNS-имя в верхнем регистре, например CORP. CONTOSO.COM, и он указывается в качестве области по умолчанию при запуске **ksetup** . Это область, из которой вы пытаетесь удалить другой KDC.|
|@no__t 0KDCName >|Имя KDC указывается в виде полного доменного имени без учета регистра, например mitkdc.contoso.com.|
