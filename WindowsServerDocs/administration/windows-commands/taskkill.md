---
title: taskkill
description: Раздел команд Windows для Taskkill, который завершает одну или несколько задач или процессов.
...
|     /PID \<идентификатор процесса >     |                                                                                                                 Указывает идентификатор процесса для завершения процесса.                                                                                                                 |
...
|-------------|------------------------|----------------------------------------------------------------------------------------------------------------------------------------------|
|   STATUS    |         eq, ne         |                                                 ЗАПУСК &#124; не отвечает &#124; — неизвестно                                                 |
...
|  ИМЯ ПОЛЬЗОВАТЕЛЯ   |         eq, ne         |                                               Любое допустимое*имя пользователя (* \\пользователя или *User* *домена* )                                               |
