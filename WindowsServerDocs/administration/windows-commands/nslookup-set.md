---
title: nslookup set
description: Справочный раздел по команде nslookup set, который изменяет параметры конфигурации, влияющие на поведение уточняющих запросов.
