...
Следующая команда создает сборщик данных конфигурации с именем cfg_log, используя раздел реестра HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows Нт\куррентверион @ no__t-0.  
```  
