---
title: sfc
description: Справочный раздел для SFC, который сканирует и проверяет целостность всех защищенных системных файлов и заменяет неверные версии на правильные версии.
...
|\<> файлов|Указанный полный путь и имя файла|
