...
-u &lt;пользователя&gt; указывает имя пользователя, учетные данные которого будут использоваться. Возможно, необходимо добавить имя домена имя пользователя в форме <em>домена</em> **\\** <em>имя пользователя</em>.
