---
title: auditpol Set
description: Справочный раздел по команде auditpol Set, задающий политику аудита для каждого пользователя, политику аудита системы или параметры аудита.
