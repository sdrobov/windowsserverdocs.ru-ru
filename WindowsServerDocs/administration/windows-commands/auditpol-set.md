---
title: auditpol Set
description: Раздел команд Windows для **auditpol Set**, который задает политику аудита для каждого пользователя, политику аудита системы или параметры аудита.
