...
description: Справочный раздел по команде ksetup аддреалмфлагс, который добавляет дополнительные флаги сферы в указанную область.
...
ms.locfileid: "83818034"
---
# <a name="ksetup-addrealmflags"></a>ksetup аддреалмфлагс
