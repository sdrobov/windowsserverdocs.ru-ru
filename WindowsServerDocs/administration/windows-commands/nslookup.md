...
|                       Параметр                       |                                                                                                         Описание                                                                                                         |
|-------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|   [nslookup exit Command](nslookup-exit-command.md)   |                                                                                                     завершает работу **nslookup**.                                                                                                     |
| [nslookup finger Command](nslookup-finger-command.md) |                                                                                  Подключается к серверу finger на текущем компьютере.                                                                                   |
|           [nslookup help](nslookup-help.md)           |                                                                                    Отображает краткое описание **nslookup** подкоманды.                                                                                    |
...
|           [nslookup root](nslookup-root.md)           |                                                                     Изменение сервера по умолчанию на сервер для корня пространства имен доменов DNS.                                                                     |
|         [nslookup server](nslookup-server.md)         |                                                                                   Изменение сервера по умолчанию для указанного домена DNS.                                                                                   |
|            [nslookup set](nslookup-set.md)            |                                                                              Изменяет параметры конфигурации, которые влияют на том, как функция уточняющих запросов.                                                                               |
|        [nslookup set all](nslookup-set-all.md)        |                                                                                  Выводит текущие значения параметров конфигурации.                                                                                   |
|      [nslookup set class](nslookup-set-class.md)      |                                                                     изменяет класс запроса. Класс определяет группу протоколов информации.                                                                     |
...
|      [nslookup set debug](nslookup-set-debug.md)      |                                                                                               Включает режим отладки, включить или отключить.                                                                                               |
...
|     [nslookup set domain](nslookup-set-domain.md)     |                                                                                 Изменяет имя домена DNS по умолчанию к имени, указанному.                                                                                  |
|                 игнорировать/Set nslookup                  |                                                                                              Игнорирует ошибки усечения пакетов.                                                                                              |
|       [nslookup set port](nslookup-set-port.md)       |                                                                          Изменение порта сервера имен DNS TCP/UDP на указанное значение.                                                                           |
|  [nslookup set querytype](nslookup-set-querytype.md)  |                                                                                       Изменяет тип записи ресурса для запроса.                                                                                       |
|    [nslookup set recurse](nslookup-set-recurse.md)    |                                                                    Указывает, что сервер имя DNS для запроса других серверов, если он не содержит данные.                                                                    |
...
|     [nslookup set search](nslookup-set-search.md)     | Добавляет к запросу доменных имен DNS в список поиска DNS домена, пока не будет получен ответ. Это применимо, когда набор и поиска запросов, содержать по крайней мере одну точку, но не заканчиваться точку. |
|   [nslookup set srchlist](nslookup-set-srchlist.md)   |                                                                                    изменяет список по умолчанию DNS домена и имя.                                                                                     |
|    [nslookup set timeout](nslookup-set-timeout.md)    |                                                                           Изменяет начальное количество секунд ожидания ответа на запрос.                                                                           |
...
|           [nslookup view](nslookup-view.md)           |                                                                          Сортирует и вывод предыдущего **ls** подкоманд и команд.                                                                          |
