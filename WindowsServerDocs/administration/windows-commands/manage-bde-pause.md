...
ms.locfileid: "59821645"
---
# <a name="manage-bde-pause"></a>готов: Приостановка



Приостановка BitLocker шифрования или расшифровки. Примеры использования этой команды см. в разделе [примеры](#BKMK_Examples).
...
В следующем примере демонстрируется использование **-приостановить** команда приостановки шифрование BitLocker на диске C.
```
manage-bde –pause C:
```
