...
|Параметр|Описание|
|---------|-----------|
|\<HH > [: \<MM > [: \<SS > [. \<NN >]]] [AM @ no__t-16:00]|Устанавливает системное время на новое указанное время, где *чч* — в часах (обязательно), *mm* — в минутах, а *SS* — в секундах. *Nn* может использоваться для указания сотых долей секунды. Если параметр **AM** или **PM** не указан, по умолчанию используется 24 **-часовой формат** .|
