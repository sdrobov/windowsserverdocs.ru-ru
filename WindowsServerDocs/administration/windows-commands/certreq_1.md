...
|Измените значение переключателя|Описание|
|------|-----------|
...
-   Если используется -config - вместо -config ИмяКомпьютераЦС\ИмяЦС, операция обрабатывается с использованием ЦС по умолчанию.
...
|Раздел|Определение|Применение|Пример|
|---|----------|-----|-------|
...
|  OID расширения   | Определение | Применение |                                                                                                                                                                                                                                                                                                                                                                                                                      Пример                                                                                                                                                                                                                                                                                                                                                                                                                       |
|------------------|------------|-------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|    2.5.29.17     |            |       |                                                                                                                                                                                                                                                                                                                                                                                                                2.5.29.17 = "{Text}"                                                                                                                                                                                                                                                                                                                                                                                                                |
|    *continue*    |            |       |                                                                                                                                                                                                                                                                                                                                                                                                        *Continue* = "UPN =User@Domain.com&"                                                                                                                                                                                                                                                                                                                                                                                                         |
|    *continue*    |            |       |                                                                                                                                                                                                                                                                                                                                                                                                       *Continue* = "e-mail =User@Domain.com&"                                                                                                                                                                                                                                                                                                                                                                                                        |
|    *continue*    |            |       |                                                                                                                                                                                                                                                                                                                                                                                                        *Continue* = "DNS = узел. домен. com &"                                                                                                                                                                                                                                                                                                                                                                                                         |
|    *continue*    |            |       |                                                                                                                                                                                                                                                                                                                                                                                               *Continue* = "ДИРЕКТОРИНАМЕ = CN = имя, DC = домен, DC = com &"                                                                                                                                                                                                                                                                                                                                                                                               |
|    *continue*    |            |       |                                                                                                                                                                                                                                                                                                                                                                                             *Continue* = "URL =<http://host.domain.com/default.html&>"                                                                                                                                                                                                                                                                                                                                                                                              |
|    *continue*    |            |       |                                                                                                                                                                                                                                                                                                                                                                                                         *Continue* = "IPAddress = 10.0.0.1 &"                                                                                                                                                                                                                                                                                                                                                                                                         |
|    *continue*    |            |       |                                                                                                                                                                                                                                                                                                                                                                                                       *Continue* = "регистередид = 1.2.3.4.5 &"                                                                                                                                                                                                                                                                                                                                                                                                       |
|    *continue*    |            |       |                                                                                                                                                                                                                                                                                                                                                                                                      *Continue* = "1.2.3.4.6.1 = {Utf8} строка &"                                                                                                                                                                                                                                                                                                                                                                                                      |
|    *continue*    |            |       |                                                                                                                                                                                                                                                                                                                                                                                                  *Continue* = "1.2.3.4.6.2 = {октет} ааекавкфбгк = &"                                                                                                                                                                                                                                                                                                                                                                                                   |
|    *continue*    |            |       |                                                                                                                                                                                                                                                                                                                                                                                          *Continue* = "1.2.3.4.6.2 = {октет} {Hex} 00 01 02 03 04 05 06 07 &"                                                                                                                                                                                                                                                                                                                                                                                           |
|    *continue*    |            |       |                                                                                                                                                                                                                                                                                                                                                                                                 *Continue* = "1.2.3.4.6.3 = {ASN} багаакидбаугбв = = &"                                                                                                                                                                                                                                                                                                                                                                                                  |
...
|     Критические     |            |       |                                                                                                                                                                                                                                                                                                                                                                                                                 Критическая = 2.5.29.19                                                                                                                                                                                                                                                                                                                                                                                                                 |
