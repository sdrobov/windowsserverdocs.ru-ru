...
|           /i            |                                                            Сравнение не учитывает регистр строк.  Можно использовать **/i** на <em>String1</em> **==** <em>String2</em> форме **Если**. Эти сравнения являются универсальными, тем, что если оба *String1* и *String2* состоят из цифр, строки преобразуются в числа, и выполняется числового сравнения.                                                            |
