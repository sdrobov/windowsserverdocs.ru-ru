---
title: defrag
description: Справочный раздел, посвященный дефрагментации, который находит и объединяет фрагментированные файлы на локальных томах для повышения производительности системы.
...
|Объект|Выполните анализ указанных томов.|
...
## <a name="additional-references"></a><a name=BKMK_additionalRef></a>Дополнительная справка
-   [chkdsk](chkdsk.md)
-   [fsutil](fsutil.md)
