...
|ТЬ|Печать хода выполнения операции на экране.|
...
- Отчеты можно отправить в текстовый файл, введя **>** <em>имя_файла. txt</em>, где *filename. txt* — это имя файла, которое вы указали. Пример: `defrag volume /v > FileName.txt`
