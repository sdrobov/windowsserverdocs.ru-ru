---
title: defrag
description: Справочный раздел по команде Defrag, который находит и объединяет фрагментированные файлы на локальных томах для повышения производительности системы.
...
- Вы не можете дефрагментировать определенные тома или диски файловой системы, включая:
  ...
  - Тома. файловая система помечена как "грязная", что указывает на возможное повреждение.<br>Перед дефрагментацией тома или диска необходимо запустить `chkdsk` . Можно определить, является ли том "грязным", `fsutil dirty` с помощью команды.
