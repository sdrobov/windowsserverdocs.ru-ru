...
description: Справочный раздел по New-Дисковеримаже, который создает новый образ обнаружения из существующего образа загрузки.
