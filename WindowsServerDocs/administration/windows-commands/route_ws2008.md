...
|Команда \<>|Указывает команду, которую требуется выполнить. В следующей таблице перечислены допустимые команды.<p>-   **Добавить:** добавляет маршрут.<br />-   **изменение:** изменяет существующий маршрут.<br />-   **Удалить:** удаляет маршрут или маршруты.<br />-   **Печать:** печать маршрута или маршрутов.|  
