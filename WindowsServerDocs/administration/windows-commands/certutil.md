...
Если certutil запускается на компьютере центра сертификации без дополнительных параметров, он отображает текущую конфигурацию центра сертификации. Если cerutil запускается на компьютере без сертификации, по умолчанию используется под управлением certutil [-дампа](#-dump) команды.

> [!WARNING]
> Более ранние версии certutil может не предоставлять все параметры, описанные в этом документе. Можно просмотреть все параметры, которые предоставляет определенную версию certutil, выполнив команды, показанные в [нотации синтаксиса](#syntax-notations) раздел.
...
- [Команды](#verbs)
- [Обозначения синтаксиса](#syntax-notations)
- [Параметры](#options)
- [Примеры дополнительных certutil](#additional-certutil-examples)
...
|Команды|Описание|
|-----|-----------|
|[-дампа](#-dump)|Дамп данных или файлов конфигурации|
|[-asn](#-asn)|Синтаксический анализ файла ASN.1|
|[-decodehex](#-decodehex)|Расшифровать файл в шестнадцатеричной кодировке|
|[-декодирования](#-decode)|Декодировать файл с кодировкой Base64|
|[-кодирования](#-encode)|Закодировать файл в кодировке Base64|
|[— запретить](#-deny)|Запретить ожидаемого запроса сертификата|
|[-повторной отправки](#-resubmit)|Отправьте повторно ожидающий запрос сертификата|
|[-setattributes](#-setattributes)|Задание атрибутов для ожидаемого запроса сертификата|
|[-setextension](#-setextension)|Установить расширение для ожидаемого запроса сертификата|
|[-отозвать](#-revoke)|Отзыв сертификата|
|[-isvalid](#-isvalid)|Отображение метода обработки текущего сертификата|
|[-getconfig](#-getconfig)|Получить строку конфигурации по умолчанию|
|[-проверки связи](#-ping)|Запросить интерфейс Active Directory Certificate Services запрос|
|-pingadmin|Свяжется интерфейса администратора служб сертификатов Active Directory|
|[-CAInfo](#-cainfo)|Отображение информации о центре сертификации|
|[-ca.cert](#-cacert)|Получить сертификат для центра сертификации|
|[-ca.chain](#-cachain)|Извлечь цепочку сертификатов центра сертификации|
|[-GetCRL](#-getcrl)|Получить список отзыва сертификатов (CRL)|
|[-CRL](#-crl)|Публикация новых списков отзыва сертификатов (CRL) [или только разностных списков отзыва сертификатов]|
|[— Завершение работы](#-shutdown)|Завершение служб сертификатов Active Directory|
|[-installCert](#-installcert)|Установить сертификат центра сертификации|
|[-renewCert](#-renewcert)|Продлить сертификат центра сертификации|
|[-схемы](#-schema)|Дамп схемы для сертификата|
|[-представление](#-view)|Дамп просмотра сертификата|
|[-db](#-db)|Дамп необработанной базы данных|
|[-deleterow](#-deleterow)|Удаление строки из базы данных сервера|
|[-резервного копирования](#-backup)|Службы сертификатов резервного копирования Active Directory|
|[-backupDB](#-backupdb)|Резервное копирование базы данных служб сертификатов Active Directory|
|[-backupKey](#-backupkey)|Службы сертификатов Active Directory сертификат и закрытый ключ для резервного копирования|
|[-Восстановление](#-restore)|Восстановление служб сертификатов Active Directory|
|[-restoreDB](#-restoredb)|Восстановление базы данных служб сертификатов Active Directory|
|[-restoreKey](#-restorekey)|Восстановление служб сертификатов Active Directory сертификат и закрытый ключ|
|[-importPFX](#-importpfx)|Импорт сертификата и закрытого ключа|
|[-dynamicfilelist](#-dynamicfilelist)|Отобразить список динамических файлов|
|[-databaselocations](#-databaselocations)|Отображения расположения базы данных|
|[-hashfile](#-hashfile)|Создать и отобразить криптографический хэш над файлом|
|[-хранения](#-store)|Дамп хранилища сертификатов|
|[-addstore](#-addstore)|Добавление сертификата в хранилище|
|[-delstore](#-delstore)|Удаление сертификата из хранилища|
|[-verifystore](#-verifystore)|Проверить сертификат в хранилище|
|[-repairstore](#-repairstore)|Восстановить сопоставления на основе ключа либо обновление свойств сертификата или дескриптор ключа безопасности|
|[-viewstore](#-viewstore)|Дамп в хранилище сертификатов|
|[-viewdelstore](#-viewdelstore)|Удаление сертификата из хранилища|
|[-dsPublish](#-dspublish)|Опубликовать сертификат или список отзыва сертификатов (CRL) в Active Directory|
|[-ADTemplate](#-adtemplate)|Шаблоны отображения AD|
|[-Шаблона](#-template)|Отображение шаблонов сертификатов|
|[-TemplateCAs](#-templatecas)|Отобразить центров сертификации (ЦС) для шаблона сертификата|
|[-CATemplates](#-catemplates)|Отображение шаблонов для ЦС|
|[-SetCASites](#-setcasites)|Управление именами сайт для ЦС|
|[-enrollmentServerURL](#-enrollmentserverurl)|Отображения, добавить или удалить URL-адреса сервера регистрации, связанные с ЦС|
|[-ADCA](#-adca)|Отобразить центров сертификации AD|
|[-CA](#-ca)|Отображение ЦС политики регистрации|
|[-Policy](#-policy)|Отображение политики регистрации|
|[-PolicyCache](#-policycache)|Отображение или удаление записей кэша политики регистрации|
|[-CredStore](#-credstore)|Отображения, добавить или удалить записи учетных данных Store|
|[-InstallDefaultTemplates](#-installdefaulttemplates)|Установите шаблоны сертификатов по умолчанию|
|[-URLCache](#-urlcache)|Отображение или удаление записей кэша URL-адрес|
|[-pulse](#-pulse)|Pulse автоматической регистрации событий|
|[-MachineInfo](#-machineinfo)|Отобразить сведения об объекте машины Active Directory|
|[-DCInfo](#-dcinfo)|Отображение информации о контроллере домена|
|[-EntInfo](#-entinfo)|Отображение сведений об ЦС предприятия|
|[-TCAInfo](#-tcainfo)|Отображение информации о ЦС|
|[-SCInfo](#-scinfo)|Отображение информации о смарт-карты|
|[-SCRoots](#-scroots)|Управление корневые сертификаты смарт-карты|
|[-verifykeys](#-verifykeys)|Проверить набор общедоступных или частных ключей|
|[— Проверка](#-verify)|Проверка сертификата и списка отзыва сертификатов (CRL) или цепочки сертификатов|
|[-verifyCTL](#-verifyctl)|Проверка AuthRoot или запрещенных сертификатов списка доверия Сертификатов|
|[-входа](#-sign)|Повторно подписать список отзыва сертификатов (CRL) или сертификат|
|[-vroot](#-vroot)|Создание или удаление виртуальных корней Веба и общих папок|
|[-vocsproot](#-vocsproot)|Создание или удаление виртуальных корней Веба для веб-прокси OCSP|
|[-addEnrollmentServer](#-addenrollmentserver)|Добавление сервера регистрации приложения|
|[-deleteEnrollmentServer](#-deleteenrollmentserver)|Удалить приложение сервера регистрации|
|[-addPolicyServer](#-addpolicyserver)|Добавление политики серверного приложения|
|[-deletePolicyServer](#-deletepolicyserver)|Удаление политики серверного приложения|
|[-oid](#-oid)|Отобразить идентификатор объекта или задать отображаемое имя|
|[-Ошибка](#-error)|Отобразить текст сообщения, связанного с кодом ошибки|
|[-getreg](#-getreg)|Отобразить значение реестра|
|[-setreg](#-setreg)|Задание значения реестра|
|[-delreg](#-delreg)|Удалить значение реестра|
|[-ImportKMS](#-importkms)|Импорт пользовательских ключей и сертификатов в базе данных сервера для архивации ключа|
|[-ImportCert](#-importcert)|Импорт файла сертификата в базу данных|
|[-GetKey](#-getkey)|Получить большой двоичный объект восстановления заархивированного закрытого ключа|
|[-RecoverKey](#-recoverkey)|Восстановление архивированного закрытого ключа|
|[-MergePFX](#-mergepfx)|Слияние файлов PFX|
|[-ConvertEPF](#-convertepf)|Преобразовать в PFX-файл в файл EPF|
|-?|Отображает список команд|
|- *\<Команда >* -?|Отображает справку по указанная команда.|
|-? -v|Отображает полный список команд и|

Вернитесь к [меню](#menu)

## <a name="syntax-notations"></a>Обозначения синтаксиса
...
Тип: числовой CRYPT\_строка\_ \* декодирование типа
...
Тип: числовой CRYPT\_строка\_ \* тип кодировки

[-f].

Вернитесь к [меню](#menu)

## <a name="-decode"></a>-декодирования
...
## <a name="-resubmit"></a>-повторной отправки
...
## <a name="-backup"></a>-резервного копирования
...
Имяхранилищасертификатов: Имя хранилища сертификатов.  См. в разделе [-хранить](#-store).
...
CertId: Сертификат или маркер совпадение списка отзыва Сертификатов.  См. в разделе [-хранить](#-store).
...
CertIdList: разделенный запятыми список сертификатов или CRL маркеры совпадения. См. в разделе [-хранить](#-store) CertId описание.
...
Имя_значения_реестра: имя значения реестра (используйте «имя\*» к совпадению префикса)
...
CertId: KMS экспортировать маркер соответствия сертификата расшифровки файла.  См. в разделе [-хранить](#-store).
...
V3CACertId: Токен соответствия сертификата ЦС v3.  См. в разделе [-хранить](#-store) CertId описание.
...
## <a name="additional-certutil-examples"></a>Примеры дополнительных certutil
