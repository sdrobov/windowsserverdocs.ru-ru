...
|Параметр|Описание|
|---------|-----------|
|\<Исходный>|Обязательный. Указывает расположение и имена файлов, которые необходимо скопировать. Этот параметр должен содержать либо диск, либо путь.|
