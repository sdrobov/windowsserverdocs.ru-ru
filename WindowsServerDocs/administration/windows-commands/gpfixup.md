---
title: gpfixup
description: Справочный раздел по команде гпфиксуп, который устраняет зависимости имен доменов в групповая политика объектах и групповая политика ссылки после операции переименования домена.
