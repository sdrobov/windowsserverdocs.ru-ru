...
```
Чтобы начать восстановление данных из резервной копии, которая выполнялась 30 апреля 2013 в 9:00 утра, в общей папке \\\\сервернаме\шаред: для Server01, введите:
```
