...
description: Справочный раздел по Wbadmin start сисрековери, который выполняет восстановление системы (восстановление исходного состояния компьютера) с использованием указанных параметров.
