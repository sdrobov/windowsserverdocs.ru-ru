...
| /ауторефреш<interval> |                                                                                                          В этом случае диспетчер балансировки сетевой нагрузки обновляет сведения об узле и <interval> кластере каждый секунд. Если интервал не указан, информация обновляется каждые 60 секунд.                                                                                                          |
