---
title: nlbmgr
description: Справочный раздел по команде Nlbmgr, который помогает настраивать и администрировать кластеры балансировки сетевой нагрузки и все узлы кластера с одного компьютера с помощью диспетчера балансировки сетевой нагрузки.
