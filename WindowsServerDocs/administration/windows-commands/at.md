...
|\<время\>|Указывает время, если вы хотите выполнить команду. время выражается как часы: минуты, в 24-часовом формате (то есть, 00:00 [полночь] до 23:59).|
