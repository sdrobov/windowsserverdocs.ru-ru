---
title: bcdedit
description: Справочный раздел по команде bcdedit, который создает новые магазины, изменяет существующие хранилища и добавляет параметры меню загрузки.
