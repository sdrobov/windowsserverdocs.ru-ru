...
|/FO \<Format >|Задает формат вывода с одним из следующих значений:</br>ТАБЛИЦА Отображает выходные данные в таблице.</br>ЧИСЛ Отображает выходные данные в списке.</br>\- Отображает выходные данные в формате значений с разделителями запятыми.|
