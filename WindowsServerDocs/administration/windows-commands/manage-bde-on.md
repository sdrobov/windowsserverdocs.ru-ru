...
|@no__t 0NumericalPassword >|Представляет пароль восстановления.|
...
|@no__t 0PathToExternalDirectory >|Представляет путь к каталогу ключа восстановления.|
...
|@no__t 0PathToExternalKeyDirectory >|Представляет путь к каталогу для ключа запуска.|
...
|@no__t 0FileSystemType >|Указывает, какие файловые системы можно использовать с дисками данных обнаружения: FAT32, по умолчанию или нет.|
