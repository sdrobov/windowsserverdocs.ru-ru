...
Чтобы проиллюстрировано использование команды **-On** для включения BitLocker для диска C и добавления пароля восстановления на диск.
```
manage-bde –on C: -recoverypassword
```
Чтобы проиллюстрировано использование команды **-On** для включения BitLocker для диска C, добавьте пароль восстановления на диск и сохраните ключ восстановления на диске E.
```
manage-bde –on C: -recoverykey E:\ -recoverypassword
```
Демонстрация использования команды **-On** для включения BitLocker для диска C с помощью предохранителя внешнего ключа (например, ключа USB) для разблокировки диска операционной системы. Этот метод необходим при использовании BitLocker с компьютерами, у которых нет доверенного платформенного модуля.
```
manage-bde -on C: -startupkey E:\
```
Чтобы проиллюстрировано использование команды **-On** для включения BitLocker для диска данных E и добавления предохранителя ключа пароля. Manage-bde предложит ввести пароль после ввода этой команды.
```
manage-bde –on E: -pw
```
Чтобы проиллюстрировано использование команды **-On** для включения BitLocker для диска с операционной системой C и использования шифрования на основе оборудования.
```
