...
|       -p @no__t — 0printerName >       |                                                                                                                                                                Указывает имя принтера, которым требуется управлять.                                                                                                                                                                 |
|     -m \<DrivermodelName >     |                                                                                                          Указывает (по имени) драйвер, который вы хотите установить. Драйверы часто называются для модели поддерживаемых принтеров. Дополнительные сведения см. в документации принтера.                                                                                                           |
...
-   Команда **прндрвр** является сценарием Visual Basic, расположенным в каталоге%WINdir%\System32\printing_Admin_Scripts @ no__t-1 @ no__t-2. Чтобы использовать эту команду, в командной строке введите **cscript** , а затем полный путь к файлу **прнмнгр** или измените каталоги на соответствующую папку. Пример:
    ```
