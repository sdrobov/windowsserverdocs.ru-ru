---
title: prnmngr
description: Справочные сведения о команде прнмнгр, которая добавляет, удаляет и перечисляет принтеры или подключения принтеров в дополнение к настройке и отображению принтера по умолчанию.
