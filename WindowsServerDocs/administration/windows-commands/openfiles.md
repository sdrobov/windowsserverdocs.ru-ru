---
title: openfiles
description: Справочный раздел, посвященный команде openfiles, которая позволяет администратору запрашивать, отображать или отключать файлы и каталоги, открытые в системе.
