---
title: goto
description: Справочный раздел по команде goto, который направляет cmd. exe на помеченную строку в пакетной программе.
...
ms.locfileid: "83818974"
---
# <a name="goto"></a>goto

Направляет cmd. exe на помеченную строку в пакетной программе. В рамках пакетной программы эта команда направляет обработку команд в строку, обозначенную меткой. При обнаружении метки обработка продолжится, начиная с команд, начинающихся со следующей строки.
