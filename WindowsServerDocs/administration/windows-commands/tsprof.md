...
|/profile: \<path >|Указывает путь к профилю, отображаемый в службы удаленных рабочих столов расширениях в оснастке "Локальные пользователи и группы" и "пользователи и компьютеры Active Directory".|
|@no__t 0UserName >|Указывает имя пользователя, для которого необходимо обновить или запросить путь к профилю сервера.|
|/Copy|Копирует сведения о конфигурации пользователя из \<*SourceUser*> в \<*DestinationUser*> и обновляет сведения о пути к профилю для *@no__t >-4 до*@no__t *-6.* Как \<*SourceUser*>, так и \<*DestinationUser*> должны быть локальными или должны находиться в домене \<*имя_домена*>.|
|@no__t 0Src_usr >|Указывает имя пользователя, от которого необходимо скопировать сведения о конфигурации пользователя.|
|@no__t 0Dest_usr >|Указывает имя пользователя, которому необходимо скопировать сведения о конфигурации пользователя.|
