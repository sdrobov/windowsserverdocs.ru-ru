...
description: Справочный раздел по команде Manage-bde Lock, который блокирует диск, защищенный BitLocker, чтобы предотвратить доступ к нему, если не указан ключ Unlock.
