...
description: Раздел команд Windows для Add-Device, который предварительно наследует компьютер в доменных службах Active Directory. Предварительно подготовленные компьютеры также называются известными компьютерами.
