...
description: Справочный раздел по Add-Device, который предварительно наследует компьютер в доменных службах Active Directory. Предварительно подготовленные компьютеры также называются известными компьютерами.
...
синтаксиса командной строки[с помощью команды Get-аллдевицес](using-the-get-alldevices-command.md)[с использованием команды Get-Device](using-the-get-device-command.md)
