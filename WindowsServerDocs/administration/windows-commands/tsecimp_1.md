---
title: tsecimp
description: Раздел команд Windows для TSecImp, который импортирует сведения о назначении из файла язык XML (XML) в файл безопасности сервера TAPI (ТСЕК. ini).
...
|Параметр|Описание|
|---------|-----------|
|/f \<имя файла >|Обязательное. Указывает имя XML-файла, содержащего сведения о назначении, которые необходимо импортировать.|
