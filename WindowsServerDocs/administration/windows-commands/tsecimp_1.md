---
title: tsecimp
description: Справочный раздел о параметре TSecImp, который импортирует сведения о назначении из файла язык XML (XML) в файл безопасности сервера TAPI (ТСЕК. ini).
...
|Параметр|Описание|
|---------|-----------|
|/f \<имя файла>|Обязательный. Указывает имя XML-файла, содержащего сведения о назначении, которые необходимо импортировать.|
|/v|Проверяет структуру XML-файла без импорта данных в файл ТСЕК. ini.|
