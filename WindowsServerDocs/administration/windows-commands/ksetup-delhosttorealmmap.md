...
Сопоставление записывается в реестр в **HKEY_LOCAL_MACHINE\SYSTEM\CurrentContolSet\Lsa\Kerberos\HostToRealm**. При использовании этой команды следует проверить сопоставление в реестре.
