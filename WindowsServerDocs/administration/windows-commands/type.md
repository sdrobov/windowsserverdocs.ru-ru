---
title: type
description: Справочный раздел типа, который отображает содержимое текстового файла.
...
|Параметр|Описание|
|---------|-----------|
|[\<Диск>:] [\<Путь>] \<Имя файла>|Указывает расположение и имя файла или файлов, которые требуется просмотреть. Несколько имен файлов следует разделять пробелами.|
