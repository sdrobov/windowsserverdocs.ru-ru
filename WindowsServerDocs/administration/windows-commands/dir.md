---
title: dir
description: Справочный раздел команды dir, в которой отображается список файлов и подкаталогов каталога.
...
- Можно использовать подстановочный знак **&#42;**, чтобы заменить любую строку символов, например:
  ...
  Можно ожидать, что при `dir t97\*` вводе будет возвращен файл t97. txt. Однако при вводе `dir t97\*` этих файлов возвращаются оба файла, так как подстановочный знак звездочки соответствует файлу t. txt2 в t97. txt с помощью краткого сопоставления имен *T97B4 ~ 1. txt*. Аналогичным образом `del t97\*` при вводе будут удалены оба файла.
