---
title: popd
description: Справочный раздел по команде pnputil, который изменяет текущий каталог на каталог, который был последним сохранен командой pushd.
