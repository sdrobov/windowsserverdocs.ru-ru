...
|@no__t 0Source >|Указывает путь и имя файла или файлов для перемещения. Если вы хотите переместить или переименовать каталог, *источником* должен быть текущий путь к каталогу и его имя.|
|@no__t 0Target >|Указывает путь и имя для перемещения файлов. Если вы хотите переместить или переименовать каталог, *целевым объектом* должен быть путь к каталогу и его имя.|
