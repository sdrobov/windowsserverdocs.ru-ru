---
title: fsutil repair
description: Справочный раздел команды fsutil Repair, которая служит для администрирования и мониторинга операций восстановления с самовосстановлением NTFS.
