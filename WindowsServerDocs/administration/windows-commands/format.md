...
|   Параметр    |                                                                                                                                                                                                                    Описание                                                                                                                                                                                                                     |
|----------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|   @no__t 0Volume >    |                                                                                         Указывает точку подключения, имя тома или букву диска (с последующим двоеточием) диска, который требуется отформатировать. Если не указать ни один из следующих параметров командной строки, команда **Format** использует тип тома для определения формата диска по умолчанию.                                                                                         |
|    /FS: {FAT    |                                                                                                                                                                                                                       FAT32                                                                                                                                                                                                                        |
...
| /n: \<Sectors >  |                                                         Задает количество секторов в дорожке. По возможности используйте параметр командной строки **/f** вместо **/n**. Параметр **/n** должен использоваться только вместе с параметром **/t**. Эти параметры применяются совместно в качестве альтернативного способа указания размера форматируемого диска. Этот параметр не работает с параметром **/f**.                                                         |
|  /p: @no__t 0Passes >  |                                                                                                                                                               Обнуляет каждый сектор тома указанное количество раз. Этот параметр не работает с параметром **/q**.                                                                                                                                                                |
