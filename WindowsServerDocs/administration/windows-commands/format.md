...
|/FS: {FAT|FAT32|NTFS|UDF}|Задает тип файловой системы: FAT, FAT32, NTFS или определяемой пользователем функции. В гибких дисках используется только файловая система FAT.|
...
-   **Формат** сообщений
    ...
    После форматирования, **формат** отображает сообщения, которые показывают общий объем дискового пространства, пробелы, помечен как неисправный и свободное место для файлов.
...
[Ключ синтаксиса командной строки](https://technet.microsoft.com/library/cc771080.aspx)