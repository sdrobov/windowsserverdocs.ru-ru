...
|Параметр|Описание|
|-------|--------|
|@no__t 0SessionName >|Указывает имя сеанса, управление которым необходимо осуществлять удаленно.|
|@no__t 0SessionID >|Указывает идентификатор сеанса, управление которым необходимо осуществлять удаленно. Используйте **запрос User** , чтобы отобразить список сеансов и их идентификаторы сеансов.|
|/Server: @no__t 0ServerName >|Указывает сервер узла сеансов удаленных рабочих столов, содержащий сеанс, который требуется удаленно контролировать. По умолчанию используется текущий сервер сеанса Host4 сеансов удаленных рабочих столов.|
...
-   Чтобы завершить удаленное управление (затенение), нажмите клавиши CTRL + \* (с помощью \* на цифровой клавиатуре).
