...
|Параметр|Описание|  
|-------|--------|  
|@no__t 0SessionID >|Указывает идентификатор сеанса, к которому необходимо подключиться. Если используется необязательный параметр **/dest:** <*SessionName*>, это идентификатор сеанса, к которому необходимо подключиться.|  
|@no__t 0SessionName >|Указывает имя сеанса, к которому необходимо подключиться.|  
|/dest: @no__t — 0SessionName >|Указывает имя текущего сеанса. Этот сеанс будет отключен при подключении к новому сеансу.|  
