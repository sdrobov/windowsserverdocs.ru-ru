...
|        Параметр        |                                                                                            Описание                                                                                             |
|-------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|      \<filename @ no__t-1       |                                                                            Обязательный. Отображает списки управления доступом для указанных файлов.                                                                             |
...
|    /g пользователь: \<perm @ no__t-1     |   Предоставьте указанные права доступа пользователя.<br /><br />Допустимые значения для разрешения:<br /><br />-n — нет<br />-r — чтение<br />-w — запись<br />-c — изменение (запись)<br />-f — полный доступ   |
|      /r пользователь [...]      |                                                                  Отозвать права доступа указанного пользователя (допустимо только с параметром **/e**).                                                                   |
| [/p пользователь: \<perm @ no__t-1 [...] | Замена прав доступа указанного пользователя.<br /><br />Допустимые значения для разрешения:<br /><br />-n — нет<br />-r — чтение<br />-w — запись<br />-c — изменение (запись)<br />-f — полный доступ |
...
- Можно использовать подстановочные знаки ( **?** и **\\ @ no__t-2**) для указания нескольких файлов.  
