...
ms.locfileid: "71379378"
---
# <a name="cleanmgr"></a>Cleanmgr

> Относится к: Windows Server 2019, Windows Server 2016, Windows Server 2012, Windows Server 2008 R2, Windows Server (половина ежегодного канала)
...
|      Параметр      |    Описание     |
| ------------------- | ------------------ |
|  /d \<driveletter >          | Указывает диск, на котором должна быть очищена Очистка диска.<br>**Примечание.** Параметр/d не используется с/сажерун: n. |
...
Чтобы выполнить ```cleanmgr /sageset:1``` и ```cleanmgr /sagerun:1``` вместе, введите:
