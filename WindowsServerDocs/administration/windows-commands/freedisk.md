...
| /u [<Domain> @ no__t-1] <User> |                                            Запускает скрипт с разрешениями указанной учетной записи пользователя. По умолчанию заданы системные разрешения.                                            |
|    /p [<Password>]    |                                                           Указывает пароль учетной записи пользователя, указанной в параметре **/u**.                                                            |
|      /d <Drive>       |                              Указывает диск, для которого необходимо определить доступность свободного пространства. Необходимо указать <Drive>for для удаленного компьютера.                               |
