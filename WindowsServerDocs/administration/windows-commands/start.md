---
title: начало
description: Раздел команд Windows для запуска, который запускает отдельное окно командной строки для запуска указанной программы или команды.
