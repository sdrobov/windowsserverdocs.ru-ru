---
title: nbtstat
description: Справочный раздел по команде nbtstat, которая отображает статистику протокола NetBIOS через TCP/IP (NetBT), таблицы имен NetBIOS как для локального компьютера, так и для удаленных компьютеров, а также для кэша имен NetBIOS.
