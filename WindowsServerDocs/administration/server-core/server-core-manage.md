...
- Если вы закроете все окна командной строки и хотите открыть новое окно командной строки, это можно сделать в диспетчере задач. Нажмите клавиши **CTRL @ no__t-1ALT @ no__t-2DELETE**, щелкните **запустить диспетчер задач**, щелкните **Дополнительные сведения > Файл > выполнить**, а затем введите **cmd. exe**. (Чтобы открыть окно командной строки PowerShell, введите **PowerShell. exe** .) Кроме того, можно выйти и снова войти в систему.
