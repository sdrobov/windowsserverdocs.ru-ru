...
-   [Ознакомьтесь с исходными соображениями и требованиями к системе](#review-initial-considerations-and-system-requirements)

-   [Задачи, которые можно выполнять в диспетчер сервера](#tasks-that-you-can-perform-in-server-manager)

-   [Запуск диспетчер сервера](#start-server-manager)

-   [Перезапуск удаленных серверов](#restart-remote-servers)

-   [Экспорт параметров диспетчер сервера на другие компьютеры](#export-server-manager-settings-to-other-computers)
