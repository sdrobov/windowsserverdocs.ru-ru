...
## <a name="manage-services-and-configure-service-alerts"></a><a name=BKMK_services></a>Управление службами и Настройка оповещений службы  
...
## <a name="view-and-copy-event-service-or-performance-entries"></a><a name=BKMK_copy></a>Просмотр и копирование записей событий, служб и производительности  
