...
## <a name="BKMK_creds"></a>Ввод учетных данных с помощью команды "Управление как"
...
3.  Выполните одно из указанных ниже действий.
    ...
    -   На вкладке **DNS** введите первые несколько символов имени или IP-адреса компьютера, затем нажмите клавишу **ВВОД** или щелкните кнопку **Поиск**. Выберите серверы, которые вы хотите добавить, и нажмите кнопку со стрелкой вправо.
