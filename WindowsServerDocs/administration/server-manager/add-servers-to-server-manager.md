...
-   [Добавить серверы для управления](#BKMK_add)

-   [Укажите учетные данные с помощью команды Manage As](#BKMK_creds)

## <a name="BKMK_creds"></a>Укажите учетные данные с помощью команды Manage As
...
## <a name="BKMK_add"></a>Добавить серверы для управления
