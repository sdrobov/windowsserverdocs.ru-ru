...
## <a name="review-initial-considerations-and-system-requirements"></a><a name=BKMK_1.1></a>Ознакомьтесь с исходными соображениями и требованиями к системе
...
### <a name="software-and-configuration-requirements"></a><a name=BKMK_softconfig></a>Требования к программному обеспечению и конфигурации
...
## <a name="tasks-that-you-can-perform-in-server-manager"></a><a name=BKMK_tasks></a>Задачи, которые можно выполнять в диспетчер сервера
...
## <a name="export-server-manager-settings-to-other-computers"></a><a name=BKMK_export></a>Экспорт параметров диспетчер сервера на другие компьютеры
...
-   %*AppData*% \ Local \ Microsoft_Corporation \Серверманажер. exe_StrongName_*GUID*\6.2.0.0\user.config
...
3.  Выполните одно из указанных ниже действий.
    ...
    -   В сборках американского английского языка (EN-US) изменения в файле **SERVERLIST. XML** автоматически сохраняются в профиле. Перейдите к следующему шагу.
    ...
    -   В других сборках скопируйте следующие два файла с компьютера, на котором выполняется диспетчер сервера, в общую сетевую папку, которая является частью перемещаемого профиля пользователя.
        ...
        -   %*LocalAppData*% \ Microsoft_Corporation \Серверманажер. exe_StrongName_*GUID*\6.2.0.0\user.config
