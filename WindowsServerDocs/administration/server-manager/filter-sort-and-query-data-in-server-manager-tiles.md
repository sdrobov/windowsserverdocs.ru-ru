...
## <a name="BKMK_tiles"></a>Фильтрация элементов списка в плитках  
...
## <a name="BKMK_sort"></a>Сортировка записей списка в плитках  
...
## <a name="BKMK_query"></a>Создание и выполнение пользовательских запросов к данным плиток  
