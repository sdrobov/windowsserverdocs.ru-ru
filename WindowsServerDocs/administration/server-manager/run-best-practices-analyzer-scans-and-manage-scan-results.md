...
## <a name="how-bpa-works"></a><a name=BKMK_how></a>Принцип работы BPA
...
## <a name="performing-best-practices-analyzer-scans-on-roles"></a><a name=BKMK_BPAscan></a>Выполнение анализатор соответствия рекомендациям сканирование ролей
...
### <a name="scanning-roles-by-using-the-bpa-gui"></a><a name=BKMK_GUIscan></a>Проверка ролей с помощью ГИП анализатора соответствия рекомендациям
...
### <a name="scanning-roles-by-using-windows-powershell-cmdlets"></a><a name=BKMK_PSscan></a>Проверка ролей с помощью командлетов Windows PowerShell
...
#### <a name="to-scan-a-single-role-by-using-windows-powershell-cmdlets"></a><a name=BKMK_singlerole></a>Сканирование одной роли с помощью командлетов Windows PowerShell
...
#### <a name="to-scan-all-roles-by-using-windows-powershell-cmdlets"></a><a name=BKMK_allroles></a>Проверка всех ролей с помощью командлетов Windows PowerShell
...
#### <a name="exclude-scan-results"></a><a name=BKMK_exclude></a>Исключить результаты проверки
...
##### <a name="to-include-scan-results-by-using-the-gui"></a><a name=BKMK_gui></a>Включение результатов проверки с помощью графического интерфейса пользователя
...
##### <a name="to-include-scan-results-by-using-windows-powershell-cmdlets"></a><a name=BKMK_cmdlets></a>Включение результатов проверки с помощью командлетов Windows PowerShell
...
[Анализатор соответствия рекомендациям содержимое решения в техническом центре Windows Server](https://go.microsoft.com/fwlink/p/?LinkId=241597)
[фильтровать, сортировать и запрашивать данные в диспетчер сервера плитках](filter-sort-and-query-data-in-server-manager-tiles.md)
[управления несколькими удаленными серверами с Диспетчер сервера](manage-multiple-remote-servers-with-server-manager.md)
