...
Этот раздел содержит общие сведения о базовом сетевом руководстве для Windows Server @ no__t-0 2016 и содержит следующие разделы.  
...
- Основные протоколы для организации связи компьютеров и других TCP/IP-совместимых устройств между собой по сети. TCP/IP — это набор стандартных протоколов для соединения компьютеров и построения сетей. TCP/IP — это программное обеспечение сетевого протокола, поставляемое с операционными системами Microsoft @ no__t-0 Windows @ no__t-1, которое реализует и поддерживает набор протоколов TCP/IP.
...
Руководство по основным сетевым компонентам Windows Server 2016 содержит инструкции по планированию и развертыванию основных компонентов, необходимых для полностью работоспособной сети, а также нового домена Active Directory @ no__t-0 в новом лесу. Используя это руководство, можно развертывать компьютеры, на которых настроены следующие компоненты сервера Windows:
