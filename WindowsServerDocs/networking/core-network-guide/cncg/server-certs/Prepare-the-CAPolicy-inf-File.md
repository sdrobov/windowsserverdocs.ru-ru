...
**Крлпериод** и **крлпериодунитс** устанавливают срок действия для базового списка отзыва сертификатов. **Крлпериод** могут иметь следующие значения: Часы, дни, недели, месяцы и годы.
