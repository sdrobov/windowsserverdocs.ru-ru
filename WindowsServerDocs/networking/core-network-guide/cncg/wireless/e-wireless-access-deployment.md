...
Если требуется несколько групп безопасности для беспроводных пользователей, повторите эти действия, чтобы создать дополнительные группы пользователей беспроводной связи. Позже можно будет создать отдельные политики сети в NPS, чтобы применить различные условия и контстраинтс к каждой группе, предоставив им разные разрешения на доступ и правила подключения.
