...
### <a name="tcpip"></a>Протокол TCP/IP
...
## <a name="core-network-planning"></a><a name="BKMK_planning"></a>Основное планирование сети
...
-   Создайте учетные записи пользователей в оснастке "Active Directory — пользователи и компьютеры". У каждого пользователя в оснастке "Active Directory — пользователи и компьютеры" должна быть учетная запись пользователя доменных служб Active Directory. Дополнительные сведения см. в разделе [Создание учетной записи пользователя в оснастке "Пользователи и компьютеры Active Directory"](#BKMK_createUA).
...
## <a name="core-network-deployment"></a><a name="BKMK_deployment"></a>Базовое развертывание сети
...
#### <a name="install-ad-ds-and-dns-for-a-new-forest"></a><a name="BKMK_installAD-DNS"></a>Установка AD DS и DNS для нового леса
...
##### <a name="create-a-user-account-in-active-directory-users-and-computers"></a><a name="BKMK_createUA"></a>Создание учетной записи пользователя в Active Directory пользователи и компьютеры
...
##### <a name="assign-group-membership"></a><a name="BKMK_assigngroup"></a>Назначение членства в группе
...
#### <a name="joining-server-computers-to-the-domain-and-logging-on"></a><a name="BKMK_joinlogserver"></a>Присоединение серверных компьютеров к домену и вход в систему
...
### <a name="joining-client-computers-to-the-domain-and-logging-on"></a><a name="BKMK_joinlogclients"></a>Присоединение клиентских компьютеров к домену и вход в систему
...
### <a name="deploying-optional-features-for-network-access-authentication-and-web-services"></a><a name="BKMK_optionalfeatures"></a>Развертывание дополнительных компонентов для проверки подлинности доступа к сети и веб-служб
...
##### <a name="install-network-policy-server-nps"></a><a name="BKMK_installNPS"></a>Установка сервера политики сети (NPS)
...
###### <a name="to-install-nps"></a>Установка NPS
...
##### <a name="install-the-web-server-iis-server-role"></a><a name="BKMK_install_IIS"></a>Установка роли сервера веб-сервера (IIS)
...
## <a name="additional-technical-resources"></a><a name="BKMK_resources"></a>Дополнительные технические ресурсы
...
## <a name="appendices-a-through-e"></a><a name="BKMK_appendix"></a>От A до E
...
## <a name="appendix-a---renaming-computers"></a><a name="BKMK_A"></a>Приложение а. переименование компьютеров
...
## <a name="appendix-b---configuring-static-ip-addresses"></a><a name="BKMK_B"></a>Приложение б. Настройка статических IP-адресов
...
## <a name="appendix-e---core-network-planning-preparation-sheet"></a><a name="BKMK_E"></a>Приложение E — Страница «Подготовка основного планирования сети»
...
### <a name="installing-active-directory-domain-services-and-dns"></a><a name="BKMK_FndtnPrep_InstallAD"></a>Установка служб домен Active Directory и DNS
...
#### <a name="creating-a-new-dhcp-scope"></a><a name="bkmk_NetFndtn_Pln_DHCP_NewScope"></a>Создание новой области DHCP
...
|Срок действия аренды адреса<br /><br />Дни<br /><br />Hours<br /><br />Минуты|-8<br />-   0<br />-   0||
