...
|Тип зоны<p>**Сохраните зону в Active Directory**|— Выбрано<br />-Не выбрано||
...
|Срок действия аренды адреса<p>Дни<p>Hours<p>Минуты|-8<br />-   0<br />-   0||
|Маршрутизатор (шлюз по умолчанию)<p>IP-адрес|10.0.1.1||
|Родительский домен DNS|corp.contoso.com||
|DNS-сервер<p>IP-адрес|10.0.0.2||
