...
![](../media/Windows-Time-Service/How-the-Windows-Time-Service-Works/trnt_ntw_adhc.gif) времени Windows
...
[Технический справочник по службе времени windows](windows-time-service-tech-ref.md)
[средства и параметры службы времени windows](Windows-Time-Service-Tools-and-Settings.md)
[статье 902229 базы знаний Майкрософт](https://go.microsoft.com/fwlink/?LinkId=186066)