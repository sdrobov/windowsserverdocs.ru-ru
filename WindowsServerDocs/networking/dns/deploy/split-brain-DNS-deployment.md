...
В области внутренней зоны, запись **www.career.contoso.com** 10.0.0.39, который является частный IP-адрес; IP-адресом и добавляется в область зоны по умолчанию одной и той же записи, **www.career.contoso.com**, — добавить IP-адресом 65.55.39.10.
