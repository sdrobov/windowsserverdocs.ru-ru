...
---
# <a name="use-dns-policy-for-split-brain-dns-deployment"></a>Использование политики DNS для разбиения\-мозгового развертывания DNS
...
>[!NOTE]
>Сведения об использовании политики DNS для разбиения\-мозгового развертывания DNS с Active Directory интегрированными зоны DNSми см. [в статье Использование политики DNS для разделения DNS-имен с разделением в Active Directory](dns-sb-with-ad.md).
