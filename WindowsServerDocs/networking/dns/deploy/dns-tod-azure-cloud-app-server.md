...
## <a name="example-of-intelligent-dns-responses-based-on-the-time-of-day-with-azure-cloud-app-server"></a>Пример интеллектуальных ответов DNS на основе времени дня с сервера приложений в облаке Azure
...
## <a name="how-intelligent-dns-responses-based-on-time-of-day-with-azure-app-server-works"></a>Работает как получение интеллектуальных ответов DNS на основе времени дня с помощью Azure сервера приложений
...
## <a name="how-to-configure-dns-policy-for-intelligent-dns-responses-based-on-time-of-day-with-azure-app-server"></a>Настройка политики DNS для интеллектуальных ответов DNS на основе времени дня с помощью Azure сервера приложений
...
- [Создание области зоны](#create-the-zone-scopes)
- [Добавление записей в области зоны](#add-records-to-the-zone-scopes)
- [Создайте политики DNS](#create-the-dns-policies)
