...
После настройки новой политики DNS, основанной на пиковых трудозатратах от 6 до 9 PM в Сиэтле, DNS-сервер отправляет 70 за каждое увеличение ответов DNS клиентам, содержащим IP-адрес в Сиэтле, и по 30 штук в секунду для клиентов. с IP-адресом сервера Azure, таким образом, направляется трафик клиента на новый веб-сервер Azure и предотвращается перегрузка веб-сервера в Сиэтле. 
