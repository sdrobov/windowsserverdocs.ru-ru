...
Политика DNS — это новая функция DNS в Windows Server @ no__t-0 2016. С помощью этого руководства вы узнаете, как с помощью политики DNS управлять тем, как DNS-сервер обрабатывает запросы разрешения имен на основе различных параметров, определенных в политиках.   
