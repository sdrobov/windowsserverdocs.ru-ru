...
|---------|---------------|-------------------|  
|**Название**|Имя политики|— До 256 символов<br />— Может содержать любой символ, допустимый для имени файла|  
...
|         **Тип запроса**          |                          Тип запрашиваемой записи (A, SRV, TXT)                          |                                                  -   **EQ, txt, SRV** -разрешается в true, если запрос запрашивает запись типа TXT **или** SRV.<br />-   **EQ, MX** -разрешает значение true, если запрос запрашивает запись MX                                                   |
