...
|Уровень |Шестнадцатеричное значение |Comments |
| --- | --- | --- |
...
|проб |0xE (коэффициент масштабирования 14) |Задайте для окна приема TCP значение рост в соответствии с экстремальными сценариями. |
