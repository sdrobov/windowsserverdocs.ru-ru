...
- [Disable-нетадаптеррсс](https://technet.microsoft.com/library/jj130892). Эта команда отключает RSS на указанном сетевом адаптере.

- [Enable-нетадаптеррсс](https://technet.microsoft.com/library/jj130859). Эта команда включает RSS на указанном сетевом адаптере.
  
- [Get-нетадаптеррсс](https://technet.microsoft.com/library/jj130912). Эта команда получает свойства RSS указанного сетевого адаптера.
  
- [Set-нетадаптеррсс](https://technet.microsoft.com/library/jj130863). Эта команда задает свойства RSS для указанного сетевого адаптера.  
...
- **Басепроцессорнумбер\*** : Задает базовый номер процессора узла NUMA. Это влияет на массив процессоров, используемый RSS. Это позволяет секционировать процессоры между сетевыми адаптерами. Это первый логический процессор в диапазоне процессоров RSS, назначенных каждому адаптеру. Пример синтаксиса:
...
Для получения дополнительных сведений щелкните следующую ссылку, чтобы скачать [масштабируемые сети: Устранение узких мест обработки приема —](https://download.microsoft.com/download/5/D/6/5D6EAF2B-7DDF-476B-93DC-7CF0072878E6/NDIS_RSS.doc) RSS-канал в формате Word.
...
Убедитесь, что на этих сетевых \(адаптерах указано значение RSC\)по умолчанию, если у \(вас нет конкретных рабочих нагрузок, например низкая задержка, сеть\) с низкой пропускной способностью, которая показывает преимущества от RSC. .
...
##  <a name="bkmk_resources"></a>Ресурсы сетевого адаптера
...
- [Get-Нетадаптерадванцедпроперти](https://technet.microsoft.com/library/jj130901.aspx)

- [Set-Нетадаптерадванцедпроперти](https://technet.microsoft.com/library/jj130894.aspx)

- [Enable-NetAdapter](https://technet.microsoft.com/library/jj130876.aspx)

- [Enable-Нетадаптербиндинг](https://technet.microsoft.com/library/jj130913.aspx)

- [Enable-Нетадаптерчекксумоффлоад](https://technet.microsoft.com/library/jj130918.aspx)

- [Enable-Нетадаптерипсекоффлоад](https://technet.microsoft.com/library/jj130890.aspx)

- [Enable-Нетадаптерлсо](https://technet.microsoft.com/library/jj130922.aspx)

- [Enable-Нетадаптерповерманажемент](https://technet.microsoft.com/library/jj130907.aspx)

- [Enable-Нетадаптеркос](https://technet.microsoft.com/library/jj130866.aspx)

- [Enable-Нетадаптеррдма](https://technet.microsoft.com/library/jj130909.aspx)

- [Enable-Нетадаптерсриов](https://technet.microsoft.com/library/jj130899.aspx)
