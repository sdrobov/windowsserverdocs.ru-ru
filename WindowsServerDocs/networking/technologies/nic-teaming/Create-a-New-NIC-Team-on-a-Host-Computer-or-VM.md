...
- [Объединение сетевых карт: использование и управление MAC-адрес](NIC-Teaming-MAC-Address-Use-and-Management.md). при настройке группы сетевых адаптеров с независимым режимом и при использовании хэша или динамического распределения нагрузки группа использует Mac-адрес участника группы основного сетевого адаптера для исходящего трафика. трафика. Член группы основного сетевого адаптера — это сетевой адаптер, выбранный операционной системой из начального набора членов группы.
