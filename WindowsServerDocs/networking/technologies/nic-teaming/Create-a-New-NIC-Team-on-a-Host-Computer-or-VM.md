...
7.  В диспетчере Hyper-V в разделе **виртуальных машин**, щелкните правой кнопкой мыши виртуальную Машину, который требуется настроить, а затем нажмите кнопку **параметры**.  

   Виртуальная машина **параметры** откроется диалоговое окно.
...
13. Чтобы добавить второй сетевой адаптер, в диспетчере Hyper-V, в **виртуальных машин**, щелкните правой кнопкой мыши той же виртуальной Машине и нажмите кнопку **параметры**.  
...
2. В **свойства** области в первом столбце, найдите **объединение Сетевых карт**, а затем нажмите кнопку **отключено** ссылку.  

   **Объединение Сетевых карт** откроется диалоговое окно.
...
4. Нажмите кнопку **ЗАДАЧИ**и нажмите кнопку **добавьте новую команду**.  

   **Новая команда** диалоговое окно открывается и отображает сетевых адаптеров и члены команды.
...
7. Если вы хотите настроить имя интерфейса основной группы или назначить номер виртуальной локальной сети для Сетевых карт, щелкните ссылку справа от **интерфейса основной группы**.  

    **Новый интерфейс team** откроется диалоговое окно.

    ![Новый интерфейс team](../../media/Create-a-New-NIC-Team/nict_newteaminterface.jpg)
