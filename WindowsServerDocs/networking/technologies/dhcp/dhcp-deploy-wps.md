...
ms.locfileid: "68544661"
---
# <a name="deploy-dhcp-using-windows-powershell"></a>Развертывание DHCP с помощью Windows PowerShell

>Относится к: Windows Server (Semi-Annual Channel), Windows Server 2016

В этом руководство содержатся инструкции по развертыванию DHCP \(\) -сервера протокола динамической настройки узла протокола IP версии 4, который автоматически назначает IP-адреса и параметры DHCP DHCP-протоколу IPv4. Клиенты, подключенные к одной или нескольким подсетям в сети.
...
После завершения задач после\-установки, таких как создание групп безопасности и авторизация DHCP-сервера в Active Directory, диспетчер сервера может по-прежнему отображать предупреждение в пользовательском интерфейсе, в котором указано, что публикация\- шаги установки необходимо выполнить с помощью мастера настройки DHCP после установки.
