...
>[!NOTE]
>NPS форматирует данные учета как XML-документ, который отправляется в хранимую процедуру **report_event** в базе данных SQL Server, назначенной в NPS. Для правильной работы SQL Server ведения журнала необходимо иметь хранимую процедуру с именем **report_event** в базе данных SQL Server, которая может принимать и анализировать XML-документы из NPS.
