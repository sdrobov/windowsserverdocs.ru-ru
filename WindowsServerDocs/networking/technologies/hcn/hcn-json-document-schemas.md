---
title: Схемы документа JSON вычислительные сети (HCN) узла
description: ''
ms.author: jmesser
author: jmesser81
ms.date: 11/05/2018
...
## <a name="hcn-endpoint-schema"></a>Схема HCN конечной точки
...
## <a name="hcn-policy-schema"></a>Схема политики HCN
...
## <a name="hcn-load-balancer-schema"></a>Схема подсистемы балансировки нагрузки HCN
...
## <a name="hcn-namespace-schema"></a>Пространство имен схемы HCN
...
## <a name="hcn-notification-schema"></a>Схема HCN уведомлений
...
## <a name="result-error-schema"></a>Результат ошибки схемы
