...
## <a name="BKMK_IPAM2012R2"></a>Обновления на IPAM-сервере  
...
### <a name="EIP"></a>Улучшенное управление IP-адресами  
...
### <a name="EDNS"></a>Улучшенное управление службами DNS  
...
### <a name="DDI"></a>Интегрированное управление DNS, DHCP и IP-адрес (DDI)  
...
### <a name="bkmk_ad"></a>Поддержка нескольких Active Directory лесов  
