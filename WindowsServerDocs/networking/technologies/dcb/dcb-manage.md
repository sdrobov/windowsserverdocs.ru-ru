...
В этом разделе приведены инструкции по использованию команд Windows PowerShell для настройки моста \(\) карт в центре обработки данных на сетевом адаптере\-, совместимом с DCB, установленным на компьютере, на котором выполняется или Windows Server 2016 или Windows 10.
...
1.  Настройте параметры DCB на уровне системы, включая:
    ...
    1\. Управление классами трафика
    
    2\. Параметры управления потоком приоритета (коэффициент мощности)
