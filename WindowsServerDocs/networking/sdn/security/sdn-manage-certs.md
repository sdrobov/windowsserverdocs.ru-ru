...
3. На **действие** последовательно выберите пункты ** все задачи<strong>, а затем нажмите кнопку ** запросить новый сертификат</strong> для запуска мастера регистрации сертификатов. Нажмите кнопку **Далее**.
...
6. Разверните **сведения** раздела и настроить следующие элементы.
   1. Убедитесь, что **использование ключа** включает в себя <strong>цифровой подписи ** и ** шифрование ключей</strong>.
