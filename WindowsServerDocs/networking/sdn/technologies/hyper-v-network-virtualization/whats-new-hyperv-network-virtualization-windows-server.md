...
## <a name="BKMK_IPAM2012R2"></a>Обновления в HNV  
...
|--------------------------|-------------------|---------------|  
|[Программируемый коммутатор Hyper-V](../../../sdn/technologies/hyper-v-network-virtualization/../../../sdn/technologies/hyper-v-network-virtualization/../../../sdn/technologies/hyper-v-network-virtualization/../../../sdn/technologies/hyper-v-network-virtualization/whats-new-hyperv-network-virtualization-windows-server.md#SDN)|Новый|Политика HNV может быть программируемой через сетевой контроллер (Майкрософт).|  
|[Поддержка инкапсуляции ВКСЛАН](../../../sdn/technologies/hyper-v-network-virtualization/../../../sdn/technologies/hyper-v-network-virtualization/../../../sdn/technologies/hyper-v-network-virtualization/../../../sdn/technologies/hyper-v-network-virtualization/whats-new-hyperv-network-virtualization-windows-server.md#VXLAN)|Новый|HNV теперь поддерживает инкапсуляцию ВКСЛАН.|  
|[Взаимодействие Load Balancer программного обеспечения (SLB)](../../../sdn/technologies/hyper-v-network-virtualization/../../../sdn/technologies/hyper-v-network-virtualization/../../../sdn/technologies/hyper-v-network-virtualization/../../../sdn/technologies/hyper-v-network-virtualization/whats-new-hyperv-network-virtualization-windows-server.md#SLB)|Новый|HNV полностью интегрирован с программным обеспечением Майкрософт Load Balancer.|  
...
### <a name="SDN"></a>Программируемый коммутатор Hyper-V  
...
### <a name="VXLAN"></a>Поддержка инкапсуляции ВКСЛАН  
...
### <a name="SLB"></a>Взаимодействие Load Balancer программного обеспечения (SLB)  
...
### <a name="L2"></a>Соответствующие заголовки IEEE Ethernet  
