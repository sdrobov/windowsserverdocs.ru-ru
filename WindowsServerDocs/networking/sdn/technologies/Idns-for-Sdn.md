...
ms.locfileid: "80317256"
---
# <a name="internal-dns-service-idns-for-sdn"></a>Внутренняя служба DNS (iDNS) для SDN

>Область применения: Windows Server (Semi-Annual Channel), Windows Server 2016

Если вы работаете с поставщиком облачных служб \(CSP\) или Enterprise, который планирует развертывать программно определенную сеть \(SDN\) в Windows Server 2016, вы можете предоставить службы DNS для рабочих нагрузок размещенного клиента с помощью внутренней \(DNS\)iDNS, которая интегрирована с SDN.

Размещенные виртуальные машины \(виртуальным машинам\) и приложениям требуется, чтобы служба DNS могла обмениваться данными в своих сетях и с внешними ресурсами в Интернете. С помощью iDNS можно предоставить клиентам службы разрешения имен DNS для изолированного, локального пространства имен и для Интернет-ресурсов.
