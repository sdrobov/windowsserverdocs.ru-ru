...
Шлюз RAS теперь поддерживает три типа VPN-подключений типа "сеть — сеть":  Протокол IKE версии 2 (IKEv2) VPN типа "сеть — сеть" (VPN), уровня 3 (L3) и туннельного протокола GRE.  
...
## <a name="bkmk_pools"></a>Пулы шлюзов  
...
## <a name="bkmk_gps"></a>Масштабируемость пула шлюзов  
...
## <a name="bkmk_m"></a>Избыточность пула шлюзов M + N  
...
## <a name="bkmk_rr"></a>Отражатель маршрутов  
...
Дополнительные сведения см. в статье [архитектура развертывания шлюза RAS](RAS-Gateway-Deployment-Architecture.md) и запрос IETF для комментариев в разделе [RFC 4456. отражение маршрутов BGP: Альтернатива полной внутренней сети BGP (ИБГП) ](https://tools.ietf.org/html/rfc4456).  
