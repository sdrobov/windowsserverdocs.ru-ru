...
## <a name="bkmk_new"></a>Использование новых функций шлюза RAS для проектирования развертывания  
...
## <a name="bkmk_tenant"></a>Добавление новых клиентов и пространства (CA) eBGP пиринга  
...
## <a name="bkmk_route"></a>Синхронизация маршрутов и маршрутизация на плоскости данных  
...
## <a name="bkmk_failover"></a>Как сетевой контроллер отвечает на шлюз RAS и отработку отказа для отражения маршрута  
