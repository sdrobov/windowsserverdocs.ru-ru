...
#### [Развертывание сертификатов сервера для проводных и беспроводных развертываний со стандартом безопасности 802.1X](core-network-guide/cncg/server-certs/Deploy-Server-Certificates-for-802.1X-Wired-and-Wireless-Deployments.md)
...
#### [Развертывание беспроводного доступа с проверкой подлинности на основе паролей со стандартом безопасности 802.1X](core-network-guide/cncg/wireless/a-deploy-8021X-wireless-access.md)
...
###### [Настройка автоматического обнаружения размещенного кэша клиентом с использованием точки подключения служб](core-network-guide/cncg/bc-hcm/10-Bc-Client-By-Scp.md)
...
####### [Настройка серверов содержимого служб WindowsServerUpdateServices (WSUS)](branchcache/deploy/configure-wsus-content-servers.md)
...
####### [Настройка правил брандмауэра для элементов, не входящих в домен, для разрешения трафика BranchCache](branchcache/deploy/Configure-Firewall-Rules-for-Non-Domain-Members-to-Allow-BranchCache-Traffic.md)
...
#### [Использование политики DNS для балансировки нагрузки приложений с помощью сведений о географическом расположении](dns/deploy/app-lb-geo.md)
...
#### [Только программные функции и технологии](technologies/hpn/hpn-software-only-features.md)
#### [Программно и аппаратно интегрируемые компоненты и технологии](technologies/hpn/hpn-software-hardware-features.md)
#### [Только аппаратные функции и технологии](technologies/hpn/hpn-hardware-only-features.md)
...
### [Руководство по настройке конвергентных сетевых карт](technologies/conv-nic/cnic-top.md)
...
#### [Устранение неполадок в конвергентной сетевой карте](technologies/conv-nic/cnic-app-troubleshoot.md)
...
#### [Включение vRSS виртуальном сетевом адаптере](technologies/vrss/vrss-enable.md)
...
#### [Устранение проблем vRSS](technologies/vrss/vrss-resolve-issues.md)

## [API службы Host Compute Network (HCN)](technologies/hcn/hcn-top.md)   
### [Распространенные ситуации, в которых используется HCN](technologies/hcn/hcn-scenarios.md)
...
##### [Удаление записи ресурсов DNS](technologies/ipam/delete-DNS-Resource-Records.md)
...
##### [Имена сфер](technologies/nps/nps-crp-realm-names.md)
...
#### [Настройка групп внешних RADIUS-серверов](technologies/nps/nps-crp-rrsg-configure.md)
...
#### [Управление NPS](technologies/nps/nps-manage-servers.md)
...
##### [Отключение перенаправления уведомлений NAS](technologies/nps/nps-disable-nas-notifications.md)
...
### [Оптимизация производительности сетевых адаптеров](technologies/network-subsystem/net-sub-performance-tuning-nics.md)
...
### [Использование MAC-адресов в объединении сетевых карт и управление ими](technologies/nic-teaming/NIC-Teaming-MAC-address-Use-and-Management.md)
### [Создание группы сетевых карт на главном компьютере или в виртуальной машине](technologies/nic-teaming/create-a-New-NIC-Team-on-a-Host-computer-or-VM.md)
### [Диагностика объединения сетевых карт](technologies/nic-teaming/Troubleshooting-NIC-Teaming.md)
...
##### [Развертывание инфраструктуры SDN с помощью сценариев](sdn/deploy/Deploy-a-Software-Defined-Network-infrastructure-using-scripts.md)
...
##### [Развертывание сетевого контроллера с помощью WindowsPowerShell](sdn/deploy/Deploy-Network-Controller-using-Windows-powershell.md)
...
#### [Принцип работы службы времени Windows](windows-time-service/How-the-Windows-Time-Service-Works.md)
