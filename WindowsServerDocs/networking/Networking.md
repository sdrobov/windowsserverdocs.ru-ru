                         ...
                         <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                        <h2><a href="../networking/What-s-New-in-Networking.md">Что&#39;s, возможности работы с сетью</a></h2>
                                        </div>
                                    </div>
                                </div>
                             </div>
                         ...
                         <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <p><b>Примечание.</b> Для узлов Hyper-V и виртуальных машин (ВМ) под управлением серверов инфраструктуры SDN, такие как узлы сетевого контроллера и балансировка нагрузки программного обеспечения необходимо установить Windows Server Datacenter edition. Для узлов Hyper-V, содержащие только рабочую нагрузку клиентов виртуальных машин, которые подключены к сетям SDN управлением можно запустить Windows Server Standard edition.</p>                                        </div>
                                    </div>
                                </div>
                            </div>
                          </a>
                         ...
                         <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                        <h3><a href="sdn/deploy/Deploy-a-Software-Defined-Network-infrastructure-using-scripts.md">Развертывание инфраструктуры программно-определяемой сети с помощью сценариев</a><hr /></h3>Это руководство содержит инструкции по развертыванию сетевого контроллера с виртуальными сетями и шлюзами в тестовой лабораторной среде.</p>                                        </div>
                                    </div>
                                </div>
                            </div>
                          </a>
                         ...
                         <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                        <h3><a href="sdn/technologies/network-function-virtualization/Network-Function-Virtualization.md">Виртуализация сетевых функций</a><hr /></h3>В центрах обработки данных программно, сетевые функции, выполняемые аппаратными устройствами (например, подсистемы балансировки нагрузки, брандмауэры, маршрутизаторы, коммутаторы и т. д.) все чаще виртуализируются в виде виртуальных устройств. Это &quot;функция виртуализации сети&quot; является естественным этапом развития виртуализации серверов и виртуализации сети.</p>                                        </div>
                                    </div>
                                </div>
                            </div>
                          </a>
                         ...
                         <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                        <h3><a href="dns/dns-top.md">Система доменных имен (DNS)&quot;&gt;</a><hr /></h3>
                                        <p>Система доменных имен (DNS) является одним из стандартных в отрасли наборов протоколов, реализующих взаимодействие TCP/IP и обеспечивают DNS-клиент и DNS-сервер службы разрешения имен сопоставление имя IP-адрес компьютера для компьютеров и пользователей.</p>
                    </div>
                </div>
            </div>
        </div>
                         ...
                         <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <p>Конфигурация протокола DHCP (Dynamic Host) — это протокол клиент сервер, который автоматически предоставляет узел протокола Интернета (IP) с его IP-адреса и другие связанные данные конфигурации, такие как подсети маска и шлюз по умолчанию.</p>
                    </div>
                </div>
            </div>
        </div>
                         ...
                         <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <p>Балансировка сетевой нагрузки (NLB) распределяет трафик между несколькими серверами, используя сетевой протокол TCP/IP. Для развертываний отличных от SDN NLB обеспечивает приложений без отслеживания состояния, например веб-серверы под управлением Internet Information Services (IIS), масштабируемые путем добавления дополнительных серверов по мере увеличения нагрузки.</p>
                    </div>
                </div>
            </div>
        </div>
                         ...
                         <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                        <h3><a href="technologies/hpn/hpn-top.md">Высокой производительности сети</a><hr /></h3>
                                        ...
                                        <hr />
                                        <a href="technologies/conv-nic/cnic-top.md">Высокой производительности сети</a><hr />
                                        <a href="technologies/dcb/dcb-top.md">Мост центра обработки данных</a><hr />
                                        <a href="technologies/vrss/vrss-top.md">Виртуального масштабирования на стороне приема (vRSS)</a>
                    </div>
                </div>
            </div>
        </div>
                         ...
                         <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <p>
Можно использовать сетевой оболочки (netsh), сетевые подключения служебная программа для управления сетевые технологии в Windows Server 2016 и Windows 10.</p>
                    </div>
                </div>
            </div>
        </div>
                         ...
                         <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                        <h3><a href="technologies/nic-teaming/NIC-Teaming.md">Поддержка групп сетевых адаптеров</a><hr /></h3>
                                        <p>
                         ...
                         <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                        <h3><a href="technologies/qos/qos-policy-top.md">Политики качества обслуживания (QoS)</a><hr /></h3>
                                        <p>
                         ...
                         <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <p>
Можно использовать технологии удаленного доступа, такие как DirectAccess и виртуальной частной сети (VPN) для предоставления удаленным работникам с подключением к ресурсам внутренней сети. Кроме того можно использовать удаленный доступ для локальной сети (LAN) маршрутизации, а также для прокси веб-приложения. Он предоставляет функции обратного прокси-сервера для веб-приложений в корпоративной сети, что делает их доступными для пользователей с любых устройств из-за пределов корпоративной сети.</p>

                                        <p>Дополнительные сведения о прокси веб-приложения, которая является службой роли из роли сервера удаленного доступа, см. в разделе <a href="https://docs.microsoft.com/windows-server/remote/remote-access/web-application-proxy/web-application-proxy-windows-server">прокси веб-приложения в Windows Server 2016</a></p>
                    </div>
                </div>
            </div>
        </div>
...
Сетевые подключения контейнеров Windows позволяют создавать и контролировать сети ими для подключения конечных точек контейнеров на узлах Windows 10 и Windows Server с помощью стандартных средств и рабочих процессов. Сетевые подключения контейнеров Windows поддерживают несколько топологий, такие как частные, плоские уровня 2 и маршрутизируемые уровня 3.</p>
                                        ...
                                        <p>Также поддерживаются перекрытия, которые можно создавать локально на узле с помощью Docker, Kubernetes или Windows PowerShell через подключаемые модули, которые обмениваются данными с Windows узла сети службы (HNS). Можно создать и управлять сетями кластер с несколькими узлами через выше уровня оркестрации системы путем взаимодействия через локальный агент на каждом узле HNS.</p>
                    </div>
                </div>
            </div>
        </div>
...
DirectAccess и VPN являются службой роли в роли сервера удаленного доступа.</p>
                                        ...
                                        <p>При установке удаленного доступа в качестве VPN-сервера виртуальной частной сети (VPN) можно использовать для предоставления удаленных сотрудников с подключениями к сети организации через Интернет - одновременно сохраняя конфиденциальность с зашифрованных соединений .</p>
                                       ...
                                       <p>Дополнительные сведения см. в разделе <a href="https://docs.microsoft.com/windows-server/remote/remote-access/vpn/always-on-vpn/deploy/always-on-vpn-deploy">удаленного доступа всегда на VPN развертывания руководство для Windows Server 2016 и Windows 10</a></p>
                    </div>
                </div>
            </div>
        </div>
...
- Windows Server 2003 [Windows Server 2003 или Windows Server 2003 R2 устаревший контент](https://www.microsoft.com/download/details.aspx?id=53314)
