...
Сеть — это \(базовая часть платформы SDDC\) , определяемая программным обеспечением центра обработки данных, и Windows Server 2016 предоставляет новые и улучшенные\) программно определяемые сетевые \(технологии Sdn, которые помогут вам перейти к полностью реализованное решение SDDC для вашей организации.
                         ...
                         <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                        <h3><a href="sdn/deploy/Deploy-a-Software-Defined-Network-infrastructure-using-scripts.md">Развертывание программно-определяемой сетевой инфраструктуры с помощью сценариев</a><hr /></h3>Это руководство содержит инструкции по развертыванию сетевого контроллера с виртуальными сетями и шлюзами в тестовой лабораторной среде.</p>                                        </div>
                                    </div>
                                </div>
                            </div>
                          </a>
                         ...
                         <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                        <h3><a href="sdn/technologies/network-function-virtualization/RAS-Gateway-for-SDN.md">Шлюз RAS-сервера для SDN</a><hr /></h3>Шлюз RAS, который является маршрутизатором, поддерживающим программное обеспечение, клиент протокол BGP (BGP) в Windows Server 2016, предназначен для поставщиков облачных служб (CSP) и предприятий, где размещаются виртуальные сети клиентов с помощью сети Hyper-V. Технология.</p>                                        </div>
                                    </div>
                                </div>
                            </div>
                          </a>
                         ...
                         <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                        <h3><a href="sdn/technologies/network-function-virtualization/Network-Function-Virtualization.md">Виртуализация сетевой функции</a><hr /></h3>В программно определенных центрах обработки данных сетевые функции, выполняемые аппаратными устройствами (например, подсистемы балансировки нагрузки, брандмауэры, маршрутизаторы, коммутаторы и т. д.), все чаще виртуализованы как виртуальные устройства. &quot;Виртуализация&quot; сетевых функций — это естественный прогресс виртуализации серверов и виртуализации сети.</p>                                        </div>
                                    </div>
                                </div>
                            </div>
                          </a>
                         ...
                         <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                        <h3><a href="core-network-guide/core-network-guide-windows-server.md">Основное сетевое руководством</a><hr /></h3>
                         ...
                         <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                        <h3><a href="technologies/dhcp/dhcp-top.md">DHCP протокол &#40;динамической настройки узла&#41;</a><hr /></h3>
                         ...
                         <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                        <h3><a href="technologies/ipam/ipam-top.md">IPAM по управлению &#40;IP-адресами&#41;</a><hr /></h3>
                         ...
                         <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <a href="technologies/dcb/dcb-top.md">Мост центра обработки данных (DCB)</a><hr />
                         ...
                         <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <p>
Сетевую программу сетевой оболочки (Netsh) можно использовать для управления сетевыми технологиями в Windows Server 2016 и Windows 10.</p>
                    </div>
                </div>
            </div>
        </div>
