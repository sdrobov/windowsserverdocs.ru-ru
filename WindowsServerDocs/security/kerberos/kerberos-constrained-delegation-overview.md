...
Сведения о реализации этих расширений см. в разделе [ @ no__t-1 мс-SFU @ no__t-2: Расширения протокола Kerberos: Служба для спецификации протокола делегирования "пользователь и ограниченный" @ no__t-0 в MSDN.
