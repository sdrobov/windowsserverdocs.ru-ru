...
| Server | Управляет использованием SSL 2,0 на сервере SSL. |
...
| Server | Управляет использованием SSL 3,0 на сервере SSL. |
...
| Server | Управляет использованием TLS 1,0 на сервере TLS. |
...
| Server | Управляет использованием TLS 1,1 на сервере TLS. |
...
| Server | Управляет использованием TLS 1,2 на сервере TLS. |
...
| Server | Управляет использованием DTLS 1,0 на сервере DTLS. |
...
| Server | Управляет использованием DTLS 1,2 на сервере DTLS. |
