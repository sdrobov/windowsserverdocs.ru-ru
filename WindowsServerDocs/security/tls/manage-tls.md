...
Начиная с Windows 10 и Windows Server 2016, Windows предоставляет управление параметрами эллиптической кривой с помощью программы командной строки Certutil. exe.
Параметры эллиптической кривой хранятся в бкриптпримитивес. dll. С помощью программы Certutil. exe администраторы могут добавлять и удалять параметры кривой в Windows, соответственно. Программа Certutil. exe сохраняет параметры кривой безопасно в реестре.
