...
Подробную информацию о настройке приемников команд и соответствующих политик проверки подлинности см. в разделе [Настройка защищенных учетных записей](how-to-configure-protected-accounts.md).
...
### <a name="how-the-kerberos-protocol-is-used-with-authentication-policy-silos-and-policies"></a><a name="BKMK_HowKerbUsed"></a>Использование протокола Kerberos с приемниками и политиками проверки подлинности
...
### <a name="how-restricting-a-user-sign-in-works"></a><a name="BKMK_HowRestrictingSignOn"></a>Как выполняется Запрещение входа пользователя
...
### <a name="how-restricting-service-ticket-issuance-works"></a><a name="BKMK_HowRestrictingServiceTicket"></a>Как ограничиваются выдача билетов на обслуживание
...
## <a name="associated-error-and-informational-event-messages"></a><a name="BKMK_ErrorandEvents"></a>Связанные сообщения об ошибках и информационные события
...
Для устранения неполадок с помощью этих событий см. разделы [Устранение неполадок политик проверки подлинности](how-to-configure-protected-accounts.md#troubleshoot-authentication-policies) и [Диагностика конфликтов, связанных с группой защищенных пользователей](how-to-configure-protected-accounts.md#troubleshoot-events-related-to-protected-users).
