...
## <a name="BKMK_HowItWorks"></a>Как работает группа защищенных пользователей
...
> [!Note]
> После установки [рекомендаций по безопасности Microsoft 2871997](https://technet.microsoft.com/library/security/2871997) дайджест Windows будет продолжать кэшировать учетные данные до тех пор, пока не будет настроен раздел реестра. См. @no__t рекомендации по безопасности 0Microsoft: Обновление для улучшения защиты учетных данных и управления ими: 13 мая 2014 г. @ no__t-0. инструкции.
