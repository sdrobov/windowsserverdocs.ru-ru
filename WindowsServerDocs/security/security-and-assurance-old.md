...
### <a name="windows-server-security-blog-posthttpsblogstechnetmicrosoftcomwindowsserver20160425ten-reasons-youll-love-windows-server-2016-8-security"></a>[Windows Server Security в блоге](https://blogs.technet.microsoft.com/windowsserver/2016/04/25/ten-reasons-youll-love-windows-server-2016-8-security/)
...
### <a name="datacenter-and-private-cloud-security-bloghttpsblogstechnetmicrosoftcomdatacentersecurity"></a>[Центр обработки данных и блог по безопасности частного облака](https://blogs.technet.microsoft.com/datacentersecurity/)
...
### <a name="addressing-emerging-threats-and-landscape-shiftshttpswwwyoutubecomwatchvb5jmyxywx1kfeatureyoutube"></a>[Сдвигает адресации новых угроз и альбомной ориентации](https://www.youtube.com/watch?v=B5JMYxYWx1k&feature=youtu.be)
...
### <a name="protecting-your-datacenter-and-cloud-from-emerging-threats-blog-posthttpblogstechnetcombwindowsserverarchive20151118protecting-your-datacenter-and-cloud-november-updateaspx"></a>[Защита центра обработки данных и облака из блога Emerging Threats](http://blogs.technet.com/b/windowsserver/archive/2015/11/18/protecting-your-datacenter-and-cloud-november-update.aspx)
...
### <a name="security-and-assurance-overview-session-at-ignitehttpchannel9msdncomeventsignite2015brk2482"></a>[Сеанс безопасности и обзорный на конференции Ignite](http://channel9.msdn.com/events/ignite/2015/brk2482)
...
### <a name="shielded-vm-in-channel-9httpchannel9msdncomshowsmechanicsintroduction-to-shielded-virtual-machines-in-windows-server-2016"></a>[Экранированная виртуальная машина в Channel 9](http://channel9.msdn.com/Shows/Mechanics/Introduction-to-Shielded-Virtual-Machines-in-Windows-Server-2016)
...
### <a name="harden-the-fabric-protecting-tenant-secrets-in-hyper-v-ignite-videohttpchannel9msdncomeventsignite2015brk3457"></a>[Усиление защиты структуры: Защита секретов клиента в Hyper-V (видео конференции Microsoft Ignite)](http://channel9.msdn.com/events/ignite/2015/brk3457)
...
### <a name="shielded-vm-articlehttpwindowsitprocomhyper-vsuper-secure-hyper-v-environments-shielded-vms-2016"></a>[Статья экранированной виртуальной Машины](http://windowsitpro.com/hyper-v/super-secure-hyper-v-environments-shielded-vms-2016)
...
### <a name="protecting-windows-and-microsoft-azure-active-directory-with-privileged-access-managementhttpchannel9msdncomeventsignite2015brk3873"></a>[Защита Windows и Microsoft Azure Active Directory с помощью управления привилегированным доступом](http://channel9.msdn.com/events/ignite/2015/brk3873)
...
### <a name="just-enough-administration-articlehttpakamsjea"></a>[Достаточно статье администрирования](http://aka.ms/JEA)
...
### <a name="just-enough-administration-demo-videohttpswwwyoutubecomwatchvxnbrbky9p20"></a>[Просто Enough Administration демонстрационное видео](https://www.youtube.com/watch?v=xnBrbkY9P20)
...
### <a name="windows-defender-application-control-wdac-deployment-guidehttpsdocsmicrosoftcomwindowssecuritythreat-protectionwindows-defender-application-controlwindows-defender-application-control"></a>[Руководство по развертыванию Windows Defender приложения управления (DAC WDAC)](https://docs.microsoft.com/windows/security/threat-protection/windows-defender-application-control/windows-defender-application-control)
...
### <a name="device-guard-demo-videohttpswwwyoutubecomwatchvf-ptkesjkhi"></a>[Устройство Guard демонстрационное видео](https://www.youtube.com/watch?v=F-pTkesjkhI)
...
### <a name="transport-layer-security-registry-settingshttpsdocsmicrosoftcomwindows-serversecuritytlstls-registry-settings"></a>[Настройки реестра для уровня безопасности транспорта](https://docs.microsoft.com/windows-server/security/tls/tls-registry-settings)
...
### <a name="oms-and-windows-serverhttpswwwyoutubecomwatchvsadw1dry2k"></a>[OMS и Windows Server](https://www.youtube.com/watch?v=_SaDw1dRy2k)
...
### <a name="whats-new-in-dns-in-windows-serverhttpstechnetmicrosoftcomwindows-server-docsnetworkingdnswhat-s-new-in-dns-server"></a>[Новые возможности DNS в Windows Server](https://technet.microsoft.com/windows-server-docs/networking/dns/what-s-new-in-dns-server)
...
-   [Технический документ по сопоставлению соответствия экранированных виртуальных машин Hyper-V](https://download.microsoft.com/download/6/D/0/6D06E149-B4C1-4EED-ACD5-DF6066E93CC0/Coalfire_Branded_Hyper_V_Shielded_VMs_Whitepaper_EN_US.pdf)

-   [JEA и JIT соответствия Технический документ по сопоставлению](https://download.microsoft.com/download/2/7/A/27A2B5BB-6B52-4482-87C1-DA9D6B6D8C8D/Coalfire_Branded_Privileged_Identity_Manager_Whitepaper_EN_US.pdf)

-   [Технический документ по сопоставлению соответствия устройства Guard](https://download.microsoft.com/download/6/9/D/69D9E610-D23C-4F7E-A8CC-D65B87CEB4F8/Coalfire_Branded_Device_Guard_Whitepaper_EN_US.pdf)

-   [Credential Guard Технический документ по сопоставлению соответствия](https://download.microsoft.com/download/8/1/2/812009C9-E4B8-4D4B-AADD-FDC373D0A076/Coalfire_Branded_Credential_Guard_Whitepaper_EN_US.pdf)

-   [Технический документ по сопоставлению соответствия Защитника Windows](https://download.microsoft.com/download/C/7/7/C778B7BB-0783-42D7-93A9-B86DFB5A7BAD/Coalfire_Branded_Windows_Defender_Whitepaper_EN_US.pdf)
