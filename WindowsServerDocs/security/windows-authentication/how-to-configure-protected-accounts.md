...
-   Отклонять проверку подлинности NTLM: можно настроить только с помощью [политик блокировки NTLM](https://technet.microsoft.com/library/jj865674(v=ws.10).aspx).  
