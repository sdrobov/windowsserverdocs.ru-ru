...
-   [Защищенных пользователей](how-to-configure-protected-accounts.md#BKMK_AddtoProtectedUsers)  
...
## <a name="BKMK_AddtoProtectedUsers"></a>Защищенных пользователей  
...
### <a name="BKMK_TrubleshootingEvents"></a>Устранение неполадок событий, связанных с защищенными пользователями  
...
### <a name="BKMK_ProvidePUdcProtections"></a>Обеспечивают средства защиты со стороны контроллера домена для служб и компьютеров  
...
Дополнительные сведения см. в разделе [Kerberos версии 5 протокола принцип действия проверки подлинности] (https://technet.microsoft.com/library/cc772815(v=WS.10.aspx.  
...
### <a name="BKMK_TroubleshootAuthnPolicies"></a>Устранение неполадок с политиками проверки подлинности  
...
### <a name="BKMK_ManageAuthnSilosUsingPSH"></a>Управление приемники команд политик проверки подлинности с помощью Windows PowerShell  
