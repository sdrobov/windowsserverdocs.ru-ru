...
-   [\[MS-ДПСП\]: расширения протокола Digest](https://msdn.microsoft.com/library/cc227906(PROT.13).aspx)
...
-   [\[MS-ТЛСП\]: профиль протокола TLS](https://msdn.microsoft.com/library/dd207968(PROT.13).aspx)
...
-   [\[MS-СПНГ\]: простые и защищенные расширения механизма согласования API GSS (SPNEGO)](https://msdn.microsoft.com/library/cc247021(PROT.13).aspx)

-   [\[MS-N2HT\]: Negotiate и Nego2 спецификация протокола проверки подлинности HTTP](https://msdn.microsoft.com/library/dd303576(PROT.13).aspx)
