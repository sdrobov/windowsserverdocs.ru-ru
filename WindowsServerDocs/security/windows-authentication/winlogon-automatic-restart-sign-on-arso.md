...
## <a name="group-policy-sign-in-last-interactive-user-automatically-after-a-system-initiated-restart"></a>Групповая политика: Автоматический вход последнего интерактивного пользователя после инициирования системой перезапуска  
...
|Имя значения|Type|Data|  
|-------|----|----|  
|дисаблеаутоматикрестартсигнон|DWORD|0<br /><br />**Например**<br /><br />0 (включено)<br /><br />1 (отключено)|  
...
**Table SEQ Table \\ @ no__t-2 Арабский 3: АРСО Глоссарий @ no__t-0  
