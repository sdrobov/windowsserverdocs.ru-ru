...
nCipher nShield        | Убедитесь, что каждый узел HGS имеет доступ к системе безопасности, содержащий ключи подписывания и шифрования. Необходимо настроить разрешения для групповой управляемой учетной записи.
