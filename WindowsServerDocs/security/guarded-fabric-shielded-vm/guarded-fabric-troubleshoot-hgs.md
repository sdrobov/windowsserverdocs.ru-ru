...
nCipher nShield        | Убедитесь, что каждый узел HGS имеет доступ к всему миру безопасности, содержащему ключи подписывания и шифрования. Не нужно настраивать разрешения, относящиеся к gMSA.
