...
2. Узел запрашивает аттестацию.
    ...
    **Аттестация, доверенная администратором**: Узел Hyper-V отправляет билет Kerberos, который определяет группы безопасности, в которых находится узел. HGS проверяет, принадлежит ли узел к группе безопасности, которую ранее настроил доверенный администратор HGS.
