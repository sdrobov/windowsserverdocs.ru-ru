...
2. Получите политику целостности кода, созданную администратором структуры для узлов в двоичном формате (@no__t -0. p7b). Скопируйте его на сервер HGS. Затем выполните следующую команду.
