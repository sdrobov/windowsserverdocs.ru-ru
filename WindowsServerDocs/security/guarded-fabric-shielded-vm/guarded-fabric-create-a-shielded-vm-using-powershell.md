...
Если вы используете корпоративную среду и можете взаимодействовать с сервером HGS, метаданные опекуна доступны на сайте *http://\<HGSCLUSTERNAME @ no__t-2/кэйпротектион/Service/Metadata/2014-07/Metadata. XML*
...
Просмотрите содержимое справки, используя `Get-Help New-ShieldedVM -Full`, чтобы узнать больше о других параметрах, которые можно передать в командлет.
