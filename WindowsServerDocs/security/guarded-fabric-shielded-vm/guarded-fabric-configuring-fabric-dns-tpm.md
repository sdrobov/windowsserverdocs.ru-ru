---
title: Настройте структуру DNS для защищенных узлов (TPM)
ms.custom: na
...
- [Действия по настройке для узлов Hyper-V, которые станут защищенных узлов](guarded-fabric-configure-hgs-with-authorized-hyper-v-hosts.md)
