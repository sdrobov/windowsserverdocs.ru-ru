---
title: Сравнение выпусков Standard и Datacenter Windows Server 2019
ms.custom: na
...
ms.locfileid: "59854135"
---
# <a name="comparison-of-standard-and-datacenter-editions-of-windows-server-2019"></a>Сравнение выпусков Standard и Datacenter Windows Server 2019

> Область применения. Windows Server 2019
  
## <a name="locks-and-limits"></a>Блокировки и ограничения
|Блокировки и ограничения|Windows Server 2019 Standard|Центр обработки данных Windows Server 2019 г.|  
|-------------------|----------|---------------------------|  
...
|Доступны роли Windows Server|Службы ролей|Windows Server 2019 Standard|Центр обработки данных Windows Server 2019 г.|  
|-------------------|----------|----------|---------------------------|  
...
* WDS транспортного сервера является новой возможностью в установках основных серверных компонентов в Windows Server 2019 (а также в полугодовой канал, начиная с Windows Server версии 1803)


## <a name="features"></a>Компоненты

|Компоненты Windows Server, доступные для установки с помощью диспетчера серверов (или PowerShell)|Windows Server 2019 Standard|Центр обработки данных Windows Server 2019 г.|  
|-------------------|----------|---------------------------|  
...
|Общедоступные компоненты|Windows Server 2019 Standard|Центр обработки данных Windows Server 2019 г.|  
|-------------------|----------|---------------------------|  
|Анализатор соответствия рекомендациям|Да|Да|
|Реплика ограниченного хранилища|Да, (1 партнерства и 1 группа ресурсов с томом единый 2 ТБ)|Да, неограниченное|
|Прямой доступ|Да|Да|
