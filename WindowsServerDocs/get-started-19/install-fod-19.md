...
Серверы под управлением Windows Server, 1903 и более поздних версий также поддерживают следующие компоненты (если используется та же версия FOD совместимости приложений):
