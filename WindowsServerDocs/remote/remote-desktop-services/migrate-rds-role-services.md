...
> [!IMPORTANT]
> Переносите коллекции сеансов только после успешного завершения предыдущего шага, [серверов перенести посредника подключений к удаленному рабочему Столу](#migrate-rdconnection-broker-servers).
...
> [!IMPORTANT]
> Перенос коллекций виртуальных рабочих столов только после успешного завершения предыдущего шага, [серверов перенести посредника подключений к удаленному рабочему Столу](#migrate-rdconnection-broker-servers).
