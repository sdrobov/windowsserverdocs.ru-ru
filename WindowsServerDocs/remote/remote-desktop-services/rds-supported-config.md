...
|---|---|---|---|
 ...
 |Посредник подключений Windows Server 2016|Нет данных|Поддерживается|Поддерживается|
 |Посредник подключений Windows Server 2012 R2|Нет данных|Нет данных|Не поддерживается|
...
Благодаря узлам сеансов служб удаленных рабочих столов односеансовые клиентские операционные системы могут воспользоваться преимуществами физических или виртуальных графических процессоров, представляемых в операционной системе разнообразными способами, включая [размеры виртуальных машин, оптимизированных для графических процессоров Azure](/en-us/azure/virtual-machines/windows/sizes-gpu); графические процессоры, доступные для физического сервера RDSH; процессоры vGPU RemoteFX (только в Windows Server 2016) и графические процессоры, предоставляемые виртуальным машинам поддерживаемыми гипервизорами.
...
Графические процессоры, представленные гипервизорами или облачной платформой сторонних производителей, должны иметь драйверы с цифровой подписью WHQL, предоставляемые поставщиком GPU.
