...
|-----------|---------|
|Общие     |1.2.945  |
|Предварительная оценка    |1.2.1009 |

## <a name="updates-for-version-121009"></a>Обновления для версии 1.2.1009

*Дата публикации: 12.05.2020*

Скачать: [Windows (64-разрядная версия)](https://query.prod.cms.rt.microsoft.com/cms/api/am/binary/RE4wseE), [Windows (32-разрядная версия)](https://query.prod.cms.rt.microsoft.com/cms/api/am/binary/RE4wnf3), [Windows (ARM64)](https://query.prod.cms.rt.microsoft.com/cms/api/am/binary/RE4wCIB)
