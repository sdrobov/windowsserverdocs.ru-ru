...
| Указатель мыши | Масштабирование                 | Сведение двумя пальцами для увеличения или их разведение для уменьшения. |

> [!TIP]
> Вопросы и комментарии всегда приветствуются. Тем не менее не стоит публиковать запрос для получения справки по устранению неполадок, используя область комментариев в конце этой статьи. Вместо этого перейдите на [форум по клиенту удаленного рабочего стола](https://social.technet.microsoft.com/forums/windowsserver/en-us/home?forum=winrdc) и начните новую беседу. Есть предложение по новым функциям? Расскажите нам о ней в [Центре отзывов](feedback-hub://?tabid=2&contextid=605).
