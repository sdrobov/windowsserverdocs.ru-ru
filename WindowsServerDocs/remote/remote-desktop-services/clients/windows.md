---
title: Начало работы с удаленными рабочими столами в Windows
description: Базовая настройка клиента удаленного рабочего стола в Windows.
ms.custom: na
...
---
# <a name="get-started-with-remote-desktop-on-windows"></a>Начало работы с удаленными рабочими столами в Windows
