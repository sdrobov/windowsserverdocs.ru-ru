---
title: Начало работы с удаленными рабочими столами в Android
...
---
# <a name="get-started-with-remote-desktop-on-android"></a>Начало работы с удаленными рабочими столами в Android
...
2. Введите следующие сведения:
   - **Имя сервера** — имя компьютера, который будет использоваться в качестве шлюза. Это может быть имя компьютера с ОС Windows, имя домена в Интернете или IP-адрес. Вы также можете добавить сведения о порте к имени сервера (например, **RDGateway:443** или **10.0.0.1:443**).
