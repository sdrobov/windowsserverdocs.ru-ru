...
4. Вы также можете нажать **Show additional options** (Показать дополнительные параметры), чтобы задать следующие необязательные параметры.
   ...
   - Параметр **Настроить разрешение экрана** задает разрешение экрана для удаленного сеанса. Если этот параметр отключен, то используется разрешение, указанное в глобальных параметрах.   
   - Параметр **Переключить кнопки мыши** переключает команды, отправляемые при жестах с использованием правой и левой кнопок мыши. Идеально подходит для пользователей-левшей.
...
Клиент Удаленного рабочего стола поддерживает закрепление подключений на начальном экране с помощью функции мини-приложения Android. Способ добавления мини-приложения зависит от типа используемого устройства Android и его операционной системы. Вот наиболее распространенный способ добавления мини-приложения:
...
- **Помогите улучшить Удаленный рабочий стол** отправляет в Майкрософт анонимные данные о том, как вы используете Удаленный рабочий стол для Android. Мы используем эти данные, чтобы улучшить клиент. Дополнительные сведения о политике конфиденциальности и типах собираемых данных см. в [Заявлении о конфиденциальности корпорации Майкрософт](https://privacy.microsoft.com/privacystatement). Эта настройка включена по умолчанию.
