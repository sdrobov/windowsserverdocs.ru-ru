...
Возможно, вы знакомы с нашим представлением о современной инфраструктуре для Удаленного рабочего стола. Возможно, вам также встречался акроним RDmi. Все это касается Виртуального рабочего стола Windows. Узнайте больше на [странице документации по Виртуальному рабочему столу Windows](https://docs.microsoft.com/azure/virtual-desktop/).
