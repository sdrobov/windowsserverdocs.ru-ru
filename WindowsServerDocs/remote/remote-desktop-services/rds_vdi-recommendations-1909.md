...
Дополнительные сведения об индикаторе работоспособности сетевых подключений (NCSI) см. в статьях [Управление конечными точками подключений для Windows 10 Корпоративная, версия 1903](https://docs.microsoft.com/windows/privacy/manage-windows-1903-endpoints) и [Управление подключениями к службам Майкрософт из компонентов операционной системы Windows 10](https://docs.microsoft.com/windows/privacy/manage-connections-from-windows-operating-system-components-to-microsoft-services).
