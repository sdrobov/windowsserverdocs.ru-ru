...
||Don’t search the web or display web results in Search (Не выполнять поиск в Интернете и не отображать результаты из Интернета в поиске)|        Enabled|
