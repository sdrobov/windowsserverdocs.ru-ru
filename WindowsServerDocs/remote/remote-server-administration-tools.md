...
#### <a name="BKMK_installthresh"></a>Скачивание пакета средств удаленного администрирования сервера для установки средств для Windows 10
...
>- [Remote Server Administration Tools (RSAT) for Windows Client and Windows Server (dsforum2wiki)](https://go.microsoft.com/fwlink/p/?LinkID=221055) (Средства удаленного администрирования сервера (RSAT) для клиентов Windows и Windows Server (dsforum2wiki))
