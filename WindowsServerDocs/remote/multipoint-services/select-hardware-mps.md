...
## <a name="BKMK_Selectingdirect-video-connectedorUSBzeroclientstationdevices"></a>Выбор Direct\-видео\-подключенными или USB-устройствами с нулевой клиентской станцией  
...
## <a name="BKMK_SelectingRDP-over-LAN-connectedstationhardware"></a>Выбор протокола RDP\-через\-подключение к локальной сети\-устройство подключенной станции  
