...
> [!NOTE]  
> Виртуализация сети Hyper-V — это технология сетевого перекрытия, использующая сетевое инкапсуляцию сетевой виртуализации ([NVGRE](https://tools.ietf.org/html/draft-sridharan-virtualization-nvgre-00)), которая позволяет клиентам использовать свое адресное пространство и обеспечивает лучшую масштабируемость CSP, чем возможно с помощью VLAN для изоляции клиентов.  
...
## <a name="bkmk_features"></a>Возможности шлюза RAS  
...
## <a name="bkmk_manage"></a>Средства управления шлюзами RAS  
