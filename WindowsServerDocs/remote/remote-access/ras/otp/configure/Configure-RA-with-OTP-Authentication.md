...
- [Шаг 1. Реализация развертывания одного сервера удаленного доступа](../../multisite/configure/Step-1-Implement-a-Single-Server-Remote-Access-Deployment.md). Установите и настройте сервер удаленного доступа. Инструкции см. в разделе [развертывание одиночного сервера DirectAccess с расширенными параметрами](https://technet.microsoft.com/windows-server-docs/networking/remote-access/directaccess/single-server-advanced/deploy-a-single-directaccess-server-with-advanced-settings).

- [Шаг 2. Настройки сервера RADIUS](Step-2-Configure-the-RADIUS-Server.md).

- [Шаг 3. Настройка сервера удаленного доступа для OTP](Step-3-Configure-the-Remote-Access-Server-for-OTP.md).

- [Шаг 4. Проверка функции DirectAccess с помощью OTP](Step-4-Verify-DirectAccess-with-OTP.md).
