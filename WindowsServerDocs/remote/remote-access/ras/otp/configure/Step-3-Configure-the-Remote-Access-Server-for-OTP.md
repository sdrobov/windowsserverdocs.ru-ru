...
## <a name="BKMK_Exempt"></a>3,1 исключение пользователей из проверки подлинности OTP (необязательно)  
...
## <a name="BKMK_Config"></a>3,2. Настройка сервера удаленного доступа на поддержку OTP  
...
4.  Если требуется поддержка Windows 7, установите флажок **разрешить клиентским компьютерам Windows 7 подключаться с помощью DirectAccess** . Примечание. Как обсуждалось в разделе Планирование, для поддержки DirectAccess с OTP на клиентах Windows 7 должен быть установлен DCA 2,0.  
...
0Windows команды PowerShell для](../../../../media/Step-3-Configure-the-Remote-Access-Server-for-OTP/PowerShellLogoSmall.gif)**Windows powershell** @no__t  
...
## <a name="BKMK_Smartcard"></a>3,3. смарт-карты для дополнительной авторизации  
...
### <a name="under-the-covers-smart-card-authorization"></a>На самом деле: Авторизация смарт-карт  
