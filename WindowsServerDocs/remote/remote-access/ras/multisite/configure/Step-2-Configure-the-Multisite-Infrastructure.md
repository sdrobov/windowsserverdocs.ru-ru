...
## <a name="BKMK_ConfigAD"></a>2,1. Настройка дополнительных сайтов Active Directory  
...
0Windows команды PowerShell для](../../../../media/Step-2-Configure-the-Multisite-Infrastructure/PowerShellLogoSmall.gif)***<em>Windows PowerShell</em> @no__t***  
...
5.  Чтобы добавить компьютеры в новую группу безопасности, дважды щелкните группу безопасности, а затем в диалоговом окне **< Group_Name > свойства** откройте вкладку **члены** .  
...
### <a name="DCMaintandDowntime"></a>Обслуживание контроллера домена и время простоя  
...
#### <a name="TransferPDC"></a>Перенос роли эмулятора PDC  
...
#### <a name="ChangeDC"></a>Изменение контроллера домена, управляющего объектами групповой политики сервера  
...
### <a name="ChangeTwoDCs"></a>Изменение двух или более контроллеров домена, управляющих объектами групповой политики сервера  
...
### <a name="ConfigDistOptimization"></a>Оптимизация распределения конфигурации  
...
-   [Шаг 3. Настройка многосайтового развертывания @ no__t-0  
-   [Шаг 1. Реализация одного сервера развертывание удаленного доступа @ no__t-0  
