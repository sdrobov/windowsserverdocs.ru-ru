...
-   **Выпуск 1**  
    ...
    **Решение**  
    ...
    2.  В мастере **установки сервера инфраструктуры** на странице **сервер сетевого расположения** на сервере удаленного доступа должен быть установлен флажок **использовать самозаверяющий сертификат** , а затем, если он **развернут на**сервере. Нажмите кнопку **Обзор** , чтобы выбрать сертификат, ВЫДАННЫЙ центром сертификации предприятия.  
...
**Произошла ошибка**. Сервер < имя_сервера > не связан с сайтом Active Directory.  
