...
Если сервер сетевого расположения размещен на сервере удаленного доступа, необходимо добавить запись DNS для веб-сайта сервера сетевого расположения для каждой точки входа в развертывании. Примите к сведению следующее.  
