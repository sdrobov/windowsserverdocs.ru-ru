...
5.  На странице **Управление** добавьте серверы управления, которые не обнаруживаются автоматически, а затем нажмите кнопку **Далее**. Служба удаленного доступа автоматически добавляет контроллеры домена и серверы System Center Configuration Manager.  
