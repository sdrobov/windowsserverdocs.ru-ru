...
## <a name="configure-routing-in-the-corporate-network"></a><a name="BKMK_ConfigRouting"></a>Настройка маршрутизации в корпоративной сети  
...
5.  Повторите этот процесс для directaccess-corpconnectivityhost и вручную созданных средств проверки. В диалоговом окне **DNS** нажмите кнопку **ОК**.  
