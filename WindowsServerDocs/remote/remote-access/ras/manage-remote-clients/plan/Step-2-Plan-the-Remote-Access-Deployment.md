...
> [!NOTE]  
> Прежде чем продолжить выполнение этих задач, см. раздел [Step 1. Спланируйте инфраструктуру удаленного доступа @ no__t-0.  
...
-   **Топология сети**  
    ...
    -   **Два адаптера**: При наличии двух сетевых адаптеров для удаленного доступа можно настроить один сетевой адаптер, подключенный напрямую к Интернету, и другой, подключенный к внутренней сети. Или же сервер устанавливается за пограничным устройством, например брандмауэром или маршрутизатором. В этой конфигурации один сетевой адаптер подключен к сети периметра, а другой подключен к внутренней сети.  
