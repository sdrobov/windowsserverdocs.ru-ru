...
## <a name="BKMK_Prefix"></a>3,1. Настройка префикса IPv6  
  
### <a name="configDA"></a>Настройка префикса  
...
## <a name="BKMK_NLB"></a>3,2. Включение балансировки нагрузки  
...
## <a name="BKMK_InstallIPHTTP"></a>3,3. Установка сертификата IP-HTTPS  
...
5.  На странице **Добро пожаловать на страницу мастера экспорта сертификатов** нажмите кнопку **Далее**.  
...
## <a name="BKMK_NLS"></a>3,4. Установка сертификата сервера сетевого расположения  
Чтобы выполнить эту процедуру, вы должны быть членом локальной группы **Администраторы** или аналогичной.  
...
## <a name="BKMK_Add"></a>3,5. Добавление серверов в кластер  
