...
| ---- | ---- |
| диспетчер конфигураций | Создайте коллекцию пользователей на основе членства в этой группе безопасности.<br><br>![](../../media/DA-to-AlwaysOnVPN/b38723b3ffcfacd697b83dd41a177f66.png)!|
