...
> Относится к: Windows Server 2019, Windows Server (половина ежегодного канала), Windows Server 2016, Windows Server 2012 R2, Windows 10

- [**Очеред** Шаг 3. Настройка сервера удаленного доступа для постоянно подключенного VPN-профиля](vpn-deploy-ras.md)
- [**Очеред** Шаг 5. Настройка параметров DNS и брандмауэра](vpn-deploy-dns-firewall.md)
...
6. В разделе Настройка методов проверки подлинности выполните следующие действия.
    ...
    3. В поле Тип (на основе метода доступа и конфигурации сети) выберите **Майкрософт: Защищенный EAP (PEAP**), а затем выберите **Настройка**.
