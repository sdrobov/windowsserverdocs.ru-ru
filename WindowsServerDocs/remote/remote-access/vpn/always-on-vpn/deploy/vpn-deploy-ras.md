...
- [**Прошлом** Шаг 2. Настройка серверной инфраструктуры](vpn-deploy-server-infrastructure.md)
- [**Прошлом** Шаг 4. Установка и настройка сервера политики сети (NPS)](vpn-deploy-nps.md)
...
11. В окне Свойства перейдите на вкладку **Безопасность** и выполните следующие действия.
    ...
    1\. Выберите **поставщик проверки подлинности** и выберите **Проверка подлинности RADIUS**.
    ...
    Г. В поле **имя сервера**введите полное доменное имя (FQDN) сервера политики сети в вашей организации или корпоративной сети.
    ...
    f. В поле **новый секрет**введите текстовую строку.
...
17. Используемых *Если вы настраиваете условный доступ для VPN-подключения*, в консоли управления "NPS" разверните узел **политики\\политики сети** и выполните следующие действия. 
    ...
    1\. Правой кнопкой мыши щелкните **подключения к сетевой политике сервера маршрутизации и удаленного доступа Майкрософт** и выберите **свойства**.

    2\. Выберите доступ **с предоставлением доступа. Предоставить доступ, если запрос на подключение соответствует этому** параметру политики.
...
19. Выберите **Минипорт WAN (SSTP)** и щелкните **Configure (настроить**). Откроется диалоговое окно Настройка мини-порта устройства WAN (SSTP).
    ...
    1\. Снимите флажки **подключения удаленного доступа (только входящие)** и **подключения с маршрутизацией вызовов по требованию (входящие и исходящие)** .
...
20. Выберите **Минипорт WAN (L2TP)** и щелкните **Configure (настроить**). Откроется диалоговое окно Настройка мини-порта устройства WAN (L2TP).
    ...
    1\. В поле **Максимальное число портов**введите количество портов в соответствии с максимальным количеством одновременных VPN-подключений, которые требуется поддерживать.
