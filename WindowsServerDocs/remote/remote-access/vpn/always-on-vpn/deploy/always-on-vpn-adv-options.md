...
&#171;  [**Предыдущих:** Дополнительные сведения о технологии AlwaysOn VPN](../always-on-vpn-technology-overview.md)<br>
&#187; [ **Next:** Начать планирование развертывания AlwaysOn VPN](always-on-vpn-deploy-planning.md)
...
**Аттестация ключей доверенного платформенного модуля (TPM)**<p>
