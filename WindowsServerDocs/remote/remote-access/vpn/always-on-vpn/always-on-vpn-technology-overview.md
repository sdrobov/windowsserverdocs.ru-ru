...
- [Обзор служб сертификации Active Directory](https://technet.microsoft.com/library/hh831740.aspx). в этом документе приведены общие сведения о Active Directory служб сертификации (AD CS) в Windows Server&reg; 2012. AD CS — это роль сервера, которая позволяет организации создать инфраструктуру открытых ключей (PKI) и использовать шифрование с открытым ключом, цифровые сертификаты и цифровые подписи.
