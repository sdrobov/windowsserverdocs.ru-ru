...
## <a name="EDGE1"></a>Тестирование подключения DirectAccess из Интернета через EDGE1  
...
## <a name="secgroup"></a>Перемещение КЛИЕНТ2 в группу безопасности Win7_Clients_Site2  
...
## <a name="DAConnect"></a>Проверка подключения DirectAccess из Интернета через 2-EDGE1  
