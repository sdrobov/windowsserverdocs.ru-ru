...
## <a name="TCP"></a>Настройка TCP/IP на RSA  
...
## <a name="copyinstfiles"></a>Копирование файлов установки диспетчера проверки подлинности на сервер RSA  
...
## <a name="JoinDomain"></a>Присоединение сервера RSA к домену CORP  
...
## <a name="BKMK_Firewall"></a>Отключить брандмауэр Windows на RSA  
...
## <a name="install"></a>Установка диспетчера проверки подлинности RSA на сервере RSA  
...
## <a name="confiauthmgr"></a>Настройка диспетчера проверки подлинности RSA  
...
12. Создайте файл секрета узла для сервера EDGE1 (EDGE1_NodeSecret. zip).  
    ...
    7.  Из диспетчера проверки подлинности RSA Media Copy \auth_mgr\windows-x86_64\am\rsa-ace_nsload\win32-5.0-x86\agent_nsload.exe в К:\РСА.  
  
## <a name="BKMK_DAProbeUser"></a>Создание Дапробеусер  
...
## <a name="InstToken"></a>Установка токена программного обеспечения RSA SecurID на компьютере КЛИЕНТ1  
...
9. Нажмите кнопку **Обзор**, выберите к:\рса Files\User1_000031701832.SDTID и нажмите кнопку **Открыть**.  
  
10. Щелкните дважды **ОК** .  
  
## <a name="configAuthAgt"></a>Настройка EDGE1 в качестве агента проверки подлинности RSA  
...
4. Скопируйте agent_nsload. exe в C:\Windows\SysWOW64 @ no__t-0.  
