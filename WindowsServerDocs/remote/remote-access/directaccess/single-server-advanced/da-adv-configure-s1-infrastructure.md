...
## <a name="11-configure-server-network-settings"></a><a name="ConfigNetworkSettings"></a>1,1. Настройка параметров сети сервера  
...
### <a name="to-create-the-network-location-server"></a><a name="NLS_DNS"></a>Создание сервера сетевого расположения  
