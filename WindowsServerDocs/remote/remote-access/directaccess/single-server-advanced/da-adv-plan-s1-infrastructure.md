...
-   [1.1.1. Планирование сетевых адаптеров и IP-адреса](#111-plan-network-adapters-and-ip-addressing)  
...
-   [1.3.3. Планирование сертификатов веб-сайт для сервера сетевых расположений](#133-plan-website-certificates-for-the-network-location-server)  
