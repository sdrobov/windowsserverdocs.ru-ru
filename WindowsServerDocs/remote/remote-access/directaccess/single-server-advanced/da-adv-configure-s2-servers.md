...
ход выполнения установки ![выполнение](../../../media/Step-2-Configuring-DirectAccess-Servers/PowerShellLogoSmall.gif)***<em>эквивалентных команд Windows PowerShell</em>***  
...
![](../../../media/Step-2-Configuring-DirectAccess-Servers/PowerShellLogoSmall.gif)**эквивалентных команд Windows PowerShell Windows PowerShell**  
