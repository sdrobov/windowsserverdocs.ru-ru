...
### <a name="BKMK_ODJOverview"></a>Обзор сценария автономного присоединение к домену с помощью политик DirectAccess  
...
## <a name="BKMK_ODJRequirements"></a>Подготовка к автономному присоединению домена  
...
## <a name="BKMK_ODKSxS"></a>Процесс присоединение к домену вне сети  
...
## <a name="BKMK_ODJSteps"></a>Действия по выполнению автономного присоединение к домену DirectAccess  
...
##### <a name="option1-create-a-provisioning-package-for-the-client-without-pki"></a>Вариант 1. Создание пакета подготовки для клиента без PKI  
...
##### <a name="option2-create-a-provisioning-package-for-the-client-with-pki"></a>Вариант 2 Создание пакета подготовки для клиента с помощью PKI  
