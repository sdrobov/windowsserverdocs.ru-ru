...
---
# <a name="test-lab-guide-demonstrate-directaccess-in-a-cluster-with-windows-nlb"></a>Руководство по лаборатории тестирования: Демонстрация DirectAccess в кластере с помощью Windows NLB

>Область применения. Windows Server (Semi-Annual Channel), Windows Server 2016

Удаленный доступ — это роль сервера в операционных системах Windows Server 2016, Windows Server 2012 R2 старается Server 2012, которая позволяет удаленным пользователям безопасно получать доступ к внутренним сетевым ресурсам с помощью DirectAccess или VPN-подключения RRAS. Это руководство содержит пошаговые инструкции по расширению лабораторного руководства по @no__t 0Test. Продемонстрируйте настройку одиночного сервера DirectAccess с смешанными IPv4 и IPv6 @ no__t-0, чтобы продемонстрировать балансировку сетевой нагрузки DirectAccess и конфигурацию кластера.  
