...
1. Определите, какую топологию сетевых адаптеров хотите использовать. Для установки удаленного доступа могут использоваться следующие варианты:  
    ...
    - С двумя сетевыми адаптерами: в пограничном месте с одним сетевым адаптером, подключенным к Интернету, а другой — к внутренней сети или за устройством NAT, брандмауэром или маршрутизатором, с одним сетевым адаптером, подключенным к сети периметра, а другим — с внутренней. сети.  
