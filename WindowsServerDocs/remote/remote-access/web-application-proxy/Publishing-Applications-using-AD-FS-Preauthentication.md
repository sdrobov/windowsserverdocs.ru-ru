...
***<em>эквивалентные команды Windows PowerShell</em> ![](../../media/Publishing-Applications-using-AD-FS-Preauthentication/PowerShellLogoSmall.gif)***  
...
## <a name="BKMK_1.2"></a>Публикация встроенного приложения с проверкой подлинности Windows для клиентов веб-браузера  
...
## <a name="BKMK_1.3"></a>Публикация приложения, использующего MS-ОФБА  
...
## <a name="BKMK_1.4"></a>Публикация приложения, использующего OAuth2, например приложение Microsoft Store  
