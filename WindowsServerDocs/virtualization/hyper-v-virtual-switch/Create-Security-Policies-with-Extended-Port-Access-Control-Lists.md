...
## <a name="bkmk_detailed"></a>Подробные правила ACL  
...
### <a name="bkmk_enforce"></a>Обеспечение безопасности на уровне приложения  
...
|Исходный IP-адрес|IP-адрес назначения|Protocol|Порт источника|Порт назначения|Direction|Action|  
|-------------|------------------|------------|---------------|--------------------|-------------|----------|  
|*|*|TCP|*|3389|In|Allow|  
...
### <a name="bkmk_both"></a>Обеспечение безопасности на уровне пользователей и приложений  
...
|Исходный IP-адрес|IP-адрес назначения|Protocol|Порт источника|Порт назначения|Direction|Action|  
|-------------|------------------|------------|---------------|--------------------|-------------|----------|  
|*|255.255.255.255|UDP|*|67|Из|Allow|  
|*|10.175.124.0/25|UDP|*|67|Из|Allow|  
...
### <a name="bkmk_tcp"></a>Обеспечение поддержки безопасности для приложения, не поддерживающего TCP/UDP  
...
## <a name="bkmk_stateful"></a>Правила списков управления доступом с отслеживанием состояния  
...
|Порт назначения|*|*|80|  
|Direction|In|Из|Из|  
|Action|Запретить|Запретить|Allow|  
