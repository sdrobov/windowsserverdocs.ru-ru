...
> [!NOTE]
> Виртуальный процессор RemoteFX полностью поддерживается в Windows Server 2016, но не поддерживается в Windows Server 2019.
...
- [Развертывание графических устройств с помощью виртуальных GPU RemoteFX](../deploy/deploy-graphics-devices-using-remotefx-vgpu.md)
- [Поддержка RemoteFX 3D Video Adapter (GPU)](../../../remote/remote-desktop-services/rds-supported-config.md#remotefx-3d-video-adapter-vgpu-support)
