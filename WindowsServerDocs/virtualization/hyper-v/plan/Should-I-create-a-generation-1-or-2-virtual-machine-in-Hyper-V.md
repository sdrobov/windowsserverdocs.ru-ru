...
|Контроллер гибких дисков и DMA|Контроллер гибких дисков не поддерживается|Нет данных|  
...
|Шина PCI|Больше не требуется|Нет данных|  
|Программируемый контроллер прерываний (PIC)|Больше не требуется|Нет данных|  
|Программируемый интервальный таймер (PIT)|Больше не требуется|Нет данных|  
|Устройство Super I/O|Больше не требуется|Нет данных|  
