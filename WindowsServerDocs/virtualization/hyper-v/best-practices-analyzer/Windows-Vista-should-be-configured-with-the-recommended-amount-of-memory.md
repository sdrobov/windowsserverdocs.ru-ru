---
title: Windows Vista должны быть настроены Рекомендуемый объем памяти
...
ms.locfileid: "59826305"
---
# <a name="windows-vista-should-be-configured-with-the-recommended-amount-of-memory"></a>Windows Vista должны быть настроены Рекомендуемый объем памяти
...
*Виртуальной машине под управлением Windows Vista настроены меньше, чем Рекомендуемый объем ОЗУ — 1 ГБ.*  
...
### <a name="to-increase-the-memory-allocated-to-a-virtual-machine"></a>Чтобы увеличить объем памяти, выделенной для виртуальной машины  
