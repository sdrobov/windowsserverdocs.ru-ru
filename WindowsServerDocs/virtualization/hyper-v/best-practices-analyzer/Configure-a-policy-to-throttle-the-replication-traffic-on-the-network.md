...
пропускная способность @no__t 0Network может стать полностью обоснованной трафиком репликации, что влияет на другие критические сетевые операции. Это влияет на следующие порты: *.  
  
@no__t 0list виртуальных машин >  
  
## <a name="resolution"></a>Разрешение  
@no__t — 0If для регулирования сетевого трафика используется другой метод. это можно проигнорировать. В противном случае используйте редактор групповая политика, чтобы настроить политику, которая будет регулировать сетевой трафик до соответствующего порта сервера реплики. *  
