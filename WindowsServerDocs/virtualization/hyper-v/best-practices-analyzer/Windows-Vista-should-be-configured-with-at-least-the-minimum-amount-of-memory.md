---
title: Windows Vista должны быть настроены по крайней мере минимальный объем памяти
...
ms.locfileid: "59815005"
---
# <a name="windows-vista-should-be-configured-with-at-least-the-minimum-amount-of-memory"></a>Windows Vista должны быть настроены по крайней мере минимальный объем памяти
...
*Виртуальной машине под управлением Windows Vista настроены меньше, чем минимальный объем ОЗУ составляет 512 МБ.*  
