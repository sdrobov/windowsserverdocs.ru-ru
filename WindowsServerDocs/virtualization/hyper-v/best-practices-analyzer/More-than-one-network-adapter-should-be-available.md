...
@no__t 0Add больше сетевых адаптеров для этого компьютера. Чтобы зарезервировать один сетевой адаптер для монопольного использования операционной системой управления, не настраивайте его для использования с внешней виртуальной сетью. *  
