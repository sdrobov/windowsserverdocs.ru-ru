---
title: Windows 10 должны быть настроены по крайней мере минимальный объем памяти
...
ms.locfileid: "59824125"
---
# <a name="windows-10-should-be-configured-with-at-least-the-minimum-amount-of-memory"></a>Windows 10 должны быть настроены по крайней мере минимальный объем памяти
...
Следующие разделы содержат сведения о конкретной проблеме. Курсив указывает текст пользовательского интерфейса, который отображается в анализатор соответствия рекомендациям для конкретной проблемы.  
  
## <a name="issue"></a>**Проблема**  
*Виртуальную машину под управлением Windows 10 оснащен меньше, чем минимальный объем ОЗУ составляет 512 МБ.*  
