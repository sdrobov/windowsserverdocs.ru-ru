...
*A ошибка адаптера шины узла может блокировать подключение Fibre Channel между хранилищем и виртуальными машинами. Это влияет на следующие виртуальные машины:* .  
