---
title: Windows 8 должны быть настроены Рекомендуемый объем памяти
...
ms.locfileid: "59849875"
---
# <a name="windows-8-should-be-configured-with-the-recommended-amount-of-memory"></a>Windows 8 должны быть настроены Рекомендуемый объем памяти
...
*Виртуальную машину под управлением Windows 8 оснащен меньше, чем Рекомендуемый объем ОЗУ — 1 ГБ.*  
