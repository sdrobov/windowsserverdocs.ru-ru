...
компьютеры с @no__t 0Virtual не могут использовать хранилище, подключенное к контроллеру SCSI. Это влияет на следующие виртуальные машины: *.  
  
@no__t 0list виртуальных машин >  
  
## <a name="resolution"></a>Разрешение  
  
@no__t — 0Shut виртуальную машину и используйте диспетчер Hyper-V для удаления контроллера SCSI из виртуальной машины. Затем перезапустите виртуальную машину. *  
