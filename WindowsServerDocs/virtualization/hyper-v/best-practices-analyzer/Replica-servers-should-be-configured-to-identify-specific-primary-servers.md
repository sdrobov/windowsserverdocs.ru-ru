...
*Use диспетчер Hyper-V, чтобы создать новые записи авторизации для конкретных серверов-источников и указать отдельные места хранения для каждого из них. Можно использовать подстановочные знаки для группировки основных серверов в наборы для каждой записи авторизации.*  
