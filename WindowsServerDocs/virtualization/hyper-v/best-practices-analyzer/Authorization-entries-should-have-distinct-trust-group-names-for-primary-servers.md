...
*There могут быть вопросами конфиденциальности и безопасности для виртуальной машины, принимающей репликацию с основных серверов, принадлежащих к разным записям авторизации. Это влияет на следующие записи авторизации: \<list записей авторизации >*  
  
## <a name="resolution"></a>**Решение**  
*Use различные теги в записях авторизации для серверов-источника с виртуальными машинами, которые не входят в одну группу безопасности. Измените параметры Hyper-V, чтобы настроить теги репликации.*  
