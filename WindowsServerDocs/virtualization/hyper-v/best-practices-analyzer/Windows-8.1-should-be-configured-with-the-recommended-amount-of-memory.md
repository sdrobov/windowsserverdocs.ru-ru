---
title: Windows 8.1 должны быть настроены Рекомендуемый объем памяти
...
ms.locfileid: "59871295"
---
# <a name="windows-81-should-be-configured-with-the-recommended-amount-of-memory"></a>Windows 8.1 должны быть настроены Рекомендуемый объем памяти
...
*Виртуальную машину под управлением Windows 8.1 оснащен меньше, чем Рекомендуемый объем ОЗУ — 1 ГБ.*  
