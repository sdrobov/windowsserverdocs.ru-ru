...
на виртуальной машине или в приложении, использующем виртуальный жесткий диск, могут возникать проблемы *Performance. Это влияет на следующие виртуальные машины:* .  
