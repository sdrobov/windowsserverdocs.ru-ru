---
title: Windows Server 2008 R2 должны быть настроены Рекомендуемый объем памяти
...
ms.locfileid: "59865365"
---
# <a name="windows-server-2008-r2-should-be-configured-with-the-recommended-amount-of-memory"></a>Windows Server 2008 R2 должны быть настроены Рекомендуемый объем памяти
...
*Виртуальной машине под управлением Windows Server 2008 R2 настраивается с меньшим, чем Рекомендуемый объем ОЗУ, который составляет 2 ГБ.*  
