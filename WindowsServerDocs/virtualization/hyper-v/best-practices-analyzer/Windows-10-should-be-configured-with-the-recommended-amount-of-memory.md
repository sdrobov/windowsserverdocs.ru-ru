---
title: Windows 10 должны быть настроены Рекомендуемый объем памяти
...
ms.locfileid: "59875365"
---
# <a name="windows-10-should-be-configured-with-the-recommended-amount-of-memory"></a>Windows 10 должны быть настроены Рекомендуемый объем памяти
...
*Виртуальную машину под управлением Windows 10 оснащен меньше, чем Рекомендуемый объем ОЗУ — 1 ГБ.*  
