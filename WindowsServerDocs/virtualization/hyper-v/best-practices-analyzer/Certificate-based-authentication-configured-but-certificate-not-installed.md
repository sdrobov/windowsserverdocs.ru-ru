...
@no__t — 0In в случае отработки отказа кластера или перемещения на другой узел, репликация Hyper-V будет приостановлена, если на новом узле не установлен соответствующий сертификат. Это касается следующих узлов: *  
