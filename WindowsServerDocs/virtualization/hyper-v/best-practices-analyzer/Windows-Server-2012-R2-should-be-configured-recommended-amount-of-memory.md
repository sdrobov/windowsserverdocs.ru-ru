---
title: Windows Server 2012 R2 должны быть настроены Рекомендуемый объем памяти
...
ms.locfileid: "59812155"
---
# <a name="windows-server-2012-r2-should-be-configured-with-the-recommended-amount-of-memory"></a>Windows Server 2012 R2 должны быть настроены Рекомендуемый объем памяти
...
*Виртуальной машине под управлением Windows Server 2012 R2 оснащен меньше, чем Рекомендуемый объем ОЗУ, который составляет 2 ГБ.*  
