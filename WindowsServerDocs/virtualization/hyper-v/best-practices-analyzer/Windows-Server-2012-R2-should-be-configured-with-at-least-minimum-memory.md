---
title: Windows Server 2012 R2 должно быть настроено по крайней мере минимальный объем памяти
...
ms.locfileid: "59856225"
---
# <a name="windows-server-2012-r2-should-be-configured-with-at-least-the-minimum-amount-of-memory"></a>Windows Server 2012 R2 должно быть настроено по крайней мере минимальный объем памяти
...
*Виртуальной машине под управлением Windows Server 2012 R2 оснащен меньше, чем минимальный объем ОЗУ составляет 512 МБ.*  
