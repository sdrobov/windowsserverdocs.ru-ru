---
title: Windows 8.1 должны быть настроены по крайней мере минимальный объем памяти
...
ms.locfileid: "59822855"
---
# <a name="windows-81-should-be-configured-with-at-least-the-minimum-amount-of-memory"></a>Windows 8.1 должны быть настроены по крайней мере минимальный объем памяти
...
*Виртуальную машину под управлением Windows 8.1 оснащен меньше, чем минимальный объем ОЗУ составляет 512 МБ.*  
