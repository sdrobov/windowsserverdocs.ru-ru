---
title: Windows Server 2016 должны быть настроены по крайней мере минимальный объем памяти
...
ms.locfileid: "59873885"
---
# <a name="windows-server-2016-should-be-configured-with-at-least-the-minimum-amount-of-memory"></a>Windows Server 2016 должны быть настроены по крайней мере минимальный объем памяти
...
*Виртуальной машине под управлением Windows Server 2016 настроен с меньшим, чем минимальный объем ОЗУ составляет 512 МБ.*  
