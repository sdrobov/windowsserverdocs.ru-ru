---
title: Windows 8 должны быть настроены по крайней мере минимальный объем памяти
...
ms.locfileid: "59864445"
---
# <a name="windows-8-should-be-configured-with-at-least-the-minimum-amount-of-memory"></a>Windows 8 должны быть настроены по крайней мере минимальный объем памяти
...
*Виртуальную машину под управлением Windows 8 оснащен меньше, чем минимальный объем ОЗУ составляет 512 МБ.*  
