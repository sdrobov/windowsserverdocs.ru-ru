---
title: Windows Server 2008 должны быть настроены Рекомендуемый объем памяти
...
ms.locfileid: "59818795"
---
# <a name="windows-server-2008-should-be-configured-with-the-recommended-amount-of-memory"></a>Windows Server 2008 должны быть настроены Рекомендуемый объем памяти
...
*Виртуальную машину под управлением Windows Server 2008 настраивается с меньшим, чем Рекомендуемый объем ОЗУ, который составляет 2 ГБ.*  
...
3.  Выполните команду, аналогичную приведенной ниже, заменив \<MyVM > имя вашей виртуальной машины и памяти значения с по крайней мере значения, приведенные ниже.  
