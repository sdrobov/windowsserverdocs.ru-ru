...
3.  Выполните команду, аналогичную приведенной ниже, заменив \<MyVM > именем виртуальной машины, а значения памяти — по меньшей мере на значения, приведенные ниже.  
