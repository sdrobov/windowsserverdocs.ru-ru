...
11. В папке **Computers** выберите учетную запись компьютера конечного сервера и повторите процесс. Убедитесь, что в диалоговом окне **Выбор пользователей или компьютеров** указано имя исходного сервера.
...
|Параметр|Описание|
|----------|---------------|
    |Протокол TCP/IP|Копирует память виртуальной машины на целевой сервер через подключение TCP/IP.|
