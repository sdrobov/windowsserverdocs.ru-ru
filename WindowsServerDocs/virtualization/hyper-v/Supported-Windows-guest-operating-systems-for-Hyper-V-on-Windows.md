...
|Windows 7 с пакетом обновления 1 (SP1)|추가를 클릭합니다.|Обновите службы Integration Services после настройки операционной системы на виртуальной машине.|Выпуски Максимальная, Корпоративная и Профессиональная (32-разрядные и 64-разрядные).|  
...
|Операционная система узла|Статья|  
|-------------------------|---------|  
