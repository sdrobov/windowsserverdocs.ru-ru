...
## <a name="BKMK_HyperVManager"></a>Создание виртуальной машины с помощью диспетчера Hyper-V  
...
4.  Выбрать подходящие параметры для виртуальной машины на всех страницах. Дополнительные сведения см. в разделе [новые параметры виртуальной машины и значения по умолчанию в диспетчере Hyper-V](#BKMK_Options) далее в этом разделе.  
...
## <a name="BKMK_PowerShell"></a>Создание виртуальной машины с помощью Windows PowerShell  
...
## <a name="BKMK_Options"></a>Параметры в мастере создания виртуальной машины в диспетчере Hyper-V  
...
- [Поддерживаемые версии виртуальных машин конфигурации](../deploy/Upgrade-virtual-machine-version-in-Hyper-V-on-Windows-or-Windows-Server.md#BKMK_SupportedConfigVersions)  
...
-   [Создайте виртуальный коммутатор для виртуальных машин Hyper-V](Create-a-virtual-switch-for-Hyper-V-virtual-machines.md)  
