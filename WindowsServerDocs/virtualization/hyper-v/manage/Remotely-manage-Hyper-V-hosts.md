...
* Вполне возможно, что установлены средства Hyper-V. Чтобы проверить, что установлена платформа Hyper-V, найдите службу управления виртуальными машинами. / (Откройте приложение службы рабочего стола: щелкните **начала**, нажмите кнопку **начать поиск** введите **services.msc**и нажмите клавишу **ввод**. Если служба управления виртуальными машинами нет в списке, установите платформу Hyper-V, следуя инструкциям в [Установка Hyper-V](../get-started/Install-the-Hyper-V-role-on-Windows-Server.md).
