...
-   **Отработка отказа**. при возникновении сбоя в основном (или вторичном хранилище в случае расширения) можно вручную инициировать тестовую, запланированную или внеплановую отработку отказа.
    ...
    | Есть ли потери данных? | Отсутствуют | Нет. После того как отказоустойчивая реплика Hyper-V реплицирует последний набор отслеживаний изменений обратно в сервер-источник для обеспечения нулевой потери данных. | Зависит от точек восстановления и событий |
