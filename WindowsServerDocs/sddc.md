...
![](media/sddc/video.png) **[Просмотрите видео, чтобы узнать больше о SDDC Майкрософт](https://mva.microsoft.com/en-US/training-courses/whats-new-in-windows-server-2016-16457?l=YcsJR6sXC_1006218965)**

![](media/sddc/poster-ico.png) — **[скачайте PDF-файл размера афиши этой страницы](https://github.com/MicrosoftDocs/windowsserverdocs/blob/master/WindowsServerDocs/media/sddc/sddc_poster_0801417_ANSI-E.pdf)**
...
![](media/sddc/learn.png) **[Узнайте больше о Azure Stack решений хЦи](https://azure.microsoft.com/overview/azure-stack/hci)**

![](media/sddc/learn.png) **[Узнайте больше о РЕШЕНИЯх ВССД](https://www.microsoft.com/en-us/cloud-platform/software-defined-datacenter)**
...
![](media/sddc/learn.png) **[Узнайте больше о Windows Server, Объединенных технологиях Hyper-](https://docs.microsoft.com/windows-server/get-started/what-s-new-in-windows-server-2016#computevirtualizationvirtualizationmd) in**
...
- От Общие VHDX-файлы поддерживают реплику Hyper-V и резервное копирование на уровне узла.

![](media/sddc/learn.png) **[Узнайте больше о кластеризации гостевых систем с общим VHDX](https://technet.microsoft.com/library/dn281956(v=ws.11).aspx)**
...
![](media/sddc/learn.png) **[Узнайте больше о брандмауэре центра обработки данных](https://docs.microsoft.com/windows-server/networking/sdn/technologies/network-function-virtualization/datacenter-firewall-overview)**
...
узел ![Each содержит локально подключенные диски на уровне кластера, Локальные дисковые пространства затем доступ к которым осуществляется виртуальными машинами через CSV @ no__t-1.
...
![](media/sddc/learn.png) **[Узнайте больше о Локальные дисковые пространства](storage/storage-spaces/storage-spaces-direct-overview.md)**
...
![](media/sddc/learn.png) **[Узнайте больше о качества обслуживания хранилища](https://docs.microsoft.com/windows-server/storage/storage-qos/storage-qos-overview)**
...
t & T1: Данные, сброшенные на том, записываются в журнал через
...
![](media/sddc/learn.png) **[Узнайте больше о подтверждение работоспособности устройства](https://docs.microsoft.com/windows-server/security/device-health-attestation)**
...
- Datacenter Настройка компонентов центра обработки данных и управление ими в качестве единой структуры в VMM. 
- Узлы виртуализации: VMM может добавлять, подготавливать и администрировать узлы и кластеры виртуализации Hyper-V и VMware.
- Сети VMM обеспечивает виртуализацию сети, включая поддержку создания виртуальных сетей и сетевых шлюзов и управления ими. 
- Хранилище: VMM может обнаруживать, классифицировать, подготавливать, распределять и назначать локальное и удаленное хранилище.
...
![](media/sddc/learn.png) **[Узнайте больше о центре администрирования Windows](manage/windows-admin-center/overview.md)**
