...
Технологии в составе Windows Server и System Center являются основными компонентами программного ЦОД Windows Server. Но несмотря на то, что это виртуализированная платформа, в ее основе должно лежать соответствующее оборудование. Партнеры корпорации Майкрософт, участвующие в **Windows Server Software-Defined (WSSD) решения** и **решения HCI Azure Stack** программ может помочь вашей компании получить соответствующее оборудование и его и запустить на день ноль.

![](media/sddc/video.png) **[Ознакомьтесь с видео для получения дополнительных сведений о Microsoft, SDDC](https://mva.microsoft.com/en-US/training-courses/whats-new-in-windows-server-2016-16457?l=YcsJR6sXC_1006218965)**

![](media/sddc/poster-ico.png) **[Скачать PDF-файла плакат размер части этой страницы](https://github.com/MicrosoftDocs/windowsserverdocs/blob/master/WindowsServerDocs/media/sddc/sddc_poster_0801417_ANSI-E.pdf)**
...
Основываясь на инфраструктуре соответствующее оборудование Windows Server программно определяемого центра обработки данных является важным первым шагом к успеху. Вот почему мы сотрудничаем с 15 партнерам возможность создавать макеты корпорацией Майкрософт были SDDC и рекомендации по развертыванию.

Партнеры Майкрософт предоставляют возможность воспользоваться множеством решений, использующих 2019 Server окна с помощью программы Azure Stack HCI и Windows Server 2016 по Windows Server программно определяемых (WSSD) программе для предоставления высокой производительности, гиперконвергентного, хранилища и сети инфраструктура. Гиперконвергентные решения объединяют ресурсы вычислений, хранения и сети в соответствующих отраслевым стандартам серверах и компонентах для улучшенной аналитики и контроля в ЦОД.

![](media/sddc/learn.png) **[Дополнительные сведения о решениях HCI Azure Stack](https://azure.microsoft.com/overview/azure-stack/hci)**

![](media/sddc/learn.png) **[Дополнительные сведения о решениях WSSD](https://www.microsoft.com/en-us/cloud-platform/software-defined-datacenter)**
...
### <a name="windows-server-hyper-converged"></a>Windows Server, гиперконвергентной
...
![](media/sddc/learn.png) **[Дополнительные сведения о Windows Server, Hyper со схождением](https://docs.microsoft.com/windows-server/get-started/what-s-new-in-windows-server-2016#computevirtualizationvirtualizationmd)**
...
### <a name="guest-clustering-with-shared-vhdx"></a>Гостевой кластер с общим диском VHDX
...
- Защищенная: Общий диск VHDX поддерживает реплики Hyper-V и резервное копирование на уровне узла.

![](media/sddc/learn.png) **[Дополнительные сведения о кластеризации гостевых с общих дисков VHDX](https://technet.microsoft.com/library/dn281956(v=ws.11).aspx)**
...
![](media/sddc/learn.png) **[Дополнительные сведения о сетевой контроллер](https://docs.microsoft.com/windows-server/networking/sdn/technologies/network-controller/network-controller)**
...
![](media/sddc/learn.png) **[Дополнительные сведения о Switch Embedded Teaming](https://docs.microsoft.com/windows-server/networking/sdn/technologies/set-for-sdn)**
...
![](media/sddc/learn.png) **[Дополнительные сведения о балансировке нагрузки программного обеспечения](https://docs.microsoft.com/windows-server/networking/sdn/technologies/network-function-virtualization/software-load-balancing-for-sdn)**
...
![Каждый узел локально присоединил накопители с дисковыми пространствами затем доступ к виртуальным машинам через общие тома кластера в составе пула на уровне кластера](media/sddc/spacer1.png)![](media/sddc/ssd.png)
...
![](media/sddc/learn.png) **[Дополнительные сведения о дисковых пространств](storage/storage-spaces/storage-spaces-direct-overview.md)**
...
t & t1: Данные сброшены в том, сквозная запись журналов
...
![](media/sddc/learn.png) **[Дополнительные сведения об экранированных виртуальных машин](https://docs.microsoft.com/windows-server/virtualization/guarded-fabric-shielded-vm/guarded-fabric-and-shielded-vms)**
...
![](media/sddc/learn.png) **[Дополнительные сведения об аттестации работоспособности устройств](https://docs.microsoft.com/windows-server/security/device-health-attestation)**
...
![](media/sddc/learn.png) **[Дополнительные сведения о PowerShell DSC](https://docs.microsoft.com/powershell/dsc/overview)**
...
- Центр обработки данных: Настройка и управление компонентов центра обработки данных как единой структуры в VMM. 
- Узлы виртуализации: VMM можно добавить, Подготовка и управление Hyper-V и VMware узлы и кластеры виртуализации.
- Сетевые подключения: VMM обеспечивает виртуализацию сети, включая поддержку создания и управления виртуальными сетями и шлюзы сети. 
- Хранилище: VMM может обнаруживать, классифицировать, подготовка, выделить и назначить локальные и удаленные хранилища.
