...
ms.locfileid: "59880815"
---
# <a name="windows-server-software-defined-datacenter"></a>Программный ЦОД Windows Server
...
Технологии в составе Windows Server и System Center являются основными компонентами программного ЦОД Windows Server. Но несмотря на то, что это виртуализированная платформа, в ее основе должно лежать соответствующее оборудование. Партнеры Майкрософт, участвующие в программе **Программные решения Windows Server** помогут вашей компании приобрести необходимое оборудование и ввести его в эксплуатацию в первый же день.
...
## <a name="windows-server-software-defined-wssd-solutions"></a>Программные решения Windows Server ##
Выбор оптимальной аппаратной инфраструктуры — одно из важнейших условий успешного создания программного ЦОД Windows Server. Именно поэтому мы объединили усилия с компаниями **DataON**, **Fujitsu**, **Lenovo**, **QCT**, **SuperMicro**, **Hewlett Packard Enterprise** и **Dell EMC** для разработки проверенных корпорацией Майкрософт проектов программного ЦОД и составления рекомендаций по развертыванию. Партнеры Майкрософт предоставляют целый ряд программных решений Windows Server, которые в сочетании с Windows Server 2016 предоставляют высокопроизводительную гиперконвергентную инфраструктуру хранилища и сети. Гиперконвергентные решения объединяют ресурсы вычислений, хранения и сети в соответствующих отраслевым стандартам серверах и компонентах для улучшенной аналитики и контроля в ЦОД.
...
![](media/sddc/learn.png)**[Дополнительные сведения о Microsoft Project Windows Admin Center](manage/windows-admin-center/overview.md)**
