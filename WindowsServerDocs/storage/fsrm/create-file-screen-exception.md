...
4.  Чтобы указать файлы, которые не будут блокироваться, выполните следующие действия.
    ...
    -   Если необходимо просмотреть типы файлов, которые содержит группа файлов и которые из нее исключаются, щелкните метку группы файлов и нажмите кнопку **Изменить**.
