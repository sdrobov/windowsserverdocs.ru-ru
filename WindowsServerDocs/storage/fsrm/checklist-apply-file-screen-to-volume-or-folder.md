...
5. Просмотрите свойства доступных шаблонов для фильтров блокировки файлов. (В окне **Управление блокировкой файлов**щелкните узел **шаблоны экранов файлов** .) [Изменить свойства шаблона фильтра блокировки файлов](edit-file-screen-template-properties.md) 
<br />
 -Или-
