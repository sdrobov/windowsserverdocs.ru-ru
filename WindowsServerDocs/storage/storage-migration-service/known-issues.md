...
## <a name="cutover-hangs-on-38-mapping-network-interfaces-on-the-source-comnputer"></a>Прямую миграцию зависает на "38% сопоставлении сетевых интерфейсов в исходном комнпутер..." 
...
Ексаминининг. исходный компьютер показывает, что исходный IP-адрес не меняется. 
