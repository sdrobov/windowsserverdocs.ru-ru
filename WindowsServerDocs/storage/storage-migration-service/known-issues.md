...
2. Если вы не указали IP-адрес шлюза по умолчанию в сетевых интерфейсах исходного компьютера, эта проблема будет возникать даже при обновлении KB4537818. Чтобы обойти эту ошибку, задайте допустимый IP-адрес по умолчанию для сетевых интерфейсов с помощью приложения "Сетевые подключения" (NCPA. CPL) или командлет Set-NetRoute PowerShell.   
