...
1. Выберите **создать задание**, укажите имя задания, а затем выберите, следует ли перенести серверы Windows и кластеры или серверы Linux, использующие Samba. Нажмите **ОК**.
...
- [Планирование развертывания службы синхронизации файлов Azure (предварительная версия)](https://docs.microsoft.com/azure/storage/files/storage-sync-files-planning)
