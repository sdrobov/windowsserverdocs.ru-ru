...
- На исходном и целевом компьютерах должны быть включены следующие правила брандмауэра (хотя они уже могут быть включены):
  ...
  > [!TIP]
  > При установке прокси-сервера службы миграции хранилища на компьютер под Windows Server 2019 автоматически открываются необходимые порты брандмауэра на этом компьютере.
