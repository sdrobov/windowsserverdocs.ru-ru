...
2. Стать владельцем папки `%programdata%/Microsoft/StorageMigrationService`
...
Большинство ошибок, обнаруженных в CSV-файле для перемещения, являются системными кодами ошибок Windows. Сведения о каждой ошибке можно узнать, просмотрев [документацию по кодам ошибок Win32](https://docs.microsoft.com/windows/win32/debug/system-error-codes). 
...
- Электронная почта smsfeed@microsoft.com
