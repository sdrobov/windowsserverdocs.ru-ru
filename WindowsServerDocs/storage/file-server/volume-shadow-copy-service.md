...
<LI>Его можно удалить файлы из теневой копии, который был создан с помощью [Diskshadow](https://docs.microsoft.com/en-us/windows-server/administration/windows-commands/diskshadow) программы, но он не может удалить файлы из теневой копии, который был создан с помощью [Vssadmin](https://docs.microsoft.com/en-us/windows-server/administration/windows-commands/vssadmin) служебной программы.<BR><BR>
