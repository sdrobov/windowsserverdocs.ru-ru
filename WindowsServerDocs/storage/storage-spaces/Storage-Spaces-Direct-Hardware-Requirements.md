...
Полностью настроенный кластер (серверы, сеть и хранилище) должен пройти все [проверочные тесты](https://technet.microsoft.com/library/cc732035(v=ws.10).aspx) в мастере в Диспетчер отказоустойчивости кластеров или с помощью [командлета](https://docs.microsoft.com/powershell/module/failoverclusters/test-cluster?view=win10-ps) `Test-Cluster` в PowerShell.
