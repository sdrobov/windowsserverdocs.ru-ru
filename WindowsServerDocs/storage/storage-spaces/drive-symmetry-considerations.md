...
|--|--|
| Диски одного типа на каждом сервере | **Обязательный** |
| Одинаковое количество каждого типа на каждом сервере | **Обязательный** |
| Модели дисков на каждом сервере | Рекомендуемая |
| Один и тот же размер диска на каждом сервере | Рекомендуемая |
