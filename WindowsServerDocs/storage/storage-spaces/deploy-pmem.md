...
> [!NOTE]  
> При перезагрузке системы с несколькими модулями Intel® Оптане™ PMem в режиме Direct, разделенных на несколько пространств имен, вы можете потерять доступ к некоторым или всем связанным дискам логического хранилища. Эта проблема возникает в версиях Windows Server 2019, предшествующих версии 1903.
>   
