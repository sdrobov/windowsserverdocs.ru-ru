# [Хранение](storage.md)
## [Новые возможности хранения](whats-new-in-storage.md)
## [Дедупликация данных](data-deduplication/overview.md)
### [Новые возможности дедупликации данных](data-deduplication/whats-new.md)
...
#### [Добавление серверов пространства имен в доменное пространство имен DFS](dfs-namespaces/add-namespace-servers-to-a-domain-based-DFS-namespace.md)
...
#### [Включение и отключение ссылок и переключение клиента на основной ресурс](dfs-namespaces/enable-or-disable-referrals-and-client-failback.md)
...
### [Обзор NFS](nfs/nfs-overview.md)
### [Развертывание сетевой файловой системы](nfs/deploy-nfs.md)
### [Обзор NTFS](file-server/ntfs-overview.md)
...
#### [Создание отчетов по требованию](fsrm/generate-reports-on-demand.md)
...
#### [Инструменты командной строки](fsrm/command-line-tools.md)
...
### [Отключайте функции "Автономные файлы" в папках](folder-redirection/disable-offline-files-on-folders.md)
...
### [Вопросы и ответы по реплике хранилища](storage-replica/storage-replica-frequently-asked-questions.md)
...
## [Дисковые пространства прямого подключения](storage-spaces/storage-spaces-direct-overview.md)
### Общие сведения
#### [Общие сведения о кэше](storage-spaces/understand-the-cache.md)
#### [Отказоустойчивость и экономичность хранения](storage-spaces/Storage-Spaces-Fault-Tolerance.md)
...
#### [Обновление кластера локальных дисковых пространств до Windows Server 2019](storage-spaces/upgrade-storage-spaces-direct-to-windows-server-2019.md)
### Управление
#### [Администрирование с помощью Windows Admin Center](../manage/windows-admin-center/use/manage-hyper-converged.md)
...
## [Управление работоспособностью памяти хранилища](storage-spaces/Storage-class-memory-health.md)
