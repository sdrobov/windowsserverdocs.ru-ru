...
| Экономная синхронизация | Новый | Помогает пользователям избежать высоких затрат на использование данных при синхронизации при использовании лимитных подключений с ограничениями на использование или роуминге в сети другого поставщика. |
| Поддержка основного компьютера | Новый | Позволяет ограничить использование перенаправления папок, перемещаемых профилей пользователей или и того, и другого только для основных компьютеров пользователя. |
