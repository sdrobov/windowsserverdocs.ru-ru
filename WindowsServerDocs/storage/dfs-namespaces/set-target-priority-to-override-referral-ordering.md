...
## <a name="to-set-target-priority-on-a-root-target-for-a-domain-based-namespace"></a>Задание приоритета корневого конечного объекта для доменного пространства имен
...
## <a name="to-set-target-priority-on-a-folder-target"></a>Задание приоритета для конечного объекта папки
