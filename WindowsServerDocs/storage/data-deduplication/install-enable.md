...
![щелкните Службы файлов и хранилища](media/enable-dedup-via-server-manager-1.PNG)
...
![щелкните настройка дедупликации данных](media/enable-dedup-via-server-manager-3.png)
4. Выберите в раскрывающемся списке нужный **тип использования** и нажмите **ОК**.  
![выберите нужный тип использования из раскрывающегося](media/enable-dedup-via-server-manager-4.png)
