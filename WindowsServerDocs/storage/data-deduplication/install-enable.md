...
3. **Каковы требования к ресурсам на сервере рабочей нагрузки?**  
...
#### <a id="enable-dedup-sometimes-considerations"></a>Дополнительные рекомендации
> [!Important]  
