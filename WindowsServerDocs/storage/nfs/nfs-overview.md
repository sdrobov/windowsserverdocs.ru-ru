...
|---|---|---|
|[NFS версии 4.1](#nfs-version-4.1)|Оператор new|Повышенный уровень безопасности, производительности и взаимодействия, по сравнению с NFS версии 3.|
