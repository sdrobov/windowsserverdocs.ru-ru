...
9. Создание кластеров (**SRAZC1**, **SRAZC2**). 
   Ниже приведен команды PowerShell для нашего примера
   ```PowerShell
...
12. На каждом узле кластера откройте порт 59999 (пробы работоспособности). 
    ...
    ```   
13. Указание кластера для прослушивания сообщений проверки работоспособности на порта 59999 и ответ от узла, который в данный момент владеет этим ресурсом. 
