...
|-------------------------------|-------------------------------------------------------------|------------------|
| Два сервера <br>(любое сочетание локального оборудования, виртуальных машин и облачных виртуальных машинах, включая виртуальные машины Azure)| Windows Server (Semi-Annual Channel) или Windows Server 2016 Datacenter edition | Реплика хранилища  |
...
1.  Установите Windows Server 2016 на обоих узлах серверов, указав тип установки Windows Server 2016 Datacenter **(возможности рабочего стола)**. Нет выберите Standard Edition, если таковой имеется, как он не содержит реплику хранилища.
...
8.  Настройте хранилище следующим образом:  
    ...
    - **Для хранения данных iSCSI:**  
        ...
        2.  Подготовьте хранилище в соответствии с документацией поставщика. При использовании целей iSCSI для Windows изучите статью [Блочное хранилище конечного сервера iSCSI, краткое руководство](https://technet.microsoft.com/library/hh848268.aspx).  
