...
@NO__T 0FIGURE 1: Репликация кластера в кластер @ no__t-0  
...
## <a name="step-3-set-up-cluster-to-cluster-replication-using-windows-powershell"></a>Шаг 3. Настройка репликации кластера в кластер с помощью Windows PowerShell  
