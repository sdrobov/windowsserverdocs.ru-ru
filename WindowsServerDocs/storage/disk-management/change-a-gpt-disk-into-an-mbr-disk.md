...
|                Значение                  |      Описание   |
| ------------------------------------- | -----------------  |
|  <strong>Список дисков</strong>  | Отображает список дисков и сведения о них, такие как размер, объем свободного места, является ли диск базовым или динамическим, а также используемый стиль раздела — основная загрузочная запись (MBR) или таблица разделов GUID (GPT). Диск, отмеченные звездочкой (\*) имеет фокус. |
| <strong>Выберите диск</strong> |                                                                                                          Выбирает указанный диск, где <em>disknumber</em> — номер диска, и переводит на него фокус.                                                                                                           |
| <strong>Преобразовать mbr</strong> |                                                                               Изменяет стиль раздела пустого базового диска с таблицы разделов GUID (GPT) на основную загрузочную запись (MBR).                                                                                |
