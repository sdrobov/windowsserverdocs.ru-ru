...
Если вы хотите скачать или использовать рабочие папки в Windows Server 2012 R2, Windows 10 или Windows 7, см. следующие статьи:

-   [Рабочие папки для Windows Server 2012 R2](https://technet.microsoft.com/library/dn265974(v=ws.11).aspx)
-   [Рабочие папки для Windows10](http://support.microsoft.com/help/12370/windows-10-work-folders)
-   [Рабочие папки для Windows 7 (скачать 64-разрядную версию)](http://www.microsoft.com/download/details.aspx?id=42558)
-   [Рабочие папки для Windows 7 (скачать 32-разрядную версию)](http://www.microsoft.com/download/details.aspx?id=42559)

##  <a name="BKMK_OVER"></a> Описание роли  
...
|-------------------|------------------|-----------------|  
|Служба роли рабочих папок в диспетчере серверов|Windows Server2012R2 или Windows Server 2016|Службы файлов и хранилищ позволяют настроить общие ресурсы синхронизации (папки, в которых хранятся рабочие файлы пользователей), отслеживают рабочие папки и общими ресурсами синхронизации и доступом пользователей|  
|Командлеты рабочих папок|Windows Server2012R2 или Windows Server 2016|Модуль Windows PowerShell, который содержит полный набор командлетов для управления серверами рабочих папок|  
...
-   На компьютерах с Windows 7 должна быть установлена одна из следующих версий Windows:  
...
##  <a name="BKMK_Comparison"></a> Рабочие папки по сравнению с другими технологиями синхронизации  
...
|**Облачная служба**|Нет|Нет|Office365|Microsoft OneDrive|  
|**Внутренние сетевые серверы**|Файловые серверы под управлением Windows Server 2012 R2 или Windows Server 2016|Файловые серверы|Сервер SharePoint (необязательно)|Нет|  
...
##  <a name="BKMK_INSTALL"></a> Сведения о диспетчере серверов  
...
##  <a name="BKMK_Azure"></a> Взаимодействие с виртуальными машинами Microsoft Azure  
...
|------------------|----------------|  
|**Оценка продукта**|-   [Рабочие папки для Android — выпущено](http://blogs.technet.com/b/filecab/archive/2015/01/16/work-folders-for-ios-ipad-app-release.aspx) (запись в блоге)<br />-   [Рабочие папки для iOS — выпуск приложения для iPad](http://blogs.technet.microsoft.com/filecab/2016/03/16/work-folders-for-android-released) (запись в блоге)<br />-   [Представляем рабочие папки в Windows Server 2012 R2](http://blogs.technet.com/b/filecab/archive/2013/07/09/introducing-work-folders-on-windows-server-2012-r2.aspx) (запись в блоге)<br />-   [Введение в рабочие папки](http://channel9.msdn.com/posts/Introduction-to-Work-Folders) (видео Channel 9)<br />-   [Развертывание лаборатории тестирования рабочих папок](http://blogs.technet.com/b/filecab/archive/2013/07/10/work-folders-test-lab-deployment.aspx) (запись блога)<br />-   [Рабочие папки для Windows 7](http://blogs.technet.com/b/filecab/archive/2014/04/24/work-folders-for-windows-7.aspx) (запись блога)|  
|**Развертывание**|-   [Проектирование реализации рабочих папок](plan-work-folders.md)<br />-   [Развертывание рабочих папок](deploy-work-folders.md)<br />-   [Развертывание рабочих папок с помощью AD FS и прокси-службы веб-приложения (WAP)](deploy-work-folders-adfs-overview.md)<br />-   [Развертывание рабочих папок с помощью прокси-сервера приложения Azure AD](https://blogs.technet.microsoft.com/filecab/2017/05/31/enable-remote-access-to-work-folders-using-azure-active-directory-application-proxy/)<br />- [Руководство по переносу автономных файлов (CSC) в рабочие папки](http://blogs.technet.microsoft.com/filecab/2016/08/12/offline-files-csc-to-work-folders-migration-guide/)<br />-   [Факторы производительности при развертывании рабочих папок](http://blogs.technet.com/b/filecab/archive/2013/11/01/performance-considerations-for-large-scale-work-folders-deployments.aspx)<br />-   [Рабочие папки для Windows 7 (скачать 64-разрядную версию)](http://www.microsoft.com/download/details.aspx?id=42558)<br />-   [Рабочие папки для Windows 7 (скачать 32-разрядную версию)](http://www.microsoft.com/download/details.aspx?id=42559)|  
|**Операции**|-   [Приложение «Рабочие папки» для iPad: вопросы и ответы](http://windows.microsoft.com/windows/work-folders-ipad-faq) (для пользователей)<br />-   [Управление сертификатами рабочих папок](http://blogs.technet.com/b/filecab/archive/2013/08/09/work-folders-certificate-management.aspx) (запись в блоге)<br />-   [Мониторинг развертывания рабочих папок в Windows Server 2012 R2](http://blogs.technet.com/b/filecab/archive/2013/10/15/monitoring-windows-server-2012-r2-work-folders-deployments.aspx) (запись в блоге)<br />-   [Командлеты SyncShare (рабочие папки) в Windows PowerShell](http://technet.microsoft.com/library/dn296644.aspx)<br />-   [Краткий справочник по командлетам PowerShell для файловых служб и служб хранилища для выпуска Windows Server 2012 R2 Preview](http://blogs.technet.com/b/filecab/archive/2013/07/30/storage-and-file-services-powershell-cmdlets-quick-reference-card-for-windows-server-2012-r2-preview-edition.aspx)|  
|**Диагностика**|-   [Windows Server 2012 R2 — устранение конфликтов портов с веб-сайтами IIS и рабочими папками](http://blogs.technet.com/b/filecab/archive/2013/10/15/windows-server-2012-r2-resolving-port-conflict-with-iis-websites-and-work-folders.aspx) (запись в блоге)<br />-   [Распространенные ошибки в рабочих папках](http://social.technet.microsoft.com/wiki/contents/articles/30578.common-errors-in-work-folders.aspx)|  
|**Ресурсы сообщества**|-   [Форум по файловым службам и хранению](http://social.technet.microsoft.com/Forums/windowsserver/home?forum=winserverfiles)<br />-   [Рабочая группа по хранению данных Майкрософт — блог File Cabinet](http://blogs.technet.com/b/filecab/)<br />-   [Задайте вопрос в блоге команды разработчиков служб каталогов](http://blogs.technet.com/b/askds/)|  
|**Связанные технологии**|-   [Хранилище в Windows Server2016](../storage.md)<br>-   [Файловые службы и службы хранилища](https://technet.microsoft.com/library/hh831487(v=ws.11).aspx)<br />-   [Диспетчер ресурсов файлового сервера](https://technet.microsoft.com/library/hh831701(v=ws.11).aspx)<br />-   [Перенаправление папок, автономные файлы и перемещаемые профили пользователей](https://technet.microsoft.com/library/hh848267(v=ws.11).aspx)<br />-   [BranchCache](https://technet.microsoft.com/library/hh831696(v=ws.11).aspx)<br />-   [Пространства имен DFS и репликация DFS](https://technet.microsoft.com/library/jj127250(v=ws.11).aspx)|
