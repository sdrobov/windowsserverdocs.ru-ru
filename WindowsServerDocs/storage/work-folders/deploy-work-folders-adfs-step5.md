...
3.  На странице **Введите рабочий адрес электронной почты** введите адрес электронной почты пользователя (например, user@contoso.com) или URL-адрес рабочих папок (в тестовом примере — https://workfolders.contoso.com) и нажмите кнопку **Далее**.  
