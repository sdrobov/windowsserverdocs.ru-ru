...
4.  В окне **Параметры рабочих папок** выберите **Службы федерации Active Directory (AD FS)** и введите URL-адрес службы федерации. Нажмите кнопку **Применить**.  
