...
- базовое представление о предоставлении веб-доступа к внутренним ресурсам через обратный веб-прокси.  
  ...
  Следующие разделы помогут вам при проектировании реализации рабочих папок. Развертывание рабочих папок обсуждается в следующей статье [Deploying Work Folders](deploy-work-folders.md).  
...
### <a name="active-directory-domain-services"></a>Доменные службы Active Directory (AD DS)  
