...
7.  На странице **Confirm installation selections** нажмите **Install**.  
...
5.  На странице **Сертификат прокси-сервера AD FS** выберите импортированный ранее сертификат AD FS. В тестовом примере используется имя **blueadfs.contoso.com**. Нажмите **Далее**.  
