...
7.  На странице **Подтверждение выбранных элементов для установки** нажмите **Установить**.  
  
## <a name="configure-web-application-proxy"></a>Настройка прокси-службы веб-приложения  
...
6.  На странице подтверждения отображается команда Windows PowerShell, которая будет выполнена для настройки службы. Щелкните **Настроить**.  
...
8.  На странице **Параметры публикации** введите следующие данные и нажмите кнопку **Далее**.  
    ...
    Серверный URL-адрес: **https://workfolders.contoso.com**  
  
9.  На странице подтверждения отображается команда Windows PowerShell, которая будет выполнения для публикации приложения. Нажмите **Опубликовать**.  
