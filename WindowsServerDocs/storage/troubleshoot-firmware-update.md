...
- [Обновление встроенного ПО дисков в Windows Server2016](update-firmware.md)
...
2.  Обратитесь к каталогу Windows Server, чтобы определить, какие устройства SAS успешно получили ДК обновления встроенного ПО (https://www.windowsservercatalog.com/)
...
- Функции: 15 (0000 1111) (бит 1 настроен на "1" и указывает "Отменить")
- SectorCount: 0 (0000 0000) (Н/Д)
- DriveHead: 160 (1010 0000) (Н/Д — настраиваются только устаревшие биты)
- Команда: 146 (1001 0010) (бит 1 настраивается на "1", указывая доступность данных датчика)
